...
module TLInterconnectCoupler_11(
  ...
  TLWidthWidget_5 widget (	// WidthWidget.scala:220:28
    ...
    .auto_out_a_ready        (auto_tl_slave_clock_xing_out_a_ready),
    .auto_out_d_valid        (auto_tl_slave_clock_xing_out_d_valid),
    .auto_out_d_bits_opcode  (auto_tl_slave_clock_xing_out_d_bits_opcode),
    .auto_out_d_bits_param   (auto_tl_slave_clock_xing_out_d_bits_param),
    .auto_out_d_bits_size    (auto_tl_slave_clock_xing_out_d_bits_size),
    .auto_out_d_bits_source  (auto_tl_slave_clock_xing_out_d_bits_source),
    .auto_out_d_bits_sink    (auto_tl_slave_clock_xing_out_d_bits_sink),
    .auto_out_d_bits_denied  (auto_tl_slave_clock_xing_out_d_bits_denied),
    .auto_out_d_bits_data    (auto_tl_slave_clock_xing_out_d_bits_data),
    .auto_out_d_bits_corrupt (auto_tl_slave_clock_xing_out_d_bits_corrupt),
    ...
    .auto_out_a_valid        (auto_tl_slave_clock_xing_out_a_valid),
    .auto_out_a_bits_opcode  (auto_tl_slave_clock_xing_out_a_bits_opcode),
    .auto_out_a_bits_param   (auto_tl_slave_clock_xing_out_a_bits_param),
    .auto_out_a_bits_size    (auto_tl_slave_clock_xing_out_a_bits_size),
    .auto_out_a_bits_source  (auto_tl_slave_clock_xing_out_a_bits_source),
    .auto_out_a_bits_address (auto_tl_slave_clock_xing_out_a_bits_address),
    .auto_out_a_bits_mask    (auto_tl_slave_clock_xing_out_a_bits_mask),
    .auto_out_a_bits_data    (auto_tl_slave_clock_xing_out_a_bits_data),
    .auto_out_a_bits_corrupt (auto_tl_slave_clock_xing_out_a_bits_corrupt),
    .auto_out_d_ready        (auto_tl_slave_clock_xing_out_d_ready)
  );
endmodule
