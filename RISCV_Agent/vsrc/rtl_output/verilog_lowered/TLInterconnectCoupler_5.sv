...
module TLInterconnectCoupler_5(
  ...
  input  [31:0] auto_tlserial_manager_crossing_out_d_bits_data,
  ...
  output [3:0]  auto_tlserial_manager_crossing_out_a_bits_mask,
  output [31:0] auto_tlserial_manager_crossing_out_a_bits_data,
  ...
  wire [2:0]  _widget_auto_out_a_bits_source;	// WidthWidget.scala:220:28
  wire [28:0] _widget_auto_out_a_bits_address;	// WidthWidget.scala:220:28
  wire [3:0]  _widget_auto_out_a_bits_mask;	// WidthWidget.scala:220:28
  wire [31:0] _widget_auto_out_a_bits_data;	// WidthWidget.scala:220:28
  wire        _widget_auto_out_a_bits_corrupt;	// WidthWidget.scala:220:28
  wire        _widget_auto_out_d_ready;	// WidthWidget.scala:220:28
  wire        _shrinker_auto_in_a_ready;	// SourceShrinker.scala:89:30
  wire        _shrinker_auto_in_d_valid;	// SourceShrinker.scala:89:30
  wire [2:0]  _shrinker_auto_in_d_bits_opcode;	// SourceShrinker.scala:89:30
  wire [1:0]  _shrinker_auto_in_d_bits_param;	// SourceShrinker.scala:89:30
  wire [2:0]  _shrinker_auto_in_d_bits_size;	// SourceShrinker.scala:89:30
  wire [2:0]  _shrinker_auto_in_d_bits_source;	// SourceShrinker.scala:89:30
  wire        _shrinker_auto_in_d_bits_sink;	// SourceShrinker.scala:89:30
  wire        _shrinker_auto_in_d_bits_denied;	// SourceShrinker.scala:89:30
  wire [31:0] _shrinker_auto_in_d_bits_data;	// SourceShrinker.scala:89:30
  wire        _shrinker_auto_in_d_bits_corrupt;	// SourceShrinker.scala:89:30
  ...
  TLWidthWidget_3 widget (	// WidthWidget.scala:220:28
    ...
    .auto_out_a_ready        (_shrinker_auto_in_a_ready),	// SourceShrinker.scala:89:30
    .auto_out_d_valid        (_shrinker_auto_in_d_valid),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_opcode  (_shrinker_auto_in_d_bits_opcode),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_param   (_shrinker_auto_in_d_bits_param),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_size    (_shrinker_auto_in_d_bits_size),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_source  (_shrinker_auto_in_d_bits_source),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_sink    (_shrinker_auto_in_d_bits_sink),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_denied  (_shrinker_auto_in_d_bits_denied),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_data    (_shrinker_auto_in_d_bits_data),	// SourceShrinker.scala:89:30
    .auto_out_d_bits_corrupt (_shrinker_auto_in_d_bits_corrupt),	// SourceShrinker.scala:89:30
