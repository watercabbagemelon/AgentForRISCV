...
module AsyncQueueSource_1(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_11 ridx_ridx_gray (	// ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_ridx),
    .io_q  (_ridx_ridx_gray_io_q)
  );
  AsyncValidSync_8 source_valid_0 (	// AsyncQueue.scala:100:32
    .clock  (clock),
    .reset  (reset | ~io_async_safe_sink_reset_n),	// AsyncQueue.scala:105:{43,46}
    .io_out (_source_valid_0_io_out)
  );
  AsyncValidSync_9 source_valid_1 (	// AsyncQueue.scala:101:32
  ...
  AsyncValidSync_10 sink_extend (	// AsyncQueue.scala:103:30
  ...
  AsyncValidSync_11 sink_valid (	// AsyncQueue.scala:104:30
