...
module TLXbar(
  ...
  wire        requestDOI_0_0 = auto_out_d_bits_source == 2'h2;	// Parameters.scala:46:9, Xbar.scala:240:55
  wire        out_7_valid = auto_out_d_valid & requestDOI_0_0;	// Parameters.scala:46:9, Xbar.scala:182:40
  ...
  wire [1:0]  readys_readys =
    ~({readys_mask[1], _readys_filter_T_1[1] | readys_mask[0]}
      & {|_readys_filter_T_1, auto_in_1_a_valid | _readys_filter_T_1[0]});	// Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43
  ...
  wire        portsAOI_filtered_0_ready =
    auto_out_a_ready & (idle ? readys_readys[0] : state_0);	// Arbiter.scala:27:18, :89:28, :96:86, :117:26, :122:24, :124:31
  wire        portsAOI_filtered_1_0_ready =
    auto_out_a_ready & (idle ? readys_readys[1] : state_1);	// Arbiter.scala:27:18, :89:28, :96:86, :117:26, :122:24, :124:31
  wire        x1_out_1_valid =
    idle
      ? _out_0_a_earlyValid_T
      : state_0 & auto_in_0_a_valid | state_1 & auto_in_1_a_valid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:29, Mux.scala:27:73
      ...
      if (latch)	// Arbiter.scala:90:24
        beatsLeft <=
          (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2])
             ? ~(_beatsAI_decode_T_1[11:2])
             : 10'h0)
          | (winnerQual_1 & ~(auto_in_1_a_bits_opcode[2])
               ? ~(_beatsAI_decode_T_5[11:2])
               : 10'h0);	// Arbiter.scala:88:30, :99:79, :112:73, :113:44, Edges.scala:91:{28,37}, :220:14, package.scala:235:{46,71,76}
  ...
  assign auto_out_a_bits_opcode =
    ...
    | (muxStateEarly_1 ? auto_in_1_a_bits_opcode : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_param =
    (muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_param : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_size =
    (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_size : 4'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_source =
    (muxStateEarly_0 ? {1'h1, auto_in_0_a_bits_source} : 2'h0)
    | (muxStateEarly_1 ? {1'h0, auto_in_1_a_bits_source} : 2'h0);	// Arbiter.scala:118:30, Bundle_ACancel.scala:56:22, Bundles.scala:259:74, Mux.scala:27:73, Parameters.scala:54:32, Xbar.scala:240:{29,55}
  assign auto_out_a_bits_address =
    (muxStateEarly_0 ? auto_in_0_a_bits_address : 32'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_mask =
    (muxStateEarly_0 ? auto_in_0_a_bits_mask : 4'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 4'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_data =
    (muxStateEarly_0 ? auto_in_0_a_bits_data : 32'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_data : 32'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_corrupt =
    muxStateEarly_0 & auto_in_0_a_bits_corrupt | muxStateEarly_1
    & auto_in_1_a_bits_corrupt;	// Arbiter.scala:118:30, Mux.scala:27:73
  assign auto_out_d_ready =
    requestDOI_0_0 & auto_in_0_d_ready | ~(auto_out_d_bits_source[1]) & auto_in_1_d_ready;	// Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}
endmodule
