...
module BreakpointUnit(
  ...
  wire _T_1 =
    ~io_bp_0_control_chain & ~io_status_debug & io_bp_0_control_r
            ...
            | {28'h0,
               ...
               io_bp_0_control_tmatch[0]}) == (~io_bp_0_address
                                               | {28'h0,
                                                  ...
                                                  _r_T_20,
                                                  _r_T_18,
                                                  io_bp_0_control_tmatch[0]}));	// Breakpoint.scala:30:35, :59:{73,83}, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :109:15, :118:15
  wire _T_3 =
    ~io_bp_0_control_chain & ~io_status_debug & io_bp_0_control_w
    & (io_bp_0_control_tmatch[1]
         ? _w_T_2 ^ io_bp_0_control_tmatch[0]
         : (~io_ea
            | {28'h0,
               ...
               io_bp_0_control_tmatch[0]}) == (~io_bp_0_address
                                               | {28'h0,
                                                  ...
                                                  _w_T_20,
                                                  _w_T_18,
                                                  io_bp_0_control_tmatch[0]}));	// Breakpoint.scala:30:35, :59:{73,83}, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :109:15, :119:15
  wire _T_5 =
    ~io_bp_0_control_chain & ~io_status_debug & io_bp_0_control_x
    & (io_bp_0_control_tmatch[1]
            ...
            | {28'h0,
               ...
               io_bp_0_control_tmatch[0]}) == (~io_bp_0_address
                                               | {28'h0,
                                                  ...
                                                  _x_T_20,
                                                  _x_T_18,
                                                  io_bp_0_control_tmatch[0]}));	// Breakpoint.scala:30:35, :59:{73,83}, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :109:15, :120:15
