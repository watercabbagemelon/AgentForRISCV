...
module TLMonitor_38(
  ...
  wire         _T_507 = a_first_done & ~a_first_counter;	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20
  wire         d_first_done = io_in_d_ready & io_in_d_valid;	// Decoupled.scala:51:35
  wire         _T_535 = d_first_done & ~d_first_counter;	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_opcodes <=
        (inflight_opcodes | (a_set ? {io_in_a_bits_opcode, 1'h1} : 4'h0)) & ~d_sizes_clr;	// Misc.scala:205:21, Monitor.scala:42:11, :613:35, :627:33, :652:{27,72}, :653:28, :654:53, :656:{28,79}, :665:33, :675:91, :677:21, :703:{43,60,62}
      inflight_sizes <=
    ...
    if (_T_507) begin	// Monitor.scala:396:20
      opcode <= io_in_a_bits_opcode;	// Monitor.scala:384:22
      param <= 3'h0;	// Monitor.scala:385:22
      size <= 2'h2;	// Monitor.scala:386:22
      address <= io_in_a_bits_address;	// Monitor.scala:388:22
    end
    source <= ~_T_507 & source;	// Monitor.scala:387:22, :396:{20,32}, :400:15
    if (_T_535) begin	// Monitor.scala:549:20
      opcode_1 <= io_in_d_bits_opcode;	// Monitor.scala:535:22
      param_1 <= 2'h0;	// Monitor.scala:536:22
      size_1 <= io_in_d_bits_size;	// Monitor.scala:537:22
      denied <= io_in_d_bits_denied;	// Monitor.scala:540:22
    end
    source_1 <= ~_T_535 & source_1;	// Monitor.scala:538:22, :549:{20,32}, :553:15
    sink <= ~_T_535 & sink;	// Monitor.scala:538:22, :539:22, :549:{20,32}, :553:15, :554:15
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire             _T_485 = io_in_a_valid & a_first_counter;	// Edges.scala:228:27, Monitor.scala:389:19
    wire             _T_509 = io_in_d_valid & d_first_counter;	// Edges.scala:228:27, Monitor.scala:541:19
    wire             _same_cycle_resp_T_1 = io_in_a_valid & ~a_first_counter_1;	// Edges.scala:228:27, :230:25, Monitor.scala:648:26
    wire             _T_588 = io_in_d_valid & ~d_first_counter_1;	// Edges.scala:228:27, :230:25, Monitor.scala:671:26
    wire             _T_559 = _T_588 & ~d_release_ack;	// Monitor.scala:670:46, :671:{26,74}, :680:71
    wire             _GEN_10 = _T_559 & _same_cycle_resp_T_1;	// Monitor.scala:648:26, :680:71, :684:30
    wire             _GEN_11 = _T_559 & ~_same_cycle_resp_T_1;	// Monitor.scala:648:26, :680:71, :684:30
    wire  [3:0]      _GEN_12 = {2'h0, io_in_d_bits_size};	// Monitor.scala:691:36
    wire             _T_638 = io_in_d_valid & ~d_first_counter_2 & d_release_ack;	// Edges.scala:228:27, :230:25, Monitor.scala:670:46, :791:71
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (io_in_d_valid & io_in_d_bits_opcode == 3'h0 & ~reset
          & io_in_d_bits_corrupt) begin	// Monitor.scala:49:11, :338:25
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (io_in_d_valid & io_in_d_bits_opcode == 3'h1 & ~reset
          & ~(~io_in_d_bits_denied | io_in_d_bits_corrupt)) begin	// Monitor.scala:49:11, :346:25, :350:{15,30}, :640:42
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_T_559 & ~reset & ~(inflight | _same_cycle_resp_T_1)) begin	// Monitor.scala:49:11, :611:27, :648:26, :680:71, :682:49
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_GEN_11 & ~reset & _GEN_12 != {1'h0, inflight_sizes[3:1]}) begin	// Monitor.scala:42:11, :49:11, :615:33, :638:{19,144}, :684:30, :691:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at BusBypass.scala:33:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_588 & ~a_first_counter_1 & io_in_a_valid & ~d_release_ack & ~reset
      ...
      if (_T_638 & ~reset & ~inflight_1) begin	// Monitor.scala:49:11, :723:35, :791:71
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at BusBypass.scala:33:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_638 & ~reset & _GEN_12 != {1'h0, inflight_sizes_1[3:1]}) begin	// Monitor.scala:42:11, :49:11, :691:36, :725:35, :747:{21,146}, :791:71, :797:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at BusBypass.scala:33:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:10], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[9:0]};	// Edges.scala:228:27, Monitor.scala:388:22
        d_first_counter = _RANDOM_4[10];	// Edges.scala:228:27, Monitor.scala:388:22
        opcode_1 = _RANDOM_4[13:11];	// Monitor.scala:388:22, :535:22
        param_1 = _RANDOM_4[15:14];	// Monitor.scala:388:22, :536:22
        size_1 = _RANDOM_4[17:16];	// Monitor.scala:388:22, :537:22
        source_1 = _RANDOM_4[18];	// Monitor.scala:388:22, :538:22
        sink = _RANDOM_4[19];	// Monitor.scala:388:22, :539:22
        denied = _RANDOM_4[20];	// Monitor.scala:388:22, :540:22
        inflight = _RANDOM_4[21];	// Monitor.scala:388:22, :611:27
        inflight_opcodes = _RANDOM_4[25:22];	// Monitor.scala:388:22, :613:35
        inflight_sizes = _RANDOM_4[29:26];	// Monitor.scala:388:22, :615:33
        a_first_counter_1 = _RANDOM_4[30];	// Edges.scala:228:27, Monitor.scala:388:22
        d_first_counter_1 = _RANDOM_4[31];	// Edges.scala:228:27, Monitor.scala:388:22
        watchdog = _RANDOM_5;	// Monitor.scala:706:27
        inflight_1 = _RANDOM_6[0];	// Monitor.scala:723:35
        inflight_sizes_1 = _RANDOM_6[8:5];	// Monitor.scala:723:35, :725:35
        d_first_counter_2 = _RANDOM_6[10];	// Edges.scala:228:27, Monitor.scala:723:35
        watchdog_1 = {_RANDOM_6[31:11], _RANDOM_7[10:0]};	// Monitor.scala:723:35, :815:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
