...
module UARTTx_1(
  ...
  wire        _T_4 = ~(|counter) & io_in_valid;	// Decoupled.scala:51:35, UARTTx.scala:58:24, :66:23, :67:27
    ...
    if (reset) begin
      ...
      if (|counter) begin	// UARTTx.scala:58:24, :66:23
        if (pulse)	// UARTTx.scala:54:26
          prescaler <= 16'h364;	// UARTTx.scala:53:26
      ...
      if (_T_6) begin	// UARTTx.scala:95:15
        ...
        counter <= 4'hA;	// UARTTx.scala:58:24, :89:47
    end
    if (_T_6)	// UARTTx.scala:95:15
      shifter <= {1'h1, shifter[8:1]};	// Cat.scala:33:92, UARTTx.scala:59:20, :97:38
    else if (_T_5)	// UARTTx.scala:72:20
  ...
  assign io_in_ready = ~(|counter);	// UARTTx.scala:58:24, :66:23, :67:27
