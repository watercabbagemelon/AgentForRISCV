...
module MulDiv(
  ...
  wire [40:0] _GEN =
    {{33{remainder[32]}}, remainder[7:0]} * {{8{divisor[32]}}, divisor}
    + {{8{remainder[65]}}, remainder[65:33]};	// Multiplier.scala:57:20, :58:22, :104:31, :105:31, :106:24, :109:{38,67,76}
  ...
  wire        rhs_sign =
    (|{&_decoded_T_2, &{decoded_invInputs[0], io_req_bits_fn[2]}}) & io_req_bits_in2[31];	// Cat.scala:33:92, Multiplier.scala:78:{23,48}, pla.scala:78:21, :90:45, :91:29, :98:74, :114:39
  ...
  always @(posedge clock) begin
    ...
    if (_T_23) begin	// Decoupled.scala:51:35
      ...
      if (_T_17) begin	// Multiplier.scala:126:39
        ...
        remainder <=
          {1'h0,
           subtractor[32] ? remainder[63:32] : subtractor[31:0],
           remainder[31:0],
           ~(subtractor[32])};	// Multiplier.scala:50:16, :58:22, :85:37, :86:57, :130:28, :131:{14,24,45,67}, :134:15
      end
