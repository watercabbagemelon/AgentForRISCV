...
module DCacheModuleImpl_Anon_2(
  ...
  assign io_in_3_ready = ~_grant_T;	// Arbiter.scala:45:{68,78}
  assign io_out_valid = _grant_T | io_in_3_valid;	// Arbiter.scala:45:68, :147:31
  assign io_out_bits_addr =
    io_in_0_valid
      ? io_in_0_bits_addr
      : io_in_1_valid ? io_in_1_bits_addr : io_in_3_bits_addr;	// Arbiter.scala:138:26, :140:19
  assign io_out_bits_write =
    io_in_0_valid ? io_in_0_bits_write : io_in_1_valid & io_in_1_bits_write;	// Arbiter.scala:138:26, :140:19
  assign io_out_bits_wdata =
    io_in_0_valid
      ? io_in_0_bits_wdata
      : io_in_1_valid ? io_in_1_bits_wdata : io_in_3_bits_wdata;	// Arbiter.scala:138:26, :140:19
  assign io_out_bits_eccMask =
    io_in_0_valid ? io_in_0_bits_eccMask : io_in_1_valid ? io_in_1_bits_eccMask : 4'hF;	// Arbiter.scala:138:26, :140:19
endmodule
