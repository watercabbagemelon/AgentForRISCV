...
module IBuf(
  ...
  reg  [31:0]  buf_pc;	// IBuf.scala:35:16
  ...
  wire [1:0]   nIC =
    (io_imem_bits_btb_taken ? {1'h0, io_imem_bits_btb_bridx} + 2'h1 : 2'h2) - _GEN;	// IBuf.scala:34:47, :41:{16,64,86}, :92:63
  ...
  wire [190:0] _icData_T_4 =
    {63'h0,
     ...
     io_imem_bits_data,
     {2{io_imem_bits_data[15:0]}}} << {185'h0, _GEN_0 - 2'h2 - _GEN, 4'h0};	// Cat.scala:33:92, IBuf.scala:41:86, :42:25, :68:{34,46}, :69:87, :120:58, :121:10, :128:19
  wire [62:0]  _icMask_T_2 = 63'hFFFFFFFF << {58'h0, nBufValid, 4'h0};	// IBuf.scala:34:47, :71:51, :128:{10,19}
  wire [31:0]  inst =
    _icData_T_4[95:64] & _icMask_T_2[31:0] | buf_data & ~(_icMask_T_2[31:0]);	// IBuf.scala:35:16, :71:{51,92}, :72:{21,30,41,43}, :121:10, package.scala:155:13
  ...
  wire [2:0]   _io_inst_0_bits_xcpt1_WIRE_1 =
    _exp_io_rvc
      ...
      : {bufMask[1] ? buf_xcpt_pf_inst : io_imem_bits_xcpt_pf_inst,
         ...
         bufMask[1] ? buf_xcpt_ae_inst : io_imem_bits_xcpt_ae_inst};	// IBuf.scala:35:16, :75:37, :76:{53,61}, :86:21, :96:{35,65}
  ...
  wire [63:0]  _buf_data_T_1 =
    {{2{io_imem_bits_data[31:16]}}, io_imem_bits_data} >> {58'h0, _GEN + nICReady, 4'h0};	// Cat.scala:33:92, IBuf.scala:41:86, :42:25, :55:32, :127:58, :128:{10,19}
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      nBufValid <=
        ...
        & (io_inst_0_ready
             ...
             : nBufValid);	// IBuf.scala:34:47, :40:27, :44:{47,94}, :47:29, :48:{17,23,61}, :54:{68,94}, :56:{19,26}, :63:20, :64:17, :102:{60,69}, package.scala:210:{38,43}
    if (io_inst_0_ready & _T_7) begin	// IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13
      buf_pc <=
        ...
        & 32'h3;	// IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// IBuf.scala:79:9
      if (~reset
          & ~(~io_imem_valid | ~io_imem_bits_btb_taken
              | io_imem_bits_btb_bridx >= io_imem_bits_pc[1])) begin	// IBuf.scala:79:{9,10,28,52,78}, package.scala:155:13
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM_1[31:17], _RANDOM_2[16:0]};	// IBuf.scala:35:16
        buf_data = {_RANDOM_2[31:17], _RANDOM_3[16:0]};	// IBuf.scala:35:16
        buf_xcpt_pf_inst = _RANDOM_3[19];	// IBuf.scala:35:16
        buf_xcpt_gf_inst = _RANDOM_3[20];	// IBuf.scala:35:16
        buf_xcpt_ae_inst = _RANDOM_3[21];	// IBuf.scala:35:16
        buf_replay = _RANDOM_3[22];	// IBuf.scala:35:16
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_imem_ready =
    io_inst_0_ready & _T & (nICReady >= nIC | ~(_io_imem_ready_T_4[1]));	// IBuf.scala:41:86, :42:25, :44:{47,60,73,80,87,94}
  ...
  assign io_inst_0_bits_xcpt0_pf_inst =
    bufMask[0] ? buf_xcpt_pf_inst : io_imem_bits_xcpt_pf_inst;	// IBuf.scala:35:16, :75:37, :76:{53,61}
  assign io_inst_0_bits_xcpt0_gf_inst =
    bufMask[0] ? buf_xcpt_gf_inst : io_imem_bits_xcpt_gf_inst;	// IBuf.scala:35:16, :75:37, :76:{53,61}
  assign io_inst_0_bits_xcpt0_ae_inst =
    bufMask[0] ? buf_xcpt_ae_inst : io_imem_bits_xcpt_ae_inst;	// IBuf.scala:35:16, :75:37, :76:{53,61}
