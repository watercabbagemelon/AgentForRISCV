...
module HellaPeekingArbiter_1(
  ...
  wire [7:0]       _GEN_6 =
    {_GEN_1, {{io_in_4_valid}, {1'h0}, {1'h0}, {io_in_1_valid}, {1'h0}}};	// Arbiters.scala:43:16
  wire             _io_out_valid_output = _GEN_6[chosen];	// Arbiters.scala:37:19, :43:16
  wire [7:0][2:0]  _GEN_7 =
    {_GEN_4, {{io_in_4_bits_opcode}, {3'h0}, {3'h0}, {io_in_1_bits_opcode}, {3'h0}}};	// Arbiters.scala:43:16
  wire [7:0][2:0]  _GEN_8 =
    {_GEN_4, {{io_in_4_bits_param}, {3'h0}, {3'h0}, {io_in_1_bits_param}, {3'h0}}};	// Arbiters.scala:43:16
  wire [7:0][7:0]  _GEN_9 =
    {_GEN_3, {{io_in_4_bits_size}, {8'h0}, {8'h0}, {io_in_1_bits_size}, {8'h0}}};	// Arbiters.scala:43:16
  wire [7:0][7:0]  _GEN_10 =
    {_GEN_3, {{io_in_4_bits_source}, {8'h0}, {8'h0}, {io_in_1_bits_source}, {8'h0}}};	// Arbiters.scala:43:16
  wire [7:0][63:0] _GEN_11 =
    {_GEN_2, {{io_in_4_bits_address}, {64'h0}, {64'h0}, {64'h0}, {64'h0}}};	// Arbiters.scala:43:16
  wire [7:0][63:0] _GEN_12 =
    {_GEN_2, {{io_in_4_bits_data}, {64'h0}, {64'h0}, {io_in_1_bits_data}, {64'h0}}};	// Arbiters.scala:43:16
  wire [7:0]       _GEN_13 =
    {_GEN_1, {{io_in_4_bits_corrupt}, {1'h0}, {1'h0}, {io_in_1_bits_corrupt}, {1'h0}}};	// Arbiters.scala:43:16
  wire [7:0][8:0]  _GEN_14 =
    {_GEN_0, {{io_in_4_bits_union}, {9'h0}, {9'h0}, {io_in_1_bits_union}, {9'h0}}};	// Arbiters.scala:43:16
  wire [7:0]       _GEN_15 =
    {_GEN, {{io_in_4_bits_last}, {1'h1}, {1'h1}, {io_in_1_bits_last}, {1'h1}}};	// Arbiters.scala:43:16
