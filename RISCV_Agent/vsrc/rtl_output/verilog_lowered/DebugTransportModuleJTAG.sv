...
module DebugTransportModuleJTAG(
  ...
  wire        _io_dmi_resp_ready_output =
    dmiReqReg_op == 2'h2 ? io_dmi_resp_valid : _dmiAccessChain_io_capture_capture & ~busy;	// DebugTransport.scala:110:23, :134:31, :155:42, :224:27, :225:18, :229:{41,43}
  wire        tapIO_icodeSelects_0 =
    _tapIO_controllerInternal_io_output_instruction == 5'h1;	// JtagTap.scala:199:36, :223:82
  wire        tapIO_icodeSelects_0_1 =
    _tapIO_controllerInternal_io_output_instruction == 5'h10;	// JtagTap.scala:199:36, :223:82
  wire        tapIO_icodeSelects_0_2 =
    _tapIO_controllerInternal_io_output_instruction == 5'h11;	// JtagTap.scala:199:36, :223:82
  wire        _GEN_1 =
    _tapIO_controllerInternal_io_output_tapIsInTestLogicReset
    | _dtmInfoChain_io_update_valid & _dtmInfoChain_io_update_bits_dmireset;	// DebugTransport.scala:128:29, :163:44, :168:39, :169:49, :170:28, :171:21, :269:45, :271:19, JtagTap.scala:199:36
  always @(posedge io_jtag_clock or posedge io_jtag_reset) begin
    if (io_jtag_reset) begin
      ...
      busyReg <=
        ~(_tapIO_controllerInternal_io_output_tapIsInTestLogicReset
          | _io_dmi_resp_ready_output & io_dmi_resp_valid) & (dmiReqValidReg | busyReg);	// DebugTransport.scala:96:24, :111:31, :143:27, :144:13, :146:29, :147:13, :224:27, :269:45, :270:13, Decoupled.scala:51:35, JtagTap.scala:199:36
      stickyBusyReg <=
        ~_GEN_1 & (_dmiAccessChain_io_capture_capture & _busy_T_1 | stickyBusyReg);	// DebugTransport.scala:97:30, :134:31, :155:20, :163:44, :165:19, :168:39, :169:49, :171:21, :269:45, :271:19
      stickyNonzeroRespReg <=
        ~_GEN_1
        & (_dmiAccessChain_io_capture_capture & _nonzeroResp_T_1 | stickyNonzeroRespReg);	// DebugTransport.scala:98:37, :134:31, :163:44, :166:26, :168:39, :169:49, :170:28, :171:21, :178:60, :269:45, :271:19, :272:26
      downgradeOpReg <=
        ~_tapIO_controllerInternal_io_output_tapIsInTestLogicReset
        & (_dmiAccessChain_io_capture_capture
             ? ~busy & (stickyNonzeroRespReg | _nonzeroResp_T_1)
             : ~_dmiAccessChain_io_update_valid & downgradeOpReg);	// DebugTransport.scala:98:37, :100:31, :134:31, :155:42, :160:41, :161:20, :163:44, :164:{20,24,30}, :178:{39,60}, :269:45, :273:20, JtagTap.scala:199:36
      dmiReqValidReg <=
        ~(_tapIO_controllerInternal_io_output_tapIsInTestLogicReset | _T_12)
        & (_dmiAccessChain_io_update_valid & ~_GEN_0 | dmiReqValidReg);	// DebugTransport.scala:111:31, :134:31, :205:41, :206:26, :208:97, :215:22, :220:28, :221:20, :269:45, :274:20, Decoupled.scala:51:35, JtagTap.scala:199:36
    end
  ...
  CaptureUpdateChain dtmInfoChain (	// DebugTransport.scala:128:29
    ...
    .reset                     (io_jtag_reset),
    .io_chainIn_shift
      (tapIO_icodeSelects_0_1 & _tapIO_controllerInternal_io_dataChainOut_shift),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_data
      (tapIO_icodeSelects_0_1 & _tapIO_controllerInternal_io_dataChainOut_data),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_capture
      (tapIO_icodeSelects_0_1 & _tapIO_controllerInternal_io_dataChainOut_capture),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_update
      (tapIO_icodeSelects_0_1 & _tapIO_controllerInternal_io_dataChainOut_update),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_capture_bits_dmiStatus
      ({stickyNonzeroRespReg, stickyNonzeroRespReg | stickyBusyReg}),	// Cat.scala:33:92, DebugTransport.scala:97:30, :98:37, :118:63
  ...
  CaptureUpdateChain_1 dmiAccessChain (	// DebugTransport.scala:134:31
    ...
    .reset                (io_jtag_reset),
    .io_chainIn_shift
      (tapIO_icodeSelects_0_2 & _tapIO_controllerInternal_io_dataChainOut_shift),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_data
      (tapIO_icodeSelects_0_2 & _tapIO_controllerInternal_io_dataChainOut_data),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_capture
      (tapIO_icodeSelects_0_2 & _tapIO_controllerInternal_io_dataChainOut_capture),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_update
      (tapIO_icodeSelects_0_2 & _tapIO_controllerInternal_io_dataChainOut_update),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    ...
    .io_capture_bits_resp
      (busy ? 2'h3 : io_dmi_resp_valid ? io_dmi_resp_bits_resp : 2'h0),	// DebugTransport.scala:155:42, :183:21, :191:16, :197:{40,60}
  ...
  CaptureChain tapIO_idcodeChain (	// JtagTap.scala:181:33
    ...
    .reset              (io_jtag_reset),
    .io_chainIn_shift
      (tapIO_icodeSelects_0 & _tapIO_controllerInternal_io_dataChainOut_shift),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_data
      (tapIO_icodeSelects_0 & _tapIO_controllerInternal_io_dataChainOut_data),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_capture
      (tapIO_icodeSelects_0 & _tapIO_controllerInternal_io_dataChainOut_capture),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
    .io_chainIn_update
      (tapIO_icodeSelects_0 & _tapIO_controllerInternal_io_dataChainOut_update),	// JtagTap.scala:199:36, :223:82, :245:21, :246:26, :248:26
      ...
      (tapIO_icodeSelects_0
         ...
         : tapIO_icodeSelects_0_1
             ...
             : tapIO_icodeSelects_0_2
                 ...
                 : _tapIO_bypassChain_io_chainOut_data),	// DebugTransport.scala:128:29, :134:31, JtagTap.scala:181:33, :207:29, :223:82, :233:28, :234:43, :240:41
