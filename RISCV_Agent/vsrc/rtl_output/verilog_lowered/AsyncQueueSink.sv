...
module AsyncQueueSink(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_5 widx_widx_gray (	// ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
  ...
  AsyncValidSync_4 sink_valid_0 (	// AsyncQueue.scala:168:33
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// AsyncQueue.scala:173:{42,45}
    .io_out (_sink_valid_0_io_out)
  );
  AsyncValidSync_5 sink_valid_1 (	// AsyncQueue.scala:169:33
  ...
  AsyncValidSync_6 source_extend (	// AsyncQueue.scala:171:31
  ...
  AsyncValidSync_7 source_valid (	// AsyncQueue.scala:172:31
