...
module TLMonitor_4(
  ...
  wire        _T_881 = io_in_a_ready & io_in_a_valid;	// Decoupled.scala:51:35
  ...
  wire        _T_812 = _T_881 & a_first_1;	// Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27
  ...
  wire [66:0] _a_opcodes_set_T_1 =
    {63'h0, _T_812 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_1;	// Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54
  wire [78:0] _d_sizes_clr_T_5 = 79'hF << _GEN_2;	// Monitor.scala:677:76, :678:74
  wire [66:0] _a_sizes_set_T_1 =
    {63'h0, _T_812 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_1;	// Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52
  wire        _T_949 = io_in_d_ready & io_in_d_valid;	// Decoupled.scala:51:35
  wire        _T_827 = _T_949 & d_first_1 & ~d_release_ack;	// Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_881) begin	// Decoupled.scala:51:35
      ...
      if (_T_949) begin	// Decoupled.scala:51:35
      ...
      inflight <=
        (inflight | (_T_812 ? _a_set_T[4:0] : 5'h0)) & ~(_T_827 ? _d_clr_T[4:0] : 5'h0);	// Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35
      inflight_opcodes <=
        (inflight_opcodes | (_T_812 ? _a_opcodes_set_T_1[19:0] : 20'h0))
        & ~(_T_827 ? _d_opcodes_clr_T_5[19:0] : 20'h0);	// Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35
      inflight_sizes <=
        (inflight_sizes | (_T_812 ? _a_sizes_set_T_1[19:0] : 20'h0))
        & ~(_T_827 ? _d_sizes_clr_T_5[19:0] : 20'h0);	// Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35
      if (_T_881 | _T_949)	// Decoupled.scala:51:35, Monitor.scala:712:27
        watchdog <= 32'h0;	// Bundles.scala:259:74, Monitor.scala:706:27
      else	// Monitor.scala:712:27
        watchdog <= watchdog + 32'h1;	// Monitor.scala:706:27, :711:26
    end
    if (_T_881 & ~(|a_first_counter)) begin	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20
    ...
    if (_T_949 & ~(|d_first_counter)) begin	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_757 = io_in_a_valid & (|a_first_counter);	// Edges.scala:228:27, :230:25, Monitor.scala:389:19
    wire             _T_781 = io_in_d_valid & (|d_first_counter);	// Edges.scala:228:27, :230:25, Monitor.scala:541:19
    wire  [19:0]     _GEN_24 = {15'h0, io_in_d_bits_source, 2'h0};	// Bundles.scala:259:74, Monitor.scala:634:44, Parameters.scala:46:9
    wire  [19:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_24;	// Monitor.scala:613:35, :634:44
    wire             _T_860 = io_in_d_valid & d_first_1;	// Edges.scala:230:25, Monitor.scala:671:26
    wire             _T_831 = _T_860 & ~d_release_ack;	// Monitor.scala:670:46, :671:{26,74}, :680:71
    ...
    wire             _GEN_26 = _T_831 & same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    wire             _GEN_27 = _T_831 & ~same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    wire             _T_910 = io_in_d_valid & d_first_2 & d_release_ack;	// Edges.scala:230:25, Monitor.scala:670:46, :791:71
    wire  [4:0]      _T_813 = inflight >> io_in_a_bits_source;	// Monitor.scala:611:27, :658:26
    wire  [4:0]      _T_832 = inflight >> _GEN_25;	// Monitor.scala:611:27, :682:25
    wire  [19:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// Monitor.scala:615:33, :634:44, :638:40
    wire  [4:0]      _T_911 = 5'h0 >> _GEN_25;	// Monitor.scala:682:25, :723:35, :793:25
    ...
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_GEN_9 & ~reset
          & ~(io_in_a_bits_size != 3'h7
              & (io_in_a_bits_address[30:12] == 19'h4
                 | io_in_a_bits_address[30:16] == 15'h2
                 | io_in_a_bits_address[30:12] == 19'h10000
                 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :670:56, :671:42
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_11 & ~reset
          & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2
              ...
              & (io_in_a_bits_address[30:12] == 19'h4
                 | io_in_a_bits_address[30:12] == 19'h10000
                 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :92:42, :137:{31,65}, :671:42, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_12 & ~reset
          & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2
              ...
              & (io_in_a_bits_address[30:12] == 19'h4
                 | io_in_a_bits_address[30:12] == 19'h10000
                 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :92:42, :137:{31,65}, :671:42, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_T_860 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source
      ...
      if (_T_910 & ~reset & ~(_T_911[0])) begin	// Monitor.scala:49:11, :791:71, :793:25
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_910 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// Monitor.scala:49:11, :747:42, :791:71, :797:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:16], _RANDOM_1[14:0]};	// Edges.scala:228:27, Monitor.scala:388:22
        d_first_counter = _RANDOM_1[18:15];	// Edges.scala:228:27, Monitor.scala:388:22
        ...
        source_1 = _RANDOM_1[29:27];	// Monitor.scala:388:22, :538:22
        sink = _RANDOM_1[30];	// Monitor.scala:388:22, :539:22
        denied = _RANDOM_1[31];	// Monitor.scala:388:22, :540:22
        inflight = _RANDOM_2[4:0];	// Monitor.scala:611:27
        inflight_opcodes = _RANDOM_2[24:5];	// Monitor.scala:611:27, :613:35
        inflight_sizes = {_RANDOM_2[31:25], _RANDOM_3[12:0]};	// Monitor.scala:611:27, :615:33
        a_first_counter_1 = _RANDOM_3[16:13];	// Edges.scala:228:27, Monitor.scala:615:33
        d_first_counter_1 = _RANDOM_3[20:17];	// Edges.scala:228:27, Monitor.scala:615:33
        watchdog = {_RANDOM_3[31:21], _RANDOM_4[20:0]};	// Monitor.scala:615:33, :706:27
        d_first_counter_2 = _RANDOM_6[9:6];	// Edges.scala:228:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
