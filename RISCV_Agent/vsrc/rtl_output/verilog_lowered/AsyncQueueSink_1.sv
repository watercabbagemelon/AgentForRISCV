...
module AsyncQueueSink_1(
  ...
  wire        ridx_incremented =
    _source_valid_io_out & ridx_ridx_bin + (io_deq_ready & _io_deq_valid_output);	// AsyncQueue.scala:52:25, :53:{23,43}, :162:29, :172:31, Decoupled.scala:51:35
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_17 widx_widx_gray (	// ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
  ...
  AsyncValidSync_12 sink_valid_0 (	// AsyncQueue.scala:168:33
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// AsyncQueue.scala:173:{42,45}
    .io_out (_sink_valid_0_io_out)
  );
  AsyncValidSync_13 sink_valid_1 (	// AsyncQueue.scala:169:33
  ...
  AsyncValidSync_14 source_extend (	// AsyncQueue.scala:171:31
  ...
  AsyncValidSync_15 source_valid (	// AsyncQueue.scala:172:31
