    ...
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_GEN_7 & ~reset
          & ~(_T_407 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7
              & (_GEN_8 == 19'h0 | io_in_a_bits_address[31:16] == 16'h1
                 | io_in_a_bits_address[31:16] == 16'h2 | _GEN_9 == 19'h0
      ...
      if (_GEN_26 & ~reset
          & ~(io_in_d_bits_opcode == _GEN_2[io_in_a_bits_opcode]
              | io_in_d_bits_opcode == _GEN_1[io_in_a_bits_opcode])) begin	// Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_GEN_27 & ~reset
          & ~(io_in_d_bits_opcode == _GEN_2[_a_opcode_lookup_T_1[3:1]]
              | io_in_d_bits_opcode == _GEN_1[_a_opcode_lookup_T_1[3:1]])) begin	// Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
