...
module TLMonitor(
  ...
  wire [18:0] _a_opcodes_set_T_1 =
    ...
    << {16'h0, io_in_a_bits_source, 2'h0};	// Misc.scala:205:21, Monitor.scala:42:11, :138:25, :638:65, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, package.scala:235:71
  ...
  wire        _T_1122 = _T_1276 & ~(|d_first_counter);	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  wire        d_clr = _T_1276 & d_first_1 & ~d_release_ack;	// Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | _T_1127 & ~io_in_a_bits_source) & ~d_clr;	// Monitor.scala:611:27, :623:34, :649:22, :652:{27,72}, :653:28, :675:72, :702:{27,36,38}
      inflight_opcodes <=
        (inflight_opcodes | (_T_1127 ? _a_opcodes_set_T_1[3:0] : 4'h0)) & ~{4{d_clr}};	// Monitor.scala:138:25, :613:35, :627:33, :638:65, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:21, :703:{43,60,62}
      inflight_sizes <=
        (inflight_sizes | (_T_1127 ? _a_sizes_set_T_1[7:0] : 8'h0)) & ~{8{d_clr}};	// Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:21, :704:{39,54,56}, :745:35
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_24 = _T_1146 & same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    ...
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_T_1146 & ~reset & ~(inflight | same_cycle_resp)) begin	// Monitor.scala:49:11, :611:27, :680:71, :681:88, :682:49
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_GEN_25 & ~reset
          & ~(io_in_d_bits_opcode == _GEN_2[inflight_opcodes[3:1]]
              | io_in_d_bits_opcode == _GEN_1[inflight_opcodes[3:1]])) begin	// Monitor.scala:42:11, :49:11, :613:35, :634:152, :684:30, :685:38, :686:39, :689:{38,72}, :690:38
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      ...
      if (_GEN_25 & ~reset
          & {4'h0, io_in_d_bits_size} != {1'h0, inflight_sizes[7:1]}) begin	// Monitor.scala:42:11, :49:11, :138:25, :615:33, :638:{19,65,144}, :684:30, :691:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_1175 & a_first_1 & io_in_a_valid & ~io_in_a_bits_source & ~d_release_ack
          & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (~reset
          & ~(a_set_wo_ready != (_T_1175 & ~d_release_ack) | ~a_set_wo_ready)) begin	// Monitor.scala:49:11, :624:34, :648:71, :649:22, :670:46, :671:{26,71,74}, :699:{29,48,51}
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
