...
module TLMonitor_44(
  ...
  wire        _T_768 = io_in_a_ready & io_in_a_valid;	// Decoupled.scala:51:35
  ...
  wire        _T_692 = _T_768 & a_first_1;	// Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27
  ...
  wire [66:0] _a_opcodes_set_T_1 =
    {63'h0, _T_692 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54
  wire [78:0] _d_sizes_clr_T_5 = 79'hF << _GEN_4;	// Monitor.scala:677:76, :678:74
  wire [66:0] _a_sizes_set_T_1 =
    {63'h0, _T_692 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52
  wire        _T_841 = io_in_d_ready & io_in_d_valid;	// Decoupled.scala:51:35
  wire        _T_707 = _T_841 & d_first_1 & ~d_release_ack;	// Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_768) begin	// Decoupled.scala:51:35
      ...
      if (_T_841) begin	// Decoupled.scala:51:35
      ...
      if (_T_768 | _T_841)	// Decoupled.scala:51:35, Monitor.scala:712:27
        watchdog <= 32'h0;	// Bundles.scala:259:74, Monitor.scala:706:27
      else	// Monitor.scala:712:27
        watchdog <= watchdog + 32'h1;	// Monitor.scala:706:27, :711:26
    end
    if (_T_768 & ~(|a_first_counter)) begin	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20
    ...
    if (_T_841 & ~(|d_first_counter)) begin	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_28 = _T_711 & same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    wire             _GEN_29 = _T_711 & ~same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    wire             _T_797 = io_in_d_valid & d_first_2 & d_release_ack;	// Edges.scala:230:25, Monitor.scala:670:46, :791:71
    wire  [4:0]      _T_693 = inflight >> io_in_a_bits_source;	// Monitor.scala:611:27, :658:26
    wire  [4:0]      _T_712 = inflight >> _GEN_27;	// Monitor.scala:611:27, :682:25
    ...
    wire  [4:0]      _T_798 = 5'h0 >> _GEN_27;	// Monitor.scala:682:25, :723:35, :793:25
    ...
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (~reset
          & ~(a_set_wo_ready != (_T_740 & ~d_release_ack ? _d_clr_wo_ready_T[4:0] : 5'h0)
      ...
      if (_T_797 & ~reset & ~(_T_798[0])) begin	// Monitor.scala:49:11, :791:71, :793:25
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at CrossingHelper.scala:30:44)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_797 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// Monitor.scala:49:11, :747:42, :791:71, :797:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:30:44)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
