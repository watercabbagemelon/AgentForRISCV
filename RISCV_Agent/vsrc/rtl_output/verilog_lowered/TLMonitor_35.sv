...
module TLMonitor_35(
  ...
  wire        _T_498 = a_first_done & ~a_first_counter;	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20
  wire        d_first_done = io_in_d_ready & io_in_d_valid;	// Decoupled.scala:51:35
  wire        _T_526 = d_first_done & ~d_first_counter;	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  ...
  always @(posedge clock) begin
    ...
    if (_T_498) begin	// Monitor.scala:396:20
      opcode <= io_in_a_bits_opcode;	// Monitor.scala:384:22
      param <= 3'h0;	// Monitor.scala:385:22
      size <= 2'h2;	// Monitor.scala:386:22
      address <= io_in_a_bits_address;	// Monitor.scala:388:22
    end
    source <= ~_T_498 & source;	// Monitor.scala:387:22, :396:{20,32}, :400:15
    if (_T_526) begin	// Monitor.scala:549:20
    ...
    source_1 <= ~_T_526 & source_1;	// Monitor.scala:538:22, :549:{20,32}, :553:15
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire             _T_476 = io_in_a_valid & a_first_counter;	// Edges.scala:228:27, Monitor.scala:389:19
    wire             _T_500 = io_in_d_valid & d_first_counter;	// Edges.scala:228:27, Monitor.scala:541:19
    wire             _same_cycle_resp_T_1 = io_in_a_valid & ~a_first_counter_1;	// Edges.scala:228:27, :230:25, Monitor.scala:648:26
    wire             _T_579 = io_in_d_valid & ~d_first_counter_1;	// Edges.scala:228:27, :230:25, Monitor.scala:671:26
    wire             _T_550 = _T_579 & ~d_release_ack;	// Monitor.scala:670:46, :671:{26,74}, :680:71
    wire             _GEN_14 = _T_550 & _same_cycle_resp_T_1;	// Monitor.scala:648:26, :680:71, :684:30
    wire             _GEN_15 = _T_550 & ~_same_cycle_resp_T_1;	// Monitor.scala:648:26, :680:71, :684:30
    wire  [3:0]      _GEN_16 = {2'h0, io_in_d_bits_size};	// Monitor.scala:122:25, :691:36
    wire             _T_629 = io_in_d_valid & ~d_first_counter_2 & d_release_ack;	// Edges.scala:228:27, :230:25, Monitor.scala:670:46, :791:71
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset
          & (|(io_in_a_bits_address[1:0]))) begin	// Edges.scala:20:{16,24}, Monitor.scala:42:11, :104:25
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (io_in_a_valid & io_in_a_bits_opcode == 3'h0 & ~reset
          & (|(io_in_a_bits_address[1:0]))) begin	// Edges.scala:20:{16,24}, Monitor.scala:42:11, :114:25
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_T_476 & ~reset & io_in_a_bits_opcode != opcode) begin	// Monitor.scala:42:11, :384:22, :389:19, :390:32
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
          $error("Assertion failed: 'A' channel opcode changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:42 assert(cond, message)\n");	// Monitor.scala:42:11
        if (`STOP_COND_)	// Monitor.scala:42:11
          $fatal;	// Monitor.scala:42:11
      end
      if (_T_476 & ~reset & (|param)) begin	// Monitor.scala:42:11, :385:22, :389:19, :391:32
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
          $error("Assertion failed: 'A' channel param changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:42 assert(cond, message)\n");	// Monitor.scala:42:11
        if (`STOP_COND_)	// Monitor.scala:42:11
          $fatal;	// Monitor.scala:42:11
      end
      if (_T_476 & ~reset & size != 2'h2) begin	// Monitor.scala:42:11, :386:22, :389:19, :392:32
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
          $error("Assertion failed: 'A' channel size changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:42 assert(cond, message)\n");	// Monitor.scala:42:11
        if (`STOP_COND_)	// Monitor.scala:42:11
          $fatal;	// Monitor.scala:42:11
      end
      if (_T_476 & ~reset & source) begin	// Monitor.scala:42:11, :387:22, :389:19
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
          $error("Assertion failed: 'A' channel source changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:42 assert(cond, message)\n");	// Monitor.scala:42:11
        if (`STOP_COND_)	// Monitor.scala:42:11
          $fatal;	// Monitor.scala:42:11
      end
      if (_T_476 & ~reset & io_in_a_bits_address != address) begin	// Monitor.scala:42:11, :388:22, :389:19, :394:32
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
          $error("Assertion failed: 'A' channel address changed with multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:42 assert(cond, message)\n");	// Monitor.scala:42:11
        if (`STOP_COND_)	// Monitor.scala:42:11
          $fatal;	// Monitor.scala:42:11
      end
      if (_T_500 & ~reset & io_in_d_bits_opcode != opcode_1) begin	// Monitor.scala:49:11, :535:22, :541:19, :542:29
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel opcode changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_500 & ~reset & io_in_d_bits_param != param_1) begin	// Monitor.scala:49:11, :536:22, :541:19, :543:29
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel param changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_500 & ~reset & io_in_d_bits_size != size_1) begin	// Monitor.scala:49:11, :537:22, :541:19, :544:29
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel size changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_500 & ~reset & source_1) begin	// Monitor.scala:49:11, :538:22, :541:19
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel source changed within multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_500 & ~reset & io_in_d_bits_sink != sink) begin	// Monitor.scala:49:11, :539:22, :541:19, :546:29
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel sink changed with multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_500 & ~reset & io_in_d_bits_denied != denied) begin	// Monitor.scala:49:11, :540:22, :541:19, :547:29
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel denied changed with multibeat operation (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      ...
      if (_T_550 & ~reset & ~(inflight | _same_cycle_resp_T_1)) begin	// Monitor.scala:49:11, :611:27, :648:26, :680:71, :682:49
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_GEN_14 & ~reset
          & ~(io_in_d_bits_opcode == _GEN_0[io_in_a_bits_opcode]
              | io_in_d_bits_opcode == _GEN[io_in_a_bits_opcode])) begin	// Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
      ...
      if (_GEN_15 & ~reset & _GEN_16 != {1'h0, inflight_sizes[3:1]}) begin	// Monitor.scala:42:11, :49:11, :615:33, :638:{19,144}, :684:30, :691:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_579 & ~a_first_counter_1 & io_in_a_valid & ~d_release_ack & ~reset
      ...
      if (_T_629 & ~reset & ~inflight_1) begin	// Monitor.scala:49:11, :723:35, :791:71
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
      end
      if (_T_629 & ~reset & _GEN_16 != {1'h0, inflight_sizes_1[3:1]}) begin	// Monitor.scala:42:11, :49:11, :691:36, :725:35, :747:{21,146}, :791:71, :797:36
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper response size (connected at Debug.scala:671:18)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
