...
module TLXbar_6(
  ...
  assign auto_out_a_bits_opcode =
    (x1_out_1_bits_source ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// Arbiter.scala:26:66, :118:30, Mux.scala:27:73
  ...
  assign auto_out_a_bits_size =
    (x1_out_1_bits_source ? auto_in_0_a_bits_size : 4'h0)
    | (muxStateEarly_1 ? 4'h6 : 4'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_source = x1_out_1_bits_source;	// Arbiter.scala:118:30
  assign auto_out_a_bits_address =
    (x1_out_1_bits_source ? auto_in_0_a_bits_address : 32'h0)
    | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// Arbiter.scala:118:30, Mux.scala:27:73
  assign auto_out_a_bits_mask =
    (x1_out_1_bits_source ? auto_in_0_a_bits_mask : 4'h0) | {4{muxStateEarly_1}};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  ...
  assign auto_out_d_ready =
    auto_out_d_bits_source & auto_in_0_d_ready | ~auto_out_d_bits_source;	// Mux.scala:27:73, Parameters.scala:46:9
endmodule
