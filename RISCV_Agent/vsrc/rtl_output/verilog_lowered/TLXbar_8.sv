...
module TLXbar_8(
  ...
  wire       requestAIO_0_0 =
    ...
    | auto_in_a_bits_address[8:7] == 2'h1 | auto_in_a_bits_address[8];	// Parameters.scala:137:{31,45,65}, Xbar.scala:366:92
  wire       requestAIO_0_1 =
    {auto_in_a_bits_address[8:4] ^ 5'h4, auto_in_a_bits_address[2]} == 6'h0
    | auto_in_a_bits_address[8:3] == 6'hA;	// Parameters.scala:137:{31,45,65}, Xbar.scala:366:92
  wire       _portsAOI_in_0_a_ready_WIRE =
    requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready;	// Mux.scala:27:73, Xbar.scala:366:92
  ...
  wire       out_9_valid =
    beatsLeft
      ...
      : _sink_ACancel_earlyValid_T;	// Arbiter.scala:88:30, :108:36, :117:26, :126:29, Mux.scala:27:73
  ...
  TLMonitor_35 monitor (	// Nodes.scala:24:25
    ...
    .io_in_d_bits_opcode
      ((muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0)
       | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0)),	// Arbiter.scala:118:30, Mux.scala:27:73
    .io_in_d_bits_param   (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0),	// Arbiter.scala:118:30, Mux.scala:27:73
    .io_in_d_bits_size
      ((muxStateEarly_0 ? auto_out_0_d_bits_size : 2'h0) | {muxStateEarly_1, 1'h0}),	// Arbiter.scala:118:30, Mux.scala:27:73
    .io_in_d_bits_sink    (muxStateEarly_0 & auto_out_0_d_bits_sink),	// Arbiter.scala:118:30, Mux.scala:27:73
