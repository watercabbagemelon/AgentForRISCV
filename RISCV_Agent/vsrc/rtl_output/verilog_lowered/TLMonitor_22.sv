...
module TLMonitor_22(
  ...
  wire        _T_623 = _T_777 & ~(|d_first_counter);	// Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20
  ...
  `ifndef SYNTHESIS
    ...
    wire  [19:0]     _GEN_22 = {15'h0, io_in_d_bits_source, 2'h0};	// Monitor.scala:634:44
    wire  [19:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_22;	// Monitor.scala:613:35, :634:44
    ...
    wire  [4:0]      _GEN_23 = {2'h0, io_in_d_bits_source};	// Monitor.scala:682:25
    wire             _GEN_24 = _T_647 & same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    wire             _GEN_25 = _T_647 & ~same_cycle_resp;	// Monitor.scala:680:71, :681:88, :684:30
    ...
    wire  [4:0]      _T_648 = inflight >> _GEN_23;	// Monitor.scala:611:27, :682:25
    wire  [19:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_22;	// Monitor.scala:615:33, :634:44, :638:40
    wire  [7:0]      _d_clr_wo_ready_T = 8'h1 << _GEN_1;	// OneHot.scala:57:35
    wire  [4:0]      _T_734 = 5'h0 >> _GEN_23;	// Monitor.scala:682:25, :723:35, :793:25
    wire  [19:0]     _c_size_lookup_T_1 = 20'h0 >> _GEN_22;	// Monitor.scala:634:44, :725:35, :747:42
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_GEN_11 & ~reset
          & ~(io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:65, :670:56
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_13 & ~reset
          & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2
              ...
              & (&(io_in_a_bits_address[27:26])))) begin	// Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :92:42, :137:65, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_14 & ~reset
          & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2
               | _source_ok_WIRE_3) & io_in_a_bits_size != 3'h7
              & (&(io_in_a_bits_address[27:26])))) begin	// Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :92:42, :137:65, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:16], _RANDOM_1[11:0]};	// Edges.scala:228:27, Monitor.scala:388:22
        d_first_counter = _RANDOM_1[15:12];	// Edges.scala:228:27, Monitor.scala:388:22
        ...
        inflight_sizes = {_RANDOM_2[31:22], _RANDOM_3[9:0]};	// Monitor.scala:611:27, :615:33
        a_first_counter_1 = _RANDOM_3[13:10];	// Edges.scala:228:27, Monitor.scala:615:33
        d_first_counter_1 = _RANDOM_3[17:14];	// Edges.scala:228:27, Monitor.scala:615:33
        watchdog = {_RANDOM_3[31:18], _RANDOM_4[17:0]};	// Monitor.scala:615:33, :706:27
        d_first_counter_2 = _RANDOM_6[6:3];	// Edges.scala:228:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
