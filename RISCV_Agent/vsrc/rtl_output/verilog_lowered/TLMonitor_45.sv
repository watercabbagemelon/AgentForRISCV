...
module TLMonitor_45(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_15 = io_in_d_bits_source > 8'h9F;	// Parameters.scala:57:20
    ...
    wire  [639:0]    _GEN_18 = {630'h0, io_in_d_bits_source, 2'h0};	// Monitor.scala:122:25, :634:44
    wire  [639:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_18;	// Monitor.scala:613:35, :634:44
    ...
    wire  [159:0]    _GEN_19 = {152'h0, io_in_d_bits_source};	// Monitor.scala:658:26, :682:25
    ...
    wire  [159:0]    _T_618 = inflight >> _GEN_19;	// Monitor.scala:611:27, :682:25
    wire  [639:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_18;	// Monitor.scala:615:33, :634:44, :638:40
    wire  [159:0]    _T_697 = 160'h0 >> _GEN_19;	// Monitor.scala:682:25, :723:35, :793:25
    wire  [639:0]    _c_size_lookup_T_1 = 640'h0 >> _GEN_18;	// Monitor.scala:634:44, :725:35, :747:42
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_GEN_7 & ~reset
          & ~(io_in_a_bits_size != 2'h3 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{31,65}, :670:56, package.scala:235:64
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_9 & ~reset
          & ~(io_in_a_bits_source < 8'hA0 & io_in_a_bits_size != 2'h3
              & io_in_a_bits_address[30:12] == 19'h54000)) begin	// Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_10 & ~reset
          & ~(io_in_a_bits_source < 8'hA0 & io_in_a_bits_size != 2'h3
              & io_in_a_bits_address[30:12] == 19'h54000)) begin	// Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_21 & ~reset
          & ~(io_in_d_bits_opcode == _GEN_1[_a_opcode_lookup_T_1[3:1]]
              | io_in_d_bits_opcode == _GEN_0[_a_opcode_lookup_T_1[3:1]])) begin	// Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:49:11
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// Monitor.scala:49:11
        if (`STOP_COND_)	// Monitor.scala:49:11
          $fatal;	// Monitor.scala:49:11
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_48 = `RANDOM;
        inflight =
          {_RANDOM_2[31:2], _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[1:0]};	// Monitor.scala:611:27
        inflight_opcodes =
          {_RANDOM_7[31:2],
           _RANDOM_8,
           _RANDOM_9,
           ...
           _RANDOM_25,
           _RANDOM_26,
           _RANDOM_27[1:0]};	// Monitor.scala:611:27, :613:35
        inflight_sizes =
          {_RANDOM_27[31:2],
           _RANDOM_28,
           _RANDOM_29,
           ...
           _RANDOM_45,
           _RANDOM_46,
           _RANDOM_47[1:0]};	// Monitor.scala:613:35, :615:33
        watchdog = {_RANDOM_47[31:4], _RANDOM_48[3:0]};	// Monitor.scala:615:33, :706:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
