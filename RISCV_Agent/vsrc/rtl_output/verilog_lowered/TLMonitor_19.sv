...
module TLMonitor_19(
  ...
  wire [66:0] _a_opcodes_set_T_1 =
    {63'h0, _T_1202 ? {io_in_a_bits_opcode, 1'h1} : 4'h0}
  ...
  wire [67:0] _a_sizes_set_T_1 =
    {63'h0, _T_1202 ? {io_in_a_bits_size, 1'h1} : 5'h0}
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <=
        (inflight | (_T_1202 ? _a_set_T[4:0] : 5'h0)) & ~(_T_1217 ? _d_clr_T[4:0] : 5'h0);	// Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35
      inflight_opcodes <=
        (inflight_opcodes | (_T_1202 ? _a_opcodes_set_T_1[19:0] : 20'h0))
        & ~(_T_1217 ? _d_opcodes_clr_T_5[19:0] : 20'h0);	// Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35
      inflight_sizes <=
        (inflight_sizes | (_T_1202 ? _a_sizes_set_T_1[39:0] : 40'h0))
        & ~(_T_1217 ? _d_sizes_clr_T_5[39:0] : 40'h0);	// Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35
    ...
    always @(posedge clock) begin	// Monitor.scala:42:11
      ...
      if (_GEN_15 & ~reset
          & ~(io_in_a_bits_size < 4'hD
              & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2
                 | _source_ok_WIRE_3) & io_in_a_bits_size < 4'h3
              & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3
                 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200
                 | io_in_a_bits_address[31:26] == 6'h3
                 | io_in_a_bits_address[31:12] == 20'h10000
                 | io_in_a_bits_address[31:12] == 20'h54000
                 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :671:42, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_GEN_16 & ~reset
          & ~(io_in_a_bits_size < 4'hD
              ...
              & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3
                 ...
                 | io_in_a_bits_address[31:12] == 20'h10000
                 | io_in_a_bits_address[31:12] == 20'h54000
                 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :671:42, :1161:43
        if (`ASSERT_VERBOSE_COND_)	// Monitor.scala:42:11
      ...
      if (_T_1250 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source
      ...
      if (~reset
          & ~(a_set_wo_ready != (_T_1250 & ~d_release_ack ? _d_clr_wo_ready_T[4:0] : 5'h0)
