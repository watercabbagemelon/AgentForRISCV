...
module JtagStateMachine(
  ...
  wire [15:0][3:0] _GEN =
    {{io_tms ? 4'hF : 4'hC},
     ...
     {io_tms ? 4'h1 : 4'h2},
     {io_tms ? 4'h5 : 4'h3},
     {io_tms ? 4'h5 : 4'h2}};	// JtagStateMachine.scala:77:27, :80:22, :82:{17,23}, :85:{17,23}, :88:{17,23}, :91:{17,23}, :94:{17,23}, :97:{17,23}, :100:{17,23}, :103:{17,23}, :106:{17,23}, :109:{17,23}, :112:{17,23}, :115:{17,23}, :118:{17,23}, :121:{17,23}, :124:{17,23}, :127:{17,23}
