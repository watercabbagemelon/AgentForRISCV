...
module AsyncQueueSink_4(
  ...
  wire [3:0]       _ridx_incremented_T_1 =
    ridx_ridx_bin + {3'h0, io_deq_ready & _io_deq_valid_output};	// AsyncQueue.scala:52:25, :53:43, :162:29, Decoupled.scala:51:35
  ...
  wire [7:0][31:0] _GEN =
    {{io_async_mem_7},
     ...
     {io_async_mem_2},
     {io_async_mem_1},
     {io_async_mem_0}};	// SynchronizerReg.scala:209:18
  ...
  AsyncResetSynchronizerShiftReg_w4_d3_i0_3 widx_widx_gray (	// ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
    .io_q  (_widx_widx_gray_io_q)
  );
  ClockCrossingReg_w32_1 io_deq_bits_deq_bits_reg (	// SynchronizerReg.scala:207:25
    .clock (clock),
  ...
  AsyncValidSync_36 sink_valid_0 (	// AsyncQueue.scala:168:33
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// AsyncQueue.scala:173:{42,45}
    .io_out (_sink_valid_0_io_out)
  );
  AsyncValidSync_37 sink_valid_1 (	// AsyncQueue.scala:169:33
  ...
  AsyncValidSync_38 source_extend (	// AsyncQueue.scala:171:31
  ...
  AsyncValidSync_39 source_valid (	// AsyncQueue.scala:172:31
