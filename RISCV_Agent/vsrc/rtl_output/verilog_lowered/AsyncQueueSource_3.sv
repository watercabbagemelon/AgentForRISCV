...
module AsyncQueueSource_3(
  ...
  AsyncValidSync_24 source_valid_0 (	// AsyncQueue.scala:100:32
    .clock  (clock),
    .reset  (reset | ~io_async_safe_sink_reset_n),	// AsyncQueue.scala:105:{43,46}
    .io_out (_source_valid_0_io_out)
  );
  AsyncValidSync_25 source_valid_1 (	// AsyncQueue.scala:101:32
  ...
  AsyncValidSync_26 sink_extend (	// AsyncQueue.scala:103:30
  ...
  AsyncValidSync_27 sink_valid (	// AsyncQueue.scala:104:30
