...
module ALUExeUnit_1(
  ...
  wire [4:0]  _div_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:357:17]
  ...
  wire [7:0]  _ifpu_io_resp_bits_uop_br_mask;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_uop_br_tag;	// @[execution-unit.scala:330:18]
  wire [3:0]  _ifpu_io_resp_bits_uop_ftq_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [4:0]  _ifpu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_uop_ldq_idx;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_uop_stq_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [3:0]  _ifpu_io_resp_bits_uop_ppred;	// @[execution-unit.scala:330:18]
  ...
  wire [7:0]  _ifpu_io_resp_bits_fflags_bits_uop_br_mask;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_fflags_bits_uop_br_tag;	// @[execution-unit.scala:330:18]
  wire [3:0]  _ifpu_io_resp_bits_fflags_bits_uop_ftq_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [4:0]  _ifpu_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_fflags_bits_uop_ldq_idx;	// @[execution-unit.scala:330:18]
  wire [2:0]  _ifpu_io_resp_bits_fflags_bits_uop_stq_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [3:0]  _ifpu_io_resp_bits_fflags_bits_uop_ppred;	// @[execution-unit.scala:330:18]
  ...
  wire [4:0]  _imul_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:317:18]
  ...
  wire [4:0]  _alu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:262:17]
  ...
  wire        _io_iresp_valid_T = _alu_io_resp_valid | _imul_io_resp_valid;	// @[execution-unit.scala:262:17, :317:18, :367:72]
  ...
  `ifndef SYNTHESIS	// @[execution-unit.scala:350:12]
    wire [1:0] _T_34 = {1'h0, _imul_io_resp_valid} + {1'h0, _div_io_resp_valid};	// @[Bitwise.scala:51:90, execution-unit.scala:284:15, :317:18, :357:17]
    wire [1:0] _GEN = {1'h0, _alu_io_resp_valid};	// @[Bitwise.scala:51:90, execution-unit.scala:262:17, :284:15]
    wire [1:0] _T_29 = _GEN + _T_34;	// @[Bitwise.scala:51:90]
    always @(posedge clock) begin	// @[execution-unit.scala:350:12]
      ...
      if (~reset & ~(~(_T_29[1]) & ~_div_io_resp_valid | _GEN + _T_34 != 2'h3 & _div_io_resp_valid)) begin	// @[Bitwise.scala:51:90, execution-unit.scala:357:17, :416:{10,58,65,68,83}, :417:{58,65}]
  ...
  BranchKillableQueue_3 queue (	// @[execution-unit.scala:338:23]
    .clock                                       (clock),
    .reset                                       (reset),
  ...
  DivUnit div (	// @[execution-unit.scala:357:17]
    ...
    .io_req_bits_rs2_data           (io_req_bits_rs2_data[63:0]),	// @[execution-unit.scala:275:30]
    .io_req_bits_kill               (io_req_bits_kill),
    .io_resp_ready                  (~_io_iresp_valid_T),	// @[execution-unit.scala:367:{26,72}]
    .io_brupdate_b1_resolve_mask    (io_brupdate_b1_resolve_mask),
    .io_brupdate_b1_mispredict_mask (io_brupdate_b1_mispredict_mask),
  ...
  assign io_fu_types = {1'h0, _queue_io_empty, 3'h1, ~div_busy, 4'hB};	// @[execution-unit.scala:253:22, :254:45, :255:49, :284:15, :338:23, :370:39]
  assign io_iresp_valid = _io_iresp_valid_T | _div_io_resp_valid;	// @[execution-unit.scala:357:17, :367:72, :400:71]
  assign io_iresp_bits_uop_csr_addr = _alu_io_resp_bits_uop_imm_packed[19:8];	// @[execution-unit.scala:262:17, :411:34]
  assign io_iresp_bits_uop_rob_idx = _alu_io_resp_valid ? _alu_io_resp_bits_uop_rob_idx : _imul_io_resp_valid ? _imul_io_resp_bits_uop_rob_idx : _div_io_resp_bits_uop_rob_idx;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_uop_pdst = _alu_io_resp_valid ? _alu_io_resp_bits_uop_pdst : _imul_io_resp_valid ? _imul_io_resp_bits_uop_pdst : _div_io_resp_bits_uop_pdst;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_uop_bypassable = _alu_io_resp_valid ? _alu_io_resp_bits_uop_bypassable : _imul_io_resp_valid ? _imul_io_resp_bits_uop_bypassable : _div_io_resp_bits_uop_bypassable;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_uop_is_amo = _alu_io_resp_valid ? _alu_io_resp_bits_uop_is_amo : _imul_io_resp_valid ? _imul_io_resp_bits_uop_is_amo : _div_io_resp_bits_uop_is_amo;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_uop_uses_stq = _alu_io_resp_valid ? _alu_io_resp_bits_uop_uses_stq : _imul_io_resp_valid ? _imul_io_resp_bits_uop_uses_stq : _div_io_resp_bits_uop_uses_stq;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_uop_dst_rtype = _alu_io_resp_valid ? _alu_io_resp_bits_uop_dst_rtype : _imul_io_resp_valid ? _imul_io_resp_bits_uop_dst_rtype : _div_io_resp_bits_uop_dst_rtype;	// @[Mux.scala:47:70, execution-unit.scala:262:17, :317:18, :357:17]
  assign io_iresp_bits_data = {1'h0, _alu_io_resp_valid ? _alu_io_resp_bits_data : _imul_io_resp_valid ? _imul_io_resp_bits_data : _div_io_resp_bits_data};	// @[Mux.scala:47:70, execution-unit.scala:262:17, :284:15, :317:18, :357:17, :403:24]
