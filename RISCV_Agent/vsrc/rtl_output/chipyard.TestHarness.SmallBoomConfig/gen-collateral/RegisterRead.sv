...
module RegisterRead(
  ...
  always @(posedge clock) begin
    ...
    rrd_rs3_data_0_REG <= io_iss_uops_0_prs3 == 6'h0;	// @[consts.scala:270:20, register-read.scala:126:{57,67}]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        exe_reg_uops_0_br_mask = {_RANDOM_4[31:29], _RANDOM_5[4:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_br_tag = _RANDOM_5[7:5];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ftq_idx = _RANDOM_5[11:8];	// @[register-read.scala:70:29]
        exe_reg_uops_0_edge_inst = _RANDOM_5[12];	// @[register-read.scala:70:29]
        exe_reg_uops_0_pc_lob = _RANDOM_5[18:13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_taken = _RANDOM_5[19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_imm_packed = {_RANDOM_5[31:20], _RANDOM_6[7:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_csr_addr = _RANDOM_6[19:8];	// @[register-read.scala:70:29]
        exe_reg_uops_0_rob_idx = _RANDOM_6[24:20];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldq_idx = _RANDOM_6[27:25];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stq_idx = _RANDOM_6[30:28];	// @[register-read.scala:70:29]
        exe_reg_uops_0_rxq_idx = {_RANDOM_6[31], _RANDOM_7[0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_pdst = _RANDOM_7[6:1];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1 = _RANDOM_7[12:7];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2 = _RANDOM_7[18:13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3 = _RANDOM_7[24:19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred = _RANDOM_7[28:25];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1_busy = _RANDOM_7[29];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2_busy = _RANDOM_7[30];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3_busy = _RANDOM_7[31];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred_busy = _RANDOM_8[0];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stale_pdst = _RANDOM_8[6:1];	// @[register-read.scala:70:29]
        exe_reg_uops_0_exception = _RANDOM_8[7];	// @[register-read.scala:70:29]
        exe_reg_uops_0_exc_cause = {_RANDOM_8[31:8], _RANDOM_9, _RANDOM_10[7:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_bypassable = _RANDOM_10[8];	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_cmd = _RANDOM_10[13:9];	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_size = _RANDOM_10[15:14];	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_signed = _RANDOM_10[16];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_fence = _RANDOM_10[17];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_fencei = _RANDOM_10[18];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_amo = _RANDOM_10[19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_uses_ldq = _RANDOM_10[20];	// @[register-read.scala:70:29]
        exe_reg_uops_0_uses_stq = _RANDOM_10[21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_sys_pc2epc = _RANDOM_10[22];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_unique = _RANDOM_10[23];	// @[register-read.scala:70:29]
        exe_reg_uops_0_flush_on_commit = _RANDOM_10[24];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst_is_rs1 = _RANDOM_10[25];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst = _RANDOM_10[31:26];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs1 = _RANDOM_11[5:0];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs2 = _RANDOM_11[11:6];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs3 = _RANDOM_11[17:12];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst_val = _RANDOM_11[18];	// @[register-read.scala:70:29]
        exe_reg_uops_0_dst_rtype = _RANDOM_11[20:19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs1_rtype = _RANDOM_11[22:21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs2_rtype = _RANDOM_11[24:23];	// @[register-read.scala:70:29]
        exe_reg_uops_0_frs3_en = _RANDOM_11[25];	// @[register-read.scala:70:29]
        exe_reg_uops_0_fp_val = _RANDOM_11[26];	// @[register-read.scala:70:29]
        exe_reg_uops_0_fp_single = _RANDOM_11[27];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_pf_if = _RANDOM_11[28];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_ae_if = _RANDOM_11[29];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_ma_if = _RANDOM_11[30];	// @[register-read.scala:70:29]
        exe_reg_uops_0_bp_debug_if = _RANDOM_11[31];	// @[register-read.scala:70:29]
        exe_reg_uops_0_bp_xcpt_if = _RANDOM_12[0];	// @[register-read.scala:70:29]
        exe_reg_uops_0_debug_fsrc = _RANDOM_12[2:1];	// @[register-read.scala:70:29]
        exe_reg_uops_0_debug_tsrc = _RANDOM_12[4:3];	// @[register-read.scala:70:29]
        exe_reg_rs1_data_0 = {_RANDOM_12[31:5], _RANDOM_13, _RANDOM_14[5:0]};	// @[register-read.scala:70:29, :71:29]
        exe_reg_rs2_data_0 = {_RANDOM_14[31:6], _RANDOM_15, _RANDOM_16[6:0]};	// @[register-read.scala:71:29, :72:29]
        exe_reg_rs3_data_0 = {_RANDOM_16[31:7], _RANDOM_17, _RANDOM_18[7:0]};	// @[register-read.scala:72:29, :73:29]
        rrd_valids_0_REG = _RANDOM_18[9];	// @[register-read.scala:73:29, :84:29]
        rrd_uops_0_REG_uopc = _RANDOM_18[16:10];	// @[register-read.scala:73:29, :86:29]
        rrd_uops_0_REG_inst = {_RANDOM_18[31:17], _RANDOM_19[16:0]};	// @[register-read.scala:73:29, :86:29]
        rrd_uops_0_REG_debug_inst = {_RANDOM_19[31:17], _RANDOM_20[16:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_rvc = _RANDOM_20[17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_pc = {_RANDOM_20[31:18], _RANDOM_21[25:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iq_type = _RANDOM_21[28:26];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fu_code = {_RANDOM_21[31:29], _RANDOM_22[6:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_br_type = _RANDOM_22[10:7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op1_sel = _RANDOM_22[12:11];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op2_sel = _RANDOM_22[15:13];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_imm_sel = _RANDOM_22[18:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op_fcn = _RANDOM_22[22:19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_fcn_dw = _RANDOM_22[23];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_csr_cmd = _RANDOM_22[26:24];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_load = _RANDOM_22[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_sta = _RANDOM_22[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_std = _RANDOM_22[29];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iw_state = _RANDOM_22[31:30];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_br = _RANDOM_23[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jalr = _RANDOM_23[3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jal = _RANDOM_23[4];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sfb = _RANDOM_23[5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_mask = _RANDOM_23[13:6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_tag = _RANDOM_23[16:14];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ftq_idx = _RANDOM_23[20:17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_edge_inst = _RANDOM_23[21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_pc_lob = _RANDOM_23[27:22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_taken = _RANDOM_23[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_imm_packed = {_RANDOM_23[31:29], _RANDOM_24[16:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_csr_addr = _RANDOM_24[28:17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_rob_idx = {_RANDOM_24[31:29], _RANDOM_25[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldq_idx = _RANDOM_25[4:2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_stq_idx = _RANDOM_25[7:5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_rxq_idx = _RANDOM_25[9:8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_pdst = _RANDOM_25[15:10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1 = _RANDOM_25[21:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2 = _RANDOM_25[27:22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3 = {_RANDOM_25[31:28], _RANDOM_26[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred = _RANDOM_26[5:2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1_busy = _RANDOM_26[6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2_busy = _RANDOM_26[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3_busy = _RANDOM_26[8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred_busy = _RANDOM_26[9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_stale_pdst = _RANDOM_26[15:10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exception = _RANDOM_26[16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exc_cause = {_RANDOM_26[31:17], _RANDOM_27, _RANDOM_28[16:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bypassable = _RANDOM_28[17];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_cmd = _RANDOM_28[22:18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_size = _RANDOM_28[24:23];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_signed = _RANDOM_28[25];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fence = _RANDOM_28[26];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fencei = _RANDOM_28[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_amo = _RANDOM_28[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_ldq = _RANDOM_28[29];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_stq = _RANDOM_28[30];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sys_pc2epc = _RANDOM_28[31];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_unique = _RANDOM_29[0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_flush_on_commit = _RANDOM_29[1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_is_rs1 = _RANDOM_29[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst = _RANDOM_29[8:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1 = _RANDOM_29[14:9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2 = _RANDOM_29[20:15];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs3 = _RANDOM_29[26:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_val = _RANDOM_29[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_dst_rtype = _RANDOM_29[29:28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1_rtype = _RANDOM_29[31:30];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2_rtype = _RANDOM_30[1:0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_frs3_en = _RANDOM_30[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_val = _RANDOM_30[3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_single = _RANDOM_30[4];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_pf_if = _RANDOM_30[5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ae_if = _RANDOM_30[6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ma_if = _RANDOM_30[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_debug_if = _RANDOM_30[8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_xcpt_if = _RANDOM_30[9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_fsrc = _RANDOM_30[11:10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_tsrc = _RANDOM_30[13:12];	// @[register-read.scala:86:29]
        rrd_rs1_data_0_REG = _RANDOM_30[14];	// @[register-read.scala:86:29, :124:57]
        rrd_rs2_data_0_REG = _RANDOM_30[15];	// @[register-read.scala:86:29, :125:57]
        rrd_rs3_data_0_REG = _RANDOM_30[16];	// @[register-read.scala:86:29, :126:57]
      `endif // RANDOMIZE_REG_INIT
    end // initial
