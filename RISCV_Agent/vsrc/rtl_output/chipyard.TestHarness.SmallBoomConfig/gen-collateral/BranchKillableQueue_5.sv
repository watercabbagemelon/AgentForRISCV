...
module BranchKillableQueue_5(
  ...
  wire [3:0][7:0] _GEN_2 = {{uops_0_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [7:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [3:0][4:0] _GEN_3 = {{uops_0_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [3:0][2:0] _GEN_4 = {{uops_0_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 2'h0) & (_GEN_11 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_1 <= ~(do_deq & deq_ptr_value == 2'h1) & (_GEN_13 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_15 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = {_RANDOM_4[31], _RANDOM_5[6:0]};	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_6[26:22];	// @[util.scala:466:20]
        uops_0_stq_idx = {_RANDOM_6[31:30], _RANDOM_7[0]};	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[8:3];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_10[21];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_10[23];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_11[22:21];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_11[28];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_12[13:7];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_17[10:3];	// @[util.scala:466:20]
        uops_1_rob_idx = _RANDOM_18[30:26];	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_19[4:2];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_19[12:7];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_22[25];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_22[27];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_23[26:25];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_24[0];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_24[17:11];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_29[14:7];	// @[util.scala:466:20]
        uops_2_rob_idx = {_RANDOM_30[31:30], _RANDOM_31[2:0]};	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_31[8:6];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_31[16:11];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_34[29];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_34[31];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_35[30:29];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_36[4];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_36[16:15];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_36[18:17];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_36[19];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_33 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_fflags_valid = ~_io_empty_output & _ram_ext_R0_data[454];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? 5'h0 : _ram_ext_R0_data[670:666];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? 5'h0 : _ram_ext_R0_data[847:843];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
