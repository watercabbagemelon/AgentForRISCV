...
module FpPipeline(
  ...
  input  [2:0]  io_ll_wports_0_bits_uop_stq_idx,
  ...
  input  [7:0]  io_from_int_bits_uop_br_mask,
  input  [4:0]  io_from_int_bits_uop_rob_idx,
  input  [2:0]  io_from_int_bits_uop_stq_idx,
  ...
  wire [7:0]   _ll_wbarb_io_out_bits_uop_br_mask;	// @[fp-pipeline.scala:170:24]
  wire [2:0]   _ll_wbarb_io_out_bits_uop_stq_idx;	// @[fp-pipeline.scala:170:24]
  ...
  wire [7:0]   _fregister_read_io_exe_reqs_0_bits_uop_br_mask;	// @[fp-pipeline.scala:73:30]
  wire [2:0]   _fregister_read_io_exe_reqs_0_bits_uop_br_tag;	// @[fp-pipeline.scala:73:30]
  wire [3:0]   _fregister_read_io_exe_reqs_0_bits_uop_ftq_idx;	// @[fp-pipeline.scala:73:30]
  ...
  wire [4:0]   _fregister_read_io_exe_reqs_0_bits_uop_rob_idx;	// @[fp-pipeline.scala:73:30]
  wire [2:0]   _fregister_read_io_exe_reqs_0_bits_uop_ldq_idx;	// @[fp-pipeline.scala:73:30]
  wire [2:0]   _fregister_read_io_exe_reqs_0_bits_uop_stq_idx;	// @[fp-pipeline.scala:73:30]
  ...
  wire [3:0]   _fregister_read_io_exe_reqs_0_bits_uop_ppred;	// @[fp-pipeline.scala:73:30]
  ...
  wire [7:0]   _fp_issue_unit_io_iss_uops_0_br_mask;	// @[fp-pipeline.scala:62:30]
  wire [2:0]   _fp_issue_unit_io_iss_uops_0_br_tag;	// @[fp-pipeline.scala:62:30]
  wire [3:0]   _fp_issue_unit_io_iss_uops_0_ftq_idx;	// @[fp-pipeline.scala:62:30]
  ...
  wire [4:0]   _fp_issue_unit_io_iss_uops_0_rob_idx;	// @[fp-pipeline.scala:62:30]
  wire [2:0]   _fp_issue_unit_io_iss_uops_0_ldq_idx;	// @[fp-pipeline.scala:62:30]
  wire [2:0]   _fp_issue_unit_io_iss_uops_0_stq_idx;	// @[fp-pipeline.scala:62:30]
  ...
  wire [3:0]   _fp_issue_unit_io_iss_uops_0_ppred;	// @[fp-pipeline.scala:62:30]
  ...
  wire [4:0]   _fpiu_unit_io_ll_iresp_bits_uop_rob_idx;	// @[execution-units.scala:131:32]
