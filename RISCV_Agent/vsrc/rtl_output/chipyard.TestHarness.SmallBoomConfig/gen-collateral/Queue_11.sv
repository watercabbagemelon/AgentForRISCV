...
module Queue_11(
  ...
  wire [101:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[28:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[36:29];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[100:37];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[101];	// @[Decoupled.scala:273:95]
endmodule
