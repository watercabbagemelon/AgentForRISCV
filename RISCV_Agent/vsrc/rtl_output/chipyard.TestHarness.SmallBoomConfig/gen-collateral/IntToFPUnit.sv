...
module IntToFPUnit(
  ...
  wire [7:0]  _io_resp_bits_uop_br_mask_output = r_uops_1_br_mask & ~io_brupdate_b1_resolve_mask;	// @[functional-unit.scala:227:23, util.scala:85:{25,27}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_br_mask = {_RANDOM_4[31:30], _RANDOM_5[5:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_br_tag = _RANDOM_5[8:6];	// @[functional-unit.scala:227:23]
        r_uops_0_ftq_idx = _RANDOM_5[12:9];	// @[functional-unit.scala:227:23]
        r_uops_0_edge_inst = _RANDOM_5[13];	// @[functional-unit.scala:227:23]
        r_uops_0_pc_lob = _RANDOM_5[19:14];	// @[functional-unit.scala:227:23]
        r_uops_0_taken = _RANDOM_5[20];	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = {_RANDOM_5[31:21], _RANDOM_6[8:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_csr_addr = _RANDOM_6[20:9];	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = _RANDOM_6[25:21];	// @[functional-unit.scala:227:23]
        r_uops_0_ldq_idx = _RANDOM_6[28:26];	// @[functional-unit.scala:227:23]
        r_uops_0_stq_idx = _RANDOM_6[31:29];	// @[functional-unit.scala:227:23]
        r_uops_0_rxq_idx = _RANDOM_7[1:0];	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[7:2];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1 = _RANDOM_7[13:8];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2 = _RANDOM_7[19:14];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3 = _RANDOM_7[25:20];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred = _RANDOM_7[29:26];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1_busy = _RANDOM_7[30];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2_busy = _RANDOM_7[31];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3_busy = _RANDOM_8[0];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred_busy = _RANDOM_8[1];	// @[functional-unit.scala:227:23]
        r_uops_0_stale_pdst = _RANDOM_8[7:2];	// @[functional-unit.scala:227:23]
        r_uops_0_exception = _RANDOM_8[8];	// @[functional-unit.scala:227:23]
        r_uops_0_exc_cause = {_RANDOM_8[31:9], _RANDOM_9, _RANDOM_10[8:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_10[9];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_cmd = _RANDOM_10[14:10];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_size = _RANDOM_10[16:15];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_signed = _RANDOM_10[17];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fence = _RANDOM_10[18];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fencei = _RANDOM_10[19];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_10[20];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_ldq = _RANDOM_10[21];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_10[22];	// @[functional-unit.scala:227:23]
        r_uops_0_is_sys_pc2epc = _RANDOM_10[23];	// @[functional-unit.scala:227:23]
        r_uops_0_is_unique = _RANDOM_10[24];	// @[functional-unit.scala:227:23]
        r_uops_0_flush_on_commit = _RANDOM_10[25];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_is_rs1 = _RANDOM_10[26];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst = {_RANDOM_10[31:27], _RANDOM_11[0]};	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1 = _RANDOM_11[6:1];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2 = _RANDOM_11[12:7];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs3 = _RANDOM_11[18:13];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_val = _RANDOM_11[19];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_11[21:20];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1_rtype = _RANDOM_11[23:22];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2_rtype = _RANDOM_11[25:24];	// @[functional-unit.scala:227:23]
        r_uops_0_frs3_en = _RANDOM_11[26];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_val = _RANDOM_11[27];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_single = _RANDOM_11[28];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_pf_if = _RANDOM_11[29];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ae_if = _RANDOM_11[30];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ma_if = _RANDOM_11[31];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_debug_if = _RANDOM_12[0];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_xcpt_if = _RANDOM_12[1];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_fsrc = _RANDOM_12[3:2];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_tsrc = _RANDOM_12[5:4];	// @[functional-unit.scala:227:23]
        r_uops_1_uopc = _RANDOM_12[12:6];	// @[functional-unit.scala:227:23]
        r_uops_1_inst = {_RANDOM_12[31:13], _RANDOM_13[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_debug_inst = {_RANDOM_13[31:13], _RANDOM_14[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_is_rvc = _RANDOM_14[13];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_pc = {_RANDOM_14[31:14], _RANDOM_15[21:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_iq_type = _RANDOM_15[24:22];	// @[functional-unit.scala:227:23]
        r_uops_1_fu_code = {_RANDOM_15[31:25], _RANDOM_16[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_br_type = _RANDOM_16[6:3];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op1_sel = _RANDOM_16[8:7];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op2_sel = _RANDOM_16[11:9];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_imm_sel = _RANDOM_16[14:12];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op_fcn = _RANDOM_16[18:15];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_fcn_dw = _RANDOM_16[19];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_csr_cmd = _RANDOM_16[22:20];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_load = _RANDOM_16[23];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_sta = _RANDOM_16[24];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_std = _RANDOM_16[25];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_state = _RANDOM_16[27:26];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p1_poisoned = _RANDOM_16[28];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p2_poisoned = _RANDOM_16[29];	// @[functional-unit.scala:227:23]
        r_uops_1_is_br = _RANDOM_16[30];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jalr = _RANDOM_16[31];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jal = _RANDOM_17[0];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sfb = _RANDOM_17[1];	// @[functional-unit.scala:227:23]
        r_uops_1_br_mask = _RANDOM_17[9:2];	// @[functional-unit.scala:227:23]
        r_uops_1_br_tag = _RANDOM_17[12:10];	// @[functional-unit.scala:227:23]
        r_uops_1_ftq_idx = _RANDOM_17[16:13];	// @[functional-unit.scala:227:23]
        r_uops_1_edge_inst = _RANDOM_17[17];	// @[functional-unit.scala:227:23]
        r_uops_1_pc_lob = _RANDOM_17[23:18];	// @[functional-unit.scala:227:23]
        r_uops_1_taken = _RANDOM_17[24];	// @[functional-unit.scala:227:23]
        r_uops_1_imm_packed = {_RANDOM_17[31:25], _RANDOM_18[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_csr_addr = _RANDOM_18[24:13];	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = _RANDOM_18[29:25];	// @[functional-unit.scala:227:23]
        r_uops_1_ldq_idx = {_RANDOM_18[31:30], _RANDOM_19[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_stq_idx = _RANDOM_19[3:1];	// @[functional-unit.scala:227:23]
        r_uops_1_rxq_idx = _RANDOM_19[5:4];	// @[functional-unit.scala:227:23]
        r_uops_1_pdst = _RANDOM_19[11:6];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1 = _RANDOM_19[17:12];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2 = _RANDOM_19[23:18];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3 = _RANDOM_19[29:24];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred = {_RANDOM_19[31:30], _RANDOM_20[1:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_prs1_busy = _RANDOM_20[2];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2_busy = _RANDOM_20[3];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3_busy = _RANDOM_20[4];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred_busy = _RANDOM_20[5];	// @[functional-unit.scala:227:23]
        r_uops_1_stale_pdst = _RANDOM_20[11:6];	// @[functional-unit.scala:227:23]
        r_uops_1_exception = _RANDOM_20[12];	// @[functional-unit.scala:227:23]
        r_uops_1_exc_cause = {_RANDOM_20[31:13], _RANDOM_21, _RANDOM_22[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_22[13];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_cmd = _RANDOM_22[18:14];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_size = _RANDOM_22[20:19];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_signed = _RANDOM_22[21];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fence = _RANDOM_22[22];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fencei = _RANDOM_22[23];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_22[24];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_ldq = _RANDOM_22[25];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_22[26];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sys_pc2epc = _RANDOM_22[27];	// @[functional-unit.scala:227:23]
        r_uops_1_is_unique = _RANDOM_22[28];	// @[functional-unit.scala:227:23]
        r_uops_1_flush_on_commit = _RANDOM_22[29];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_is_rs1 = _RANDOM_22[30];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst = {_RANDOM_22[31], _RANDOM_23[4:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1 = _RANDOM_23[10:5];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2 = _RANDOM_23[16:11];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs3 = _RANDOM_23[22:17];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_val = _RANDOM_23[23];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_23[25:24];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1_rtype = _RANDOM_23[27:26];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2_rtype = _RANDOM_23[29:28];	// @[functional-unit.scala:227:23]
        r_uops_1_frs3_en = _RANDOM_23[30];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_val = _RANDOM_23[31];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_single = _RANDOM_24[0];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_pf_if = _RANDOM_24[1];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ae_if = _RANDOM_24[2];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ma_if = _RANDOM_24[3];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_debug_if = _RANDOM_24[4];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_xcpt_if = _RANDOM_24[5];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_fsrc = _RANDOM_24[7:6];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_tsrc = _RANDOM_24[9:8];	// @[functional-unit.scala:227:23]
        out_double_v = _RANDOM_24[10];	// @[Valid.scala:130:22, functional-unit.scala:227:23]
        out_double_b = _RANDOM_24[11];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
        out_double_outPipe_bits = _RANDOM_24[13];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_valid = r_valids_1 & (io_brupdate_b1_mispredict_mask & r_uops_1_br_mask) == 8'h0;	// @[functional-unit.scala:226:27, :227:23, :247:47, util.scala:118:{51,59}]
