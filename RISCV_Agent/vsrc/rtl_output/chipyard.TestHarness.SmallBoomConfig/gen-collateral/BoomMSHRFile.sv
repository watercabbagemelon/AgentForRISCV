...
module BoomMSHRFile(
  ...
  wire [7:0]  _mmios_0_io_resp_bits_uop_br_mask;	// @[mshrs.scala:710:22]
  wire [2:0]  _mmios_0_io_resp_bits_uop_br_tag;	// @[mshrs.scala:710:22]
  wire [3:0]  _mmios_0_io_resp_bits_uop_ftq_idx;	// @[mshrs.scala:710:22]
  ...
  wire [4:0]  _mmios_0_io_resp_bits_uop_rob_idx;	// @[mshrs.scala:710:22]
  wire [2:0]  _mmios_0_io_resp_bits_uop_ldq_idx;	// @[mshrs.scala:710:22]
  wire [2:0]  _mmios_0_io_resp_bits_uop_stq_idx;	// @[mshrs.scala:710:22]
  ...
  wire [3:0]  _mmios_0_io_resp_bits_uop_ppred;	// @[mshrs.scala:710:22]
  ...
  wire [7:0]  _mshrs_1_io_replay_bits_uop_br_mask;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_replay_bits_uop_br_tag;	// @[mshrs.scala:620:22]
  wire [3:0]  _mshrs_1_io_replay_bits_uop_ftq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [4:0]  _mshrs_1_io_replay_bits_uop_rob_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_replay_bits_uop_ldq_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_replay_bits_uop_stq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [3:0]  _mshrs_1_io_replay_bits_uop_ppred;	// @[mshrs.scala:620:22]
  ...
  wire [7:0]  _mshrs_1_io_resp_bits_uop_br_mask;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_resp_bits_uop_br_tag;	// @[mshrs.scala:620:22]
  wire [3:0]  _mshrs_1_io_resp_bits_uop_ftq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [4:0]  _mshrs_1_io_resp_bits_uop_rob_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_resp_bits_uop_ldq_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_1_io_resp_bits_uop_stq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [3:0]  _mshrs_1_io_resp_bits_uop_ppred;	// @[mshrs.scala:620:22]
  ...
  wire [7:0]  _mshrs_0_io_replay_bits_uop_br_mask;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_replay_bits_uop_br_tag;	// @[mshrs.scala:620:22]
  wire [3:0]  _mshrs_0_io_replay_bits_uop_ftq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [4:0]  _mshrs_0_io_replay_bits_uop_rob_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_replay_bits_uop_ldq_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_replay_bits_uop_stq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [3:0]  _mshrs_0_io_replay_bits_uop_ppred;	// @[mshrs.scala:620:22]
  ...
  wire [7:0]  _mshrs_0_io_resp_bits_uop_br_mask;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_resp_bits_uop_br_tag;	// @[mshrs.scala:620:22]
  wire [3:0]  _mshrs_0_io_resp_bits_uop_ftq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [4:0]  _mshrs_0_io_resp_bits_uop_rob_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_resp_bits_uop_ldq_idx;	// @[mshrs.scala:620:22]
  wire [2:0]  _mshrs_0_io_resp_bits_uop_stq_idx;	// @[mshrs.scala:620:22]
  ...
  wire [3:0]  _mshrs_0_io_resp_bits_uop_ppred;	// @[mshrs.scala:620:22]
  ...
  wire [7:0]  _resp_arb_io_out_bits_uop_br_mask;	// @[mshrs.scala:603:30]
  wire [2:0]  _resp_arb_io_out_bits_uop_br_tag;	// @[mshrs.scala:603:30]
  wire [3:0]  _resp_arb_io_out_bits_uop_ftq_idx;	// @[mshrs.scala:603:30]
  ...
  wire [4:0]  _resp_arb_io_out_bits_uop_rob_idx;	// @[mshrs.scala:603:30]
  wire [2:0]  _resp_arb_io_out_bits_uop_ldq_idx;	// @[mshrs.scala:603:30]
  wire [2:0]  _resp_arb_io_out_bits_uop_stq_idx;	// @[mshrs.scala:603:30]
  ...
  wire [3:0]  _resp_arb_io_out_bits_uop_ppred;	// @[mshrs.scala:603:30]
  ...
  wire        cacheable = {io_req_0_bits_addr[31], io_req_0_bits_addr[28], io_req_0_bits_addr[26], io_req_0_bits_addr[17:16] ^ 2'h2} == 5'h0 | {io_req_0_bits_addr[31], ~(io_req_0_bits_addr[28]), io_req_0_bits_addr[26], io_req_0_bits_addr[17:16]} == 5'h0 | {~(io_req_0_bits_addr[31]), io_req_0_bits_addr[28]} == 2'h0;	// @[Parameters.scala:137:{31,45,65}, :671:42]
  ...
  wire        _mshr_io_req_sec_val_T_3 = _mshr_io_req_sec_val_T_4 & tag_match_0 & idx_matches_0_0 & cacheable;	// @[Mux.scala:27:73, Parameters.scala:671:42, mshrs.scala:618:27, :624:46, :637:99]
  ...
  wire        pri_rdy = mshr_alloc_idx_REG ? _mshrs_1_io_req_pri_rdy : ~mshr_alloc_idx_REG & _mshrs_0_io_req_pri_rdy;	// @[mshrs.scala:617:25, :620:22, :632:34, :633:35, :634:15, :694:31]
  wire        _mshr_io_req_sec_val_T_7 = _mshr_io_req_sec_val_T_4 & tag_match_0 & idx_matches_0_1 & cacheable;	// @[Mux.scala:27:73, Parameters.scala:671:42, mshrs.scala:618:27, :624:46, :637:99]
  ...
  wire        _GEN_0 = _mshrs_1_io_mem_acquire_valid | _mshrs_0_io_mem_acquire_valid;	// @[mshrs.scala:620:22, package.scala:245:43]
  ...
  wire        earlyWinner_2 = ~_GEN_0 & _mmios_0_io_mem_access_valid;	// @[Arbiter.scala:17:61, :98:79, mshrs.scala:710:22, package.scala:245:43]
  ...
  assign _io_req_0_ready_output = cacheable ? sdq_rdy & (idx_match_0 ? tag_match_0 & (_mshrs_0_io_req_sec_rdy & _mshr_io_req_sec_val_T_3 | _mshrs_1_io_req_sec_rdy & _mshr_io_req_sec_val_T_7) : pri_rdy) : _mmios_0_io_req_ready;	// @[Mux.scala:27:73, Parameters.scala:671:42, mshrs.scala:557:31, :594:58, :620:22, :633:35, :634:15, :637:99, :677:{25,49}, :710:22, :745:{10,41,47,75}]
  ...
  wire        winnerQual_2 = ~_GEN_0 & _mmios_0_io_mem_access_valid;	// @[Arbiter.scala:17:61, :99:79, mshrs.scala:710:22, package.scala:245:43]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (idle & io_mem_acquire_ready) begin	// @[Arbiter.scala:89:28, :90:24]
        if (winnerQual_2 & ~(_mmios_0_io_mem_access_bits_opcode[2]))	// @[Arbiter.scala:99:79, :112:73, Edges.scala:91:{28,37}, :220:14, mshrs.scala:710:22]
        ...
        beatsLeft <= beatsLeft - {8'h0, io_mem_acquire_ready & out_3_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
