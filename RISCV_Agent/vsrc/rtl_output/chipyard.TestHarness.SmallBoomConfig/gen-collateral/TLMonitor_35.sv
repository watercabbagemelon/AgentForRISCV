...
module TLMonitor_35(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [39:0]     _GEN_28 = {34'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [39:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_28;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [9:0]      _GEN_29 = {6'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [9:0]      _T_682 = inflight >> _GEN_29;	// @[Monitor.scala:611:27, :682:25]
    wire  [39:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_28;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [15:0]     _d_clr_wo_ready_T = 16'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [9:0]      _T_768 = 10'h0 >> _GEN_29;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [39:0]     _c_size_lookup_T_1 = 40'h0 >> _GEN_28;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[28:12] == 17'h10000)) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[28:12] == 17'h10000)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_710 & ~d_release_ack ? _d_clr_wo_ready_T[9:0] : 10'h0) | a_set_wo_ready == 10'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
