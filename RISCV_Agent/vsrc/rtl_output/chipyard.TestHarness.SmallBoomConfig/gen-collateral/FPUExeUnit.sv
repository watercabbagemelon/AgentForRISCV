...
module FPUExeUnit(
  ...
  wire [4:0]  _resp_arb_io_out_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:554:26]
  ...
  wire [7:0]  _fp_sdq_io_deq_bits_uop_br_mask;	// @[execution-unit.scala:542:24]
  wire [4:0]  _fp_sdq_io_deq_bits_uop_rob_idx;	// @[execution-unit.scala:542:24]
  wire [2:0]  _fp_sdq_io_deq_bits_uop_stq_idx;	// @[execution-unit.scala:542:24]
  ...
  wire [4:0]  _fp_sdq_io_deq_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:542:24]
  ...
  wire [7:0]  _queue_io_deq_bits_uop_br_mask;	// @[execution-unit.scala:528:23]
  wire [4:0]  _queue_io_deq_bits_uop_rob_idx;	// @[execution-unit.scala:528:23]
  wire [2:0]  _queue_io_deq_bits_uop_stq_idx;	// @[execution-unit.scala:528:23]
  ...
  wire [4:0]  _queue_io_deq_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:528:23]
  ...
  wire [4:0]  _fdivsqrt_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:493:22]
  ...
  wire [4:0]  _fdivsqrt_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:493:22]
  ...
  wire [7:0]  _fpu_io_resp_bits_uop_br_mask;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_uop_br_tag;	// @[execution-unit.scala:468:17]
  wire [3:0]  _fpu_io_resp_bits_uop_ftq_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [4:0]  _fpu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_uop_ldq_idx;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_uop_stq_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [3:0]  _fpu_io_resp_bits_uop_ppred;	// @[execution-unit.scala:468:17]
  ...
  wire [7:0]  _fpu_io_resp_bits_fflags_bits_uop_br_mask;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_fflags_bits_uop_br_tag;	// @[execution-unit.scala:468:17]
  wire [3:0]  _fpu_io_resp_bits_fflags_bits_uop_ftq_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [4:0]  _fpu_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_fflags_bits_uop_ldq_idx;	// @[execution-unit.scala:468:17]
  wire [2:0]  _fpu_io_resp_bits_fflags_bits_uop_stq_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [3:0]  _fpu_io_resp_bits_fflags_bits_uop_ppred;	// @[execution-unit.scala:468:17]
  ...
  wire        _fp_sdq_io_enq_valid_T_5 = io_req_valid & io_req_bits_uop_uopc == 7'h2 & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 8'h0;	// @[Bitwise.scala:77:12, execution-unit.scala:532:60, :544:{70,81}, util.scala:118:{51,59}]
  ...
  BranchKillableQueue_4 queue (	// @[execution-unit.scala:528:23]
    .clock                                       (clock),
    .reset                                       (reset),
  ...
  BranchKillableQueue_5 fp_sdq (	// @[execution-unit.scala:542:24]
    .clock                               (clock),
    .reset                               (reset),
