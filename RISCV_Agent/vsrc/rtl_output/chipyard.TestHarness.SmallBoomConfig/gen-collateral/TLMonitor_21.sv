...
module TLMonitor_21(
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_747 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:46:9]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_747 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_747 ? _a_set_T[16:0] : 17'h0)) & ~(_T_762 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_747 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_762 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_747 ? _a_sizes_set_T_1[135:0] : 136'h0)) & ~(_T_762 ? _d_sizes_clr_T_5[135:0] : 136'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_19 = io_in_d_bits_param == 2'h2;	// @[Monitor.scala:323:28, Parameters.scala:57:20]
    ...
    wire  [135:0]    _GEN_24 = {128'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire  [16:0]     _GEN_25 = {12'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [16:0]     _T_748 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_767 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [135:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire  [31:0]     _d_clr_wo_ready_T = 32'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [16:0]     _T_853 = 17'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [135:0]    _c_size_lookup_T_1 = 136'h0 >> _GEN_24;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_266 & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_795 & ~d_release_ack ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:24], _RANDOM_1[5:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[14:6];	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_1[28:24];	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_1[29];	// @[Monitor.scala:388:22, :539:22]
        denied = _RANDOM_1[30];	// @[Monitor.scala:388:22, :540:22]
        inflight = {_RANDOM_1[31], _RANDOM_2[15:0]};	// @[Monitor.scala:388:22, :611:27]
        inflight_opcodes = {_RANDOM_2[31:16], _RANDOM_3, _RANDOM_4[19:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_4[31:20], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8[27:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = {_RANDOM_8[31:28], _RANDOM_9[4:0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_9[13:5];	// @[Edges.scala:228:27]
        watchdog = {_RANDOM_9[31:14], _RANDOM_10[13:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_17[28:20];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
