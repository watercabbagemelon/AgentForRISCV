...
module RegisterFileSynthesizable_1(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[regfile.scala:171:15]
      if (~reset & ~(~io_write_ports_0_valid | ~io_write_ports_1_valid | io_write_ports_0_bits_addr != io_write_ports_1_bits_addr | io_write_ports_0_bits_addr == 6'h0)) begin	// @[regfile.scala:171:{15,16}, :172:16, :173:{45,78}, :174:45]
  ...
  assign io_read_ports_0_data = _bypass_data_WIRE_0 | _bypass_data_WIRE_1 ? (_bypass_data_WIRE_0 ? io_write_ports_0_bits_data : 64'h0) | (_bypass_data_WIRE_1 ? io_write_ports_1_bits_data : 64'h0) : _regfile_ext_R0_data;	// @[Mux.scala:27:73, regfile.scala:117:20, :145:59, :150:{35,55}]
  assign io_read_ports_1_data = _bypass_data_WIRE_2_0 | _bypass_data_WIRE_2_1 ? (_bypass_data_WIRE_2_0 ? io_write_ports_0_bits_data : 64'h0) | (_bypass_data_WIRE_2_1 ? io_write_ports_1_bits_data : 64'h0) : _regfile_ext_R1_data;	// @[Mux.scala:27:73, regfile.scala:117:20, :145:59, :150:{35,55}]
  assign io_read_ports_2_data = _bypass_data_WIRE_4_0 | _bypass_data_WIRE_4_1 ? (_bypass_data_WIRE_4_0 ? io_write_ports_0_bits_data : 64'h0) | (_bypass_data_WIRE_4_1 ? io_write_ports_1_bits_data : 64'h0) : _regfile_ext_R2_data;	// @[Mux.scala:27:73, regfile.scala:117:20, :145:59, :150:{35,55}]
  assign io_read_ports_3_data = _bypass_data_WIRE_6_0 | _bypass_data_WIRE_6_1 ? (_bypass_data_WIRE_6_0 ? io_write_ports_0_bits_data : 64'h0) | (_bypass_data_WIRE_6_1 ? io_write_ports_1_bits_data : 64'h0) : _regfile_ext_R3_data;	// @[Mux.scala:27:73, regfile.scala:117:20, :145:59, :150:{35,55}]
endmodule
