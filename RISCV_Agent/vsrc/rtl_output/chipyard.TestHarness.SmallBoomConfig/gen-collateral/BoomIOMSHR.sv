...
module BoomIOMSHR(
  ...
  wire        get_a_mask_size = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        put_a_mask_size = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_3 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_6 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_12 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_15 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_18 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  wire        atomics_a_mask_size_24 = req_uop_mem_size == 2'h2;	// @[Edges.scala:499:15, Misc.scala:208:26, mshrs.scala:410:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_br_mask = {_RANDOM_4[31:28], _RANDOM_5[3:0]};	// @[mshrs.scala:410:16]
        req_uop_br_tag = _RANDOM_5[6:4];	// @[mshrs.scala:410:16]
        req_uop_ftq_idx = _RANDOM_5[10:7];	// @[mshrs.scala:410:16]
        req_uop_edge_inst = _RANDOM_5[11];	// @[mshrs.scala:410:16]
        req_uop_pc_lob = _RANDOM_5[17:12];	// @[mshrs.scala:410:16]
        req_uop_taken = _RANDOM_5[18];	// @[mshrs.scala:410:16]
        req_uop_imm_packed = {_RANDOM_5[31:19], _RANDOM_6[6:0]};	// @[mshrs.scala:410:16]
        req_uop_csr_addr = _RANDOM_6[18:7];	// @[mshrs.scala:410:16]
        req_uop_rob_idx = _RANDOM_6[23:19];	// @[mshrs.scala:410:16]
        req_uop_ldq_idx = _RANDOM_6[26:24];	// @[mshrs.scala:410:16]
        req_uop_stq_idx = _RANDOM_6[29:27];	// @[mshrs.scala:410:16]
        req_uop_rxq_idx = _RANDOM_6[31:30];	// @[mshrs.scala:410:16]
        req_uop_pdst = _RANDOM_7[5:0];	// @[mshrs.scala:410:16]
        req_uop_prs1 = _RANDOM_7[11:6];	// @[mshrs.scala:410:16]
        req_uop_prs2 = _RANDOM_7[17:12];	// @[mshrs.scala:410:16]
        req_uop_prs3 = _RANDOM_7[23:18];	// @[mshrs.scala:410:16]
        req_uop_ppred = _RANDOM_7[27:24];	// @[mshrs.scala:410:16]
        req_uop_prs1_busy = _RANDOM_7[28];	// @[mshrs.scala:410:16]
        req_uop_prs2_busy = _RANDOM_7[29];	// @[mshrs.scala:410:16]
        req_uop_prs3_busy = _RANDOM_7[30];	// @[mshrs.scala:410:16]
        req_uop_ppred_busy = _RANDOM_7[31];	// @[mshrs.scala:410:16]
        req_uop_stale_pdst = _RANDOM_8[5:0];	// @[mshrs.scala:410:16]
        req_uop_exception = _RANDOM_8[6];	// @[mshrs.scala:410:16]
        req_uop_exc_cause = {_RANDOM_8[31:7], _RANDOM_9, _RANDOM_10[6:0]};	// @[mshrs.scala:410:16]
        req_uop_bypassable = _RANDOM_10[7];	// @[mshrs.scala:410:16]
        req_uop_mem_cmd = _RANDOM_10[12:8];	// @[mshrs.scala:410:16]
        req_uop_mem_size = _RANDOM_10[14:13];	// @[mshrs.scala:410:16]
        req_uop_mem_signed = _RANDOM_10[15];	// @[mshrs.scala:410:16]
        req_uop_is_fence = _RANDOM_10[16];	// @[mshrs.scala:410:16]
        req_uop_is_fencei = _RANDOM_10[17];	// @[mshrs.scala:410:16]
        req_uop_is_amo = _RANDOM_10[18];	// @[mshrs.scala:410:16]
        req_uop_uses_ldq = _RANDOM_10[19];	// @[mshrs.scala:410:16]
        req_uop_uses_stq = _RANDOM_10[20];	// @[mshrs.scala:410:16]
        req_uop_is_sys_pc2epc = _RANDOM_10[21];	// @[mshrs.scala:410:16]
        req_uop_is_unique = _RANDOM_10[22];	// @[mshrs.scala:410:16]
        req_uop_flush_on_commit = _RANDOM_10[23];	// @[mshrs.scala:410:16]
        req_uop_ldst_is_rs1 = _RANDOM_10[24];	// @[mshrs.scala:410:16]
        req_uop_ldst = _RANDOM_10[30:25];	// @[mshrs.scala:410:16]
        req_uop_lrs1 = {_RANDOM_10[31], _RANDOM_11[4:0]};	// @[mshrs.scala:410:16]
        req_uop_lrs2 = _RANDOM_11[10:5];	// @[mshrs.scala:410:16]
        req_uop_lrs3 = _RANDOM_11[16:11];	// @[mshrs.scala:410:16]
        req_uop_ldst_val = _RANDOM_11[17];	// @[mshrs.scala:410:16]
        req_uop_dst_rtype = _RANDOM_11[19:18];	// @[mshrs.scala:410:16]
        req_uop_lrs1_rtype = _RANDOM_11[21:20];	// @[mshrs.scala:410:16]
        req_uop_lrs2_rtype = _RANDOM_11[23:22];	// @[mshrs.scala:410:16]
        req_uop_frs3_en = _RANDOM_11[24];	// @[mshrs.scala:410:16]
        req_uop_fp_val = _RANDOM_11[25];	// @[mshrs.scala:410:16]
        req_uop_fp_single = _RANDOM_11[26];	// @[mshrs.scala:410:16]
        req_uop_xcpt_pf_if = _RANDOM_11[27];	// @[mshrs.scala:410:16]
        req_uop_xcpt_ae_if = _RANDOM_11[28];	// @[mshrs.scala:410:16]
        req_uop_xcpt_ma_if = _RANDOM_11[29];	// @[mshrs.scala:410:16]
        req_uop_bp_debug_if = _RANDOM_11[30];	// @[mshrs.scala:410:16]
        req_uop_bp_xcpt_if = _RANDOM_11[31];	// @[mshrs.scala:410:16]
        req_uop_debug_fsrc = _RANDOM_12[1:0];	// @[mshrs.scala:410:16]
        req_uop_debug_tsrc = _RANDOM_12[3:2];	// @[mshrs.scala:410:16]
        req_addr = {_RANDOM_12[31:4], _RANDOM_13[11:0]};	// @[mshrs.scala:410:16]
        req_data = {_RANDOM_13[31:12], _RANDOM_14, _RANDOM_15[11:0]};	// @[mshrs.scala:410:16]
        grant_word = {_RANDOM_15[31:13], _RANDOM_16, _RANDOM_17[12:0]};	// @[mshrs.scala:410:16, :411:23]
        state = _RANDOM_17[14:13];	// @[mshrs.scala:411:23, :415:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_mem_access_bits_opcode = _io_mem_access_bits_T_16 ? (_T_28 | _T_27 | _T_26 | _T_25 | _T_24 ? 3'h2 : _GEN ? 3'h3 : 3'h0) : {_io_mem_access_bits_T_41, 2'h0};	// @[Consts.scala:83:44, :85:68, Edges.scala:515:15, Misc.scala:201:34, Mux.scala:81:{58,61}, mshrs.scala:415:22, :446:{29,66}]
  assign io_mem_access_bits_param = _io_mem_access_bits_T_16 ? (_T_28 ? 3'h3 : _T_27 ? 3'h2 : _T_26 ? 3'h1 : _T_25 ? 3'h0 : _T_24 ? 3'h4 : _T_20 ? 3'h2 : _T_19 ? 3'h1 : _T_18 | ~_T_17 ? 3'h0 : 3'h3) : 3'h0;	// @[Consts.scala:83:44, Edges.scala:448:15, :515:15, Misc.scala:201:34, Mux.scala:81:{58,61}, mshrs.scala:446:29]
  assign io_mem_access_bits_size = _GEN_0 ? {2'h0, req_uop_mem_size} : 4'h0;	// @[Edges.scala:450:15, mshrs.scala:410:16, :415:22, :428:46, :446:29]
  assign io_mem_access_bits_source = _io_mem_access_bits_T_16 ? {2{_T_28 | _T_27 | _T_26 | _T_25 | _T_24 | _GEN}} : 2'h3;	// @[Consts.scala:83:44, Edges.scala:451:15, Mux.scala:81:{58,61}, mshrs.scala:446:29]
