...
module BoomFrontend(
  ...
  wire [3:0]       _ftq_io_enq_idx;	// @[frontend.scala:864:19]
  ...
  Queue_56 f3 (	// @[frontend.scala:518:11]
    .clock                                          (clock),
  ...
  Queue_57 f3_bpd_resp (	// @[frontend.scala:523:11]
    .clock                                  (clock),
  ...
  Queue_58 f4_btb_corrections (	// @[frontend.scala:844:34]
    .clock                                          (clock),
    .reset                                          (reset),
  ...
  Queue_59 f4 (	// @[frontend.scala:861:11]
    .clock                                          (clock),
  ...
  FetchTargetQueue ftq (	// @[frontend.scala:864:19]
    ...
    .io_deq_bits                                        (io_cpu_commit_bits[3:0]),	// @[frontend.scala:948:14]
