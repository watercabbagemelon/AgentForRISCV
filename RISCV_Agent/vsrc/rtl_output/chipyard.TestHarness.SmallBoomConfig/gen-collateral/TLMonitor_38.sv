...
module TLMonitor_38(
  ...
  wire [511:0]  _GEN = {503'h0, io_in_a_bits_source};	// @[OneHot.scala:57:35]
  wire          d_release_ack = io_in_d_bits_opcode == 3'h6;	// @[Monitor.scala:81:25, :670:46]
  wire [511:0]  _GEN_0 = {503'h0, io_in_d_bits_source};	// @[OneHot.scala:57:35]
  ...
  wire [4110:0] _GEN_1 = {4100'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, OneHot.scala:64:12]
  wire [511:0]  _d_clr_T = 512'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  wire [511:0]  _a_set_T = 512'h1 << _GEN;	// @[OneHot.scala:57:35]
  wire [4110:0] _d_opcodes_clr_T_5 = 4111'hF << _GEN_1;	// @[Monitor.scala:677:76]
  wire [4098:0] _a_opcodes_set_T_1 = {4095'h0, a_first_done ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {4088'h0, io_in_a_bits_source, 2'h0};	// @[Decoupled.scala:51:35, Monitor.scala:42:11, :632:35, :643:40, :652:72, :654:{28,53}, :656:54, OneHot.scala:64:12]
  wire [4110:0] _d_sizes_clr_T_5 = 4111'hF << _GEN_1;	// @[Monitor.scala:677:76, :678:74]
  wire [4097:0] _a_sizes_set_T_1 = {4095'h0, a_first_done ? {io_in_a_bits_size, 1'h1} : 3'h0} << {4087'h0, io_in_a_bits_source, 2'h0};	// @[Decoupled.scala:51:35, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:72, :655:{28,51}, :656:54, :657:52, OneHot.scala:64:12]
  always @(posedge clock) begin
    if (reset) begin
      inflight <= 272'h0;	// @[Monitor.scala:611:27, :723:35]
      inflight_opcodes <= 1088'h0;	// @[Monitor.scala:613:35, :725:35]
      inflight_sizes <= 1088'h0;	// @[Monitor.scala:615:33, :725:35]
      watchdog <= 32'h0;	// @[Monitor.scala:706:27]
    end
    else begin
      inflight <= (inflight | (a_first_done ? _a_set_T[271:0] : 272'h0)) & ~(_T_613 ? _d_clr_T[271:0] : 272'h0);	// @[Decoupled.scala:51:35, Monitor.scala:611:27, :623:34, :652:72, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (a_first_done ? _a_opcodes_set_T_1[1087:0] : 1088'h0)) & ~(_T_613 ? _d_opcodes_clr_T_5[1087:0] : 1088'h0);	// @[Decoupled.scala:51:35, Monitor.scala:613:35, :627:33, :652:72, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (a_first_done ? _a_sizes_set_T_1[1087:0] : 1088'h0)) & ~(_T_613 ? _d_sizes_clr_T_5[1087:0] : 1088'h0);	// @[Decoupled.scala:51:35, Monitor.scala:615:33, :629:31, :652:72, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_6 = io_in_a_bits_source > 9'h10F;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_17 = io_in_d_bits_source > 9'h10F;	// @[Parameters.scala:57:20]
    ...
    wire  [1087:0]   _GEN_21 = {1077'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [1087:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_21;	// @[Monitor.scala:613:35, :634:44]
    wire  [511:0]    _a_set_wo_ready_T = 512'h1 << _GEN;	// @[OneHot.scala:57:35]
    wire  [271:0]    a_set_wo_ready = io_in_a_valid ? _a_set_wo_ready_T[271:0] : 272'h0;	// @[Monitor.scala:624:34, :648:71, :649:22, :723:35, OneHot.scala:57:35]
    ...
    wire  [271:0]    _GEN_22 = {263'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [271:0]    _T_599 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [271:0]    _T_618 = inflight >> _GEN_22;	// @[Monitor.scala:611:27, :682:25]
    wire  [1087:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_21;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [511:0]    _d_clr_wo_ready_T = 512'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire  [271:0]    _T_704 = 272'h0 >> _GEN_22;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [1087:0]   _c_size_lookup_T_1 = 1088'h0 >> _GEN_21;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 9'h110 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_source < 9'h110 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (io_in_d_valid & ~d_release_ack ? _d_clr_wo_ready_T[271:0] : 272'h0) | a_set_wo_ready == 272'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 1 (connected at Configs.scala:128:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 272'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_78 = `RANDOM;
        _RANDOM_79 = `RANDOM;
        inflight = {_RANDOM_1[31], _RANDOM_2, _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10[14:0]};	// @[Monitor.scala:611:27]
        inflight_opcodes = {_RANDOM_10[31:15], _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20, _RANDOM_21, _RANDOM_22, _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26, _RANDOM_27, _RANDOM_28, _RANDOM_29, _RANDOM_30, _RANDOM_31, _RANDOM_32, _RANDOM_33, _RANDOM_34, _RANDOM_35, _RANDOM_36, _RANDOM_37, _RANDOM_38, _RANDOM_39, _RANDOM_40, _RANDOM_41, _RANDOM_42, _RANDOM_43, _RANDOM_44[14:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_44[31:15], _RANDOM_45, _RANDOM_46, _RANDOM_47, _RANDOM_48, _RANDOM_49, _RANDOM_50, _RANDOM_51, _RANDOM_52, _RANDOM_53, _RANDOM_54, _RANDOM_55, _RANDOM_56, _RANDOM_57, _RANDOM_58, _RANDOM_59, _RANDOM_60, _RANDOM_61, _RANDOM_62, _RANDOM_63, _RANDOM_64, _RANDOM_65, _RANDOM_66, _RANDOM_67, _RANDOM_68, _RANDOM_69, _RANDOM_70, _RANDOM_71, _RANDOM_72, _RANDOM_73, _RANDOM_74, _RANDOM_75, _RANDOM_76, _RANDOM_77, _RANDOM_78[14:0]};	// @[Monitor.scala:613:35, :615:33]
        watchdog = {_RANDOM_78[31:17], _RANDOM_79[16:0]};	// @[Monitor.scala:615:33, :706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
