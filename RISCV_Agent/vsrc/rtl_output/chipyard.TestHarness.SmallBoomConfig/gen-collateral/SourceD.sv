...
module SourceD(
  ...
  reg  [3:0]      s1_req_reg_source;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[21:18];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        ...
        s2_req_source = _RANDOM_2[26:23];	// @[Reg.scala:19:16, SourceD.scala:90:32]
        ...
        s3_req_source = _RANDOM_7[9:6];	// @[Reg.scala:19:16]
  ...
  Queue_44 queue (	// @[SourceD.scala:120:21]
    .clock            (clock),
    .reset            (reset),
