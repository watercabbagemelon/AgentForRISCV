...
module TLUART(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      txwm <= 9'h0;	// @[Bundles.scala:259:74, UART.scala:150:21]
      rxwm <= 9'h0;	// @[Bundles.scala:259:74, UART.scala:151:21]
  ...
  Queue_68 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_68 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
