...
module TLFragmenter_4(
  ...
  wire [4:0]  _repeater_io_deq_bits_source;	// @[Fragmenter.scala:263:30]
  ...
  TLMonitor_25 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[8:4])	// @[Fragmenter.scala:227:47]
  );
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[8:4];	// @[Fragmenter.scala:227:47]
