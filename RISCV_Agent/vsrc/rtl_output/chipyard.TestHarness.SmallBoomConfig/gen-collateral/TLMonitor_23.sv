...
module TLMonitor_23(
  ...
  wire [31:0]  _GEN_0 = {27'h0, io_in_a_bits_source};	// @[OneHot.scala:57:35, Parameters.scala:137:65]
  wire         _T_738 = _T_814 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  wire         d_release_ack = io_in_d_bits_opcode == 3'h6;	// @[Monitor.scala:81:25, :670:46]
  wire [31:0]  _GEN_1 = {27'h0, io_in_d_bits_source};	// @[OneHot.scala:57:35, Parameters.scala:137:65]
  ...
  wire [258:0] _GEN_3 = {252'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54, Parameters.scala:46:9]
  wire [270:0] _GEN_4 = {264'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, Parameters.scala:46:9]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_738 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [270:0] _d_sizes_clr_T_5 = 271'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [258:0] _a_sizes_set_T_1 = {255'h0, _T_738 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :632:35, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [67:0]     _GEN_26 = {61'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, Parameters.scala:46:9]
    wire  [67:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_26;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [16:0]     _T_758 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    wire  [67:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [31:0]     _d_clr_wo_ready_T = 32'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [16:0]     _T_844 = 17'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [67:0]     _c_size_lookup_T_1 = 68'h0 >> _GEN_26;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_786 & ~d_release_ack ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
