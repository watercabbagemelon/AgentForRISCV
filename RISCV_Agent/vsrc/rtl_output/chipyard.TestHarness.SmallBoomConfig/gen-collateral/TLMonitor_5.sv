...
module TLMonitor_5(
  ...
  wire [258:0] _GEN_1 = {252'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54, Parameters.scala:46:9]
  wire [270:0] _GEN_2 = {264'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, Parameters.scala:46:9]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_798 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_1;	// @[Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [270:0] _d_sizes_clr_T_5 = 271'hF << _GEN_2;	// @[Monitor.scala:677:76, :678:74]
  wire [258:0] _a_sizes_set_T_1 = {255'h0, _T_798 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_1;	// @[Monitor.scala:42:11, :632:35, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_798 ? _a_set_T[16:0] : 17'h0)) & ~(_T_813 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_798 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_813 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_798 ? _a_sizes_set_T_1[67:0] : 68'h0)) & ~(_T_813 ? _d_sizes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [67:0]     _GEN_24 = {61'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, Parameters.scala:46:9]
    wire  [67:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_24;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [16:0]     _T_799 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_818 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [67:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [16:0]     _T_897 = 17'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [67:0]     _c_size_lookup_T_1 = 68'h0 >> _GEN_24;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:17], _RANDOM_1[15:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_1[31:27];	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_2[0];	// @[Monitor.scala:539:22]
        denied = _RANDOM_2[1];	// @[Monitor.scala:539:22, :540:22]
        inflight = _RANDOM_2[18:2];	// @[Monitor.scala:539:22, :611:27]
        inflight_opcodes = {_RANDOM_2[31:19], _RANDOM_3, _RANDOM_4[22:0]};	// @[Monitor.scala:539:22, :613:35]
        inflight_sizes = {_RANDOM_4[31:23], _RANDOM_5, _RANDOM_6[26:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_6[29:27];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_6[31:30], _RANDOM_7[0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_7[31:1], _RANDOM_8[0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_12[31:29];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
