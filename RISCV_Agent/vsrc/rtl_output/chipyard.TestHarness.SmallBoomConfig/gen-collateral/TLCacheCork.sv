...
module TLCacheCork(
  ...
  wire        toD = _T & auto_in_a_bits_param == 3'h2 | (&auto_in_a_bits_opcode);	// @[CacheCork.scala:68:{37,54,73,97}, :69:37, :145:40]
  ...
  wire        _c_a_bits_a_mask_T = auto_in_c_bits_size > 3'h2;	// @[CacheCork.scala:145:40, Misc.scala:205:21]
  ...
  wire        _GEN_0 = _GEN[auto_out_d_bits_source[3:1]];	// @[CacheCork.scala:134:46, :142:25]
  reg         dWHeld_r;	// @[Reg.scala:19:16]
  wire        _T_18 = auto_out_d_bits_opcode == 3'h1 & auto_out_d_bits_source[0];	// @[CacheCork.scala:145:40, :153:{33,51,71}]
  ...
  wire [2:0]  out_6_bits_source = (muxStateEarly_1_0 ? auto_out_d_bits_source[3:1] : 3'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_source : 3'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_source : 3'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:134:46, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  always @(posedge clock) begin
    ...
    if (_T_15 & auto_in_a_bits_source == 3'h0)	// @[CacheCork.scala:138:29, :144:28, :145:40, Decoupled.scala:51:35, Nodes.scala:1215:84]
      wSourceVec_0 <= aWOk;	// @[CacheCork.scala:138:29, Parameters.scala:615:89]
    if (_T_15 & auto_in_a_bits_source == 3'h1)	// @[CacheCork.scala:138:29, :144:28, :145:40, Decoupled.scala:51:35]
      wSourceVec_1 <= aWOk;	// @[CacheCork.scala:138:29, Parameters.scala:615:89]
    if (_T_15 & auto_in_a_bits_source == 3'h2)	// @[CacheCork.scala:138:29, :144:28, :145:40, Decoupled.scala:51:35]
      wSourceVec_2 <= aWOk;	// @[CacheCork.scala:138:29, Parameters.scala:615:89]
    if (_T_15 & auto_in_a_bits_source == 3'h3)	// @[CacheCork.scala:138:29, :144:28, :145:40, Decoupled.scala:51:35]
      wSourceVec_3 <= aWOk;	// @[CacheCork.scala:138:29, Parameters.scala:615:89]
    if (_T_15 & auto_in_a_bits_source == 3'h4)	// @[CacheCork.scala:78:27, :138:29, :144:28, :145:40, Decoupled.scala:51:35]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM_0[14:12];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
        state_0 = _RANDOM_0[15];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1 = _RANDOM_0[16];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        beatsLeft_1 = _RANDOM_0[19:17];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
        state_1_0 = _RANDOM_0[20];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1_1 = _RANDOM_0[21];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1_2 = _RANDOM_0[22];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_49 q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_49 q_1 (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
