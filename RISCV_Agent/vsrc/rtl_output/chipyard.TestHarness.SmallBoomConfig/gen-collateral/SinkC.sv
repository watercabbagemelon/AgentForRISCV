...
module SinkC(
  ...
  wire [3:0]  _c_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  wire [2:0]  beats1 = _c_io_deq_bits_opcode[0] ? ~(_beats1_decode_T_1[5:3]) : 3'h0;	// @[Decoupled.scala:375:21, Edges.scala:101:36, :220:14, :228:27, package.scala:235:{46,71,76}]
  ...
  always @(posedge clock) begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      bs_adr_bits_beat_r <= beat + {2'h0, _io_bs_adr_q_io_enq_ready};	// @[Decoupled.scala:375:21, Edges.scala:233:25, Reg.scala:19:16, SinkC.scala:103:59, :116:24]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resp_r = _RANDOM_0[3];	// @[Edges.scala:228:27, Reg.scala:19:16]
        io_set_r = _RANDOM_0[13:4];	// @[Edges.scala:228:27, Reg.scala:19:16]
        io_bs_dat_data_r = {_RANDOM_0[31:14], _RANDOM_1, _RANDOM_2[13:0]};	// @[Edges.scala:228:27, Reg.scala:19:16]
  ...
  Queue_47 c (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_48 io_bs_adr_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
