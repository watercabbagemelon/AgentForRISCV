  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[15:11];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_address = {_RANDOM_0[31:16], _RANDOM_1[14:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        beatsLeft = {_RANDOM_5[31], _RANDOM_6[1:0]};	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[2];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_6[3];	// @[Arbiter.scala:88:30, :117:26]
        d_first_counter = _RANDOM_6[6:4];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
