...
module TLMonitor_19(
  ...
  wire         _T_1192 = _T_1268 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [270:0] _d_opcodes_clr_T_5 = 271'hF << {264'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76, Parameters.scala:46:9]
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_1192 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:46:9]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1192 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1341 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1207 = _T_1341 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      a_first_counter <= 9'h0;	// @[Edges.scala:228:27]
      d_first_counter <= 9'h0;	// @[Edges.scala:228:27]
      inflight <= 17'h0;	// @[Monitor.scala:611:27, :723:35]
      inflight_opcodes <= 68'h0;	// @[Monitor.scala:613:35, :724:35]
      inflight_sizes <= 136'h0;	// @[Monitor.scala:615:33, :725:35]
      ...
      inflight <= (inflight | (_T_1192 ? _a_set_T[16:0] : 17'h0)) & ~(_T_1207 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1192 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_1207 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1192 ? _a_sizes_set_T_1[135:0] : 136'h0)) & ~(_T_1207 ? _d_sizes_clr_T_5[135:0] : 136'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
    ...
    if (_T_1268 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_1341 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _source_ok_WIRE_0 = io_in_a_bits_source == 5'h8;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_2 = io_in_a_bits_source == 5'h3;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_3 = io_in_a_bits_source == 5'h4;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_4 = io_in_a_bits_source == 5'h10;	// @[Parameters.scala:46:9]
    wire             source_ok = _source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4;	// @[Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             source_ok_1 = io_in_d_bits_source == 5'h8 | io_in_d_bits_source[4:2] == 3'h0 & io_in_d_bits_source[1:0] != 2'h3 | io_in_d_bits_source == 5'h3 | io_in_d_bits_source == 5'h4 | io_in_d_bits_source == 5'h10;	// @[Misc.scala:201:34, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_1137 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_1161 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    wire  [67:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> {61'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, Parameters.scala:46:9]
    wire  [135:0]    _GEN_26 = {128'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire  [16:0]     a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[16:0] : 17'h0;	// @[Monitor.scala:624:34, :648:{26,71}, :649:22, :723:35, OneHot.scala:57:35]
    wire             _T_1240 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    ...
    wire  [16:0]     _GEN_27 = {12'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire             _T_1297 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [16:0]     _T_1193 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_1212 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    wire  [135:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :638:40]
    wire  [31:0]     _d_clr_wo_ready_T = 32'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [16:0]     _T_1298 = 17'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [135:0]    _c_size_lookup_T_1 = 136'h0 >> _GEN_26;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, :706:27, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, :706:27, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_434 & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_11 & ~reset & ~(_T_434 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :104:45, :706:27, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :670:56, :671:42, :672:30]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1240 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1240 & ~d_release_ack ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 2 (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 17'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        source = _RANDOM_0[23:19];	// @[Edges.scala:228:27, Monitor.scala:387:22]
        address = {_RANDOM_0[31:24], _RANDOM_1[22:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[31:23];	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        inflight = {_RANDOM_2[31:16], _RANDOM_3[0]};	// @[Monitor.scala:535:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:1], _RANDOM_4, _RANDOM_5[4:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_5[31:5], _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9[12:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_9[21:13];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_9[30:22];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_9[31], _RANDOM_10[30:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_18[13:5];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
