...
module BranchKillableQueue_3(
  ...
  wire [7:0][7:0] _GEN_2 = {{uops_0_br_mask}, {uops_0_br_mask}, {uops_0_br_mask}, {uops_4_br_mask}, {uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [7:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [7:0][4:0] _GEN_3 = {{uops_0_rob_idx}, {uops_0_rob_idx}, {uops_0_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][2:0] _GEN_4 = {{uops_0_stq_idx}, {uops_0_stq_idx}, {uops_0_stq_idx}, {uops_4_stq_idx}, {uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_4 <= ~(do_deq & deq_ptr_value == 3'h4) & (_GEN_19 | valids_4 & (io_brupdate_b1_mispredict_mask & uops_4_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[8:1];	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_6[28:24];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[2:0];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[10:5];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_10[23];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_10[25];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_11[24:23];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_11[30];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_12[15:9];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_17[12:5];	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_18[31:28], _RANDOM_19[0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_19[6:4];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_19[14:9];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_22[27];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_22[29];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_23[28:27];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_24[2];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_24[19:13];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_29[16:9];	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_31[4:0];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_31[10:8];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_31[18:13];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_34[31];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_35[1];	// @[util.scala:466:20]
        uops_2_dst_rtype = {_RANDOM_35[31], _RANDOM_36[0]};	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_36[6];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_36[23:17];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_41[20:13];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_43[8:4];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_43[14:12];	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_43[22:17];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_47[3];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_47[5];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_48[4:3];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_48[10];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_48[27:21];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_53[24:17];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_55[12:8];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_55[18:16];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_55[26:21];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_59[7];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_59[9];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_60[8:7];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_60[14];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_60[27:25];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_60[30:28];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_60[31];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_34 ram_ext (	// @[util.scala:464:20]
