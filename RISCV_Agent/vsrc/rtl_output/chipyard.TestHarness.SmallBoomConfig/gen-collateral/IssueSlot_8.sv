...
module IssueSlot_8(
  ...
  wire        _T_61 = io_spec_ld_wakeup_0_valid & io_spec_ld_wakeup_0_bits == next_uop_prs1 & (io_in_uop_valid ? io_in_uop_bits_lrs1_rtype : slot_uop_lrs1_rtype) == 2'h0;	// @[issue-slot.scala:86:22, :102:25, :103:21, :210:{33,51}, :211:27]
  wire        _T_69 = io_spec_ld_wakeup_0_valid & io_spec_ld_wakeup_0_bits == next_uop_prs2 & (io_in_uop_valid ? io_in_uop_bits_lrs2_rtype : slot_uop_lrs2_rtype) == 2'h0;	// @[issue-slot.scala:86:22, :102:25, :103:21, :217:{33,51}, :218:27]
  wire [7:0]  next_br_mask = slot_uop_br_mask & ~io_brupdate_b1_resolve_mask;	// @[issue-slot.scala:102:25, util.scala:85:{25,27}]
  ...
  wire        _T_79 = state == 2'h2;	// @[consts.scala:277:20, issue-slot.scala:86:22, :260:65]
  wire        _T_81 = p1 & p2 & ppred;	// @[issue-slot.scala:87:22, :88:22, :90:22, :278:20]
  wire        _T_82 = p1 & ppred;	// @[issue-slot.scala:87:22, :90:22, :280:21]
  wire        _GEN_4 = ~_T_79 | _T_81 | _T_82 | ~(p2 & ppred);	// @[issue-slot.scala:88:22, :90:22, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}, :281:19, :283:{21,31}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      p1 <= _T_61 | io_wakeup_ports_2_valid & io_wakeup_ports_2_bits_pdst == next_uop_prs1 | io_wakeup_ports_1_valid & io_wakeup_ports_1_bits_pdst == next_uop_prs1 | io_wakeup_ports_0_valid & io_wakeup_ports_0_bits_pdst == next_uop_prs1 | ~_T_22 & (io_in_uop_valid ? ~io_in_uop_bits_prs1_busy : p1);	// @[issue-slot.scala:87:22, :103:21, :168:26, :169:{8,11}, :175:{24,45}, :177:8, :185:36, :186:{40,60}, :187:10, :210:51, :211:39, :212:10]
      p2 <= _T_69 | io_wakeup_ports_2_valid & io_wakeup_ports_2_bits_pdst == next_uop_prs2 | io_wakeup_ports_1_valid & io_wakeup_ports_1_bits_pdst == next_uop_prs2 | io_wakeup_ports_0_valid & io_wakeup_ports_0_bits_pdst == next_uop_prs2 | ~_T_27 & (io_in_uop_valid ? ~io_in_uop_bits_prs2_busy : p2);	// @[issue-slot.scala:88:22, :103:21, :168:26, :170:{8,11}, :179:{24,45}, :181:8, :189:36, :190:{40,60}, :191:10, :217:51, :218:39, :219:10]
      ...
      p1_poisoned <= _T_61;	// @[issue-slot.scala:95:28, :210:51]
      p2_poisoned <= _T_69;	// @[issue-slot.scala:96:28, :217:51]
    end
    if (io_in_uop_valid) begin
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[issue-slot.scala:156:12]
      ...
      if (_T_61 & ~reset & next_p1_poisoned) begin	// @[issue-slot.scala:99:29, :210:51, :214:14]
      ...
      if (_T_69 & ~reset & next_p2_poisoned) begin	// @[issue-slot.scala:100:29, :217:51, :221:14]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        slot_uop_br_mask = _RANDOM_5[11:4];	// @[issue-slot.scala:102:25]
        slot_uop_br_tag = _RANDOM_5[14:12];	// @[issue-slot.scala:102:25]
        slot_uop_ftq_idx = _RANDOM_5[18:15];	// @[issue-slot.scala:102:25]
        slot_uop_edge_inst = _RANDOM_5[19];	// @[issue-slot.scala:102:25]
        slot_uop_pc_lob = _RANDOM_5[25:20];	// @[issue-slot.scala:102:25]
        slot_uop_taken = _RANDOM_5[26];	// @[issue-slot.scala:102:25]
        slot_uop_imm_packed = {_RANDOM_5[31:27], _RANDOM_6[14:0]};	// @[issue-slot.scala:102:25]
        slot_uop_csr_addr = _RANDOM_6[26:15];	// @[issue-slot.scala:102:25]
        slot_uop_rob_idx = _RANDOM_6[31:27];	// @[issue-slot.scala:102:25]
        slot_uop_ldq_idx = _RANDOM_7[2:0];	// @[issue-slot.scala:102:25]
        slot_uop_stq_idx = _RANDOM_7[5:3];	// @[issue-slot.scala:102:25]
        slot_uop_rxq_idx = _RANDOM_7[7:6];	// @[issue-slot.scala:102:25]
        slot_uop_pdst = _RANDOM_7[13:8];	// @[issue-slot.scala:102:25]
        slot_uop_prs1 = _RANDOM_7[19:14];	// @[issue-slot.scala:102:25]
        slot_uop_prs2 = _RANDOM_7[25:20];	// @[issue-slot.scala:102:25]
        slot_uop_prs3 = _RANDOM_7[31:26];	// @[issue-slot.scala:102:25]
        slot_uop_ppred = _RANDOM_8[3:0];	// @[issue-slot.scala:102:25]
        slot_uop_prs1_busy = _RANDOM_8[4];	// @[issue-slot.scala:102:25]
        slot_uop_prs2_busy = _RANDOM_8[5];	// @[issue-slot.scala:102:25]
        slot_uop_prs3_busy = _RANDOM_8[6];	// @[issue-slot.scala:102:25]
        slot_uop_ppred_busy = _RANDOM_8[7];	// @[issue-slot.scala:102:25]
        slot_uop_stale_pdst = _RANDOM_8[13:8];	// @[issue-slot.scala:102:25]
        slot_uop_exception = _RANDOM_8[14];	// @[issue-slot.scala:102:25]
        slot_uop_exc_cause = {_RANDOM_8[31:15], _RANDOM_9, _RANDOM_10[14:0]};	// @[issue-slot.scala:102:25]
        slot_uop_bypassable = _RANDOM_10[15];	// @[issue-slot.scala:102:25]
        slot_uop_mem_cmd = _RANDOM_10[20:16];	// @[issue-slot.scala:102:25]
        slot_uop_mem_size = _RANDOM_10[22:21];	// @[issue-slot.scala:102:25]
        slot_uop_mem_signed = _RANDOM_10[23];	// @[issue-slot.scala:102:25]
        slot_uop_is_fence = _RANDOM_10[24];	// @[issue-slot.scala:102:25]
        slot_uop_is_fencei = _RANDOM_10[25];	// @[issue-slot.scala:102:25]
        slot_uop_is_amo = _RANDOM_10[26];	// @[issue-slot.scala:102:25]
        slot_uop_uses_ldq = _RANDOM_10[27];	// @[issue-slot.scala:102:25]
        slot_uop_uses_stq = _RANDOM_10[28];	// @[issue-slot.scala:102:25]
        slot_uop_is_sys_pc2epc = _RANDOM_10[29];	// @[issue-slot.scala:102:25]
        slot_uop_is_unique = _RANDOM_10[30];	// @[issue-slot.scala:102:25]
        slot_uop_flush_on_commit = _RANDOM_10[31];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_is_rs1 = _RANDOM_11[0];	// @[issue-slot.scala:102:25]
        slot_uop_ldst = _RANDOM_11[6:1];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1 = _RANDOM_11[12:7];	// @[issue-slot.scala:102:25]
        slot_uop_lrs2 = _RANDOM_11[18:13];	// @[issue-slot.scala:102:25]
        slot_uop_lrs3 = _RANDOM_11[24:19];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_val = _RANDOM_11[25];	// @[issue-slot.scala:102:25]
        slot_uop_dst_rtype = _RANDOM_11[27:26];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1_rtype = _RANDOM_11[29:28];	// @[issue-slot.scala:102:25]
        slot_uop_lrs2_rtype = _RANDOM_11[31:30];	// @[issue-slot.scala:102:25]
        slot_uop_frs3_en = _RANDOM_12[0];	// @[issue-slot.scala:102:25]
        slot_uop_fp_val = _RANDOM_12[1];	// @[issue-slot.scala:102:25]
        slot_uop_fp_single = _RANDOM_12[2];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_pf_if = _RANDOM_12[3];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ae_if = _RANDOM_12[4];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ma_if = _RANDOM_12[5];	// @[issue-slot.scala:102:25]
        slot_uop_bp_debug_if = _RANDOM_12[6];	// @[issue-slot.scala:102:25]
        slot_uop_bp_xcpt_if = _RANDOM_12[7];	// @[issue-slot.scala:102:25]
        slot_uop_debug_fsrc = _RANDOM_12[9:8];	// @[issue-slot.scala:102:25]
        slot_uop_debug_tsrc = _RANDOM_12[11:10];	// @[issue-slot.scala:102:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_will_be_valid = (|state) & ~(io_grant & (_may_vacate_T | _T_79 & p1 & p2 & ppred) & ~(io_ldspec_miss & (p1_poisoned | p2_poisoned)));	// @[issue-slot.scala:79:24, :86:22, :87:22, :88:22, :90:22, :95:28, :96:28, :245:15, :260:{55,65,92}, :261:{37,53}, :262:{32,35,48,51}]
  ...
  assign io_uop_lrs2_rtype = ~_T_79 | _T_81 | ~_T_82 ? slot_uop_lrs2_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}]
