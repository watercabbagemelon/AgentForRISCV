...
module BranchKillableQueue_2(
  ...
  wire [452:0]    _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  wire [3:0][7:0] _GEN_1 = {{uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [7:0]      out_uop_br_mask = _GEN_1[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [3:0][2:0] _GEN_2 = {{uops_3_ldq_idx}, {uops_2_ldq_idx}, {uops_1_ldq_idx}, {uops_0_ldq_idx}};	// @[util.scala:466:20, :508:19]
  wire [3:0][2:0] _GEN_3 = {{uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 2'h0) & (_GEN_8 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 8'h0 & ~(io_flush & uops_0_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_1 <= ~(do_deq & deq_ptr_value == 2'h1) & (_GEN_10 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 8'h0 & ~(io_flush & uops_1_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_12 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h0 & ~(io_flush & uops_2_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_3 <= ~(do_deq & (&deq_ptr_value)) & (_GEN_13 | valids_3 & (io_brupdate_b1_mispredict_mask & uops_3_br_mask) == 8'h0 & ~(io_flush & uops_3_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[7:0];	// @[util.scala:466:20]
        uops_0_ldq_idx = _RANDOM_6[30:28];	// @[util.scala:466:20]
        uops_0_stq_idx = {_RANDOM_6[31], _RANDOM_7[1:0]};	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_10[22];	// @[util.scala:466:20]
        uops_0_uses_ldq = _RANDOM_10[23];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_10[24];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_17[11:4];	// @[util.scala:466:20]
        uops_1_ldq_idx = _RANDOM_19[2:0];	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_19[5:3];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_22[26];	// @[util.scala:466:20]
        uops_1_uses_ldq = _RANDOM_22[27];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_22[28];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_29[15:8];	// @[util.scala:466:20]
        uops_2_ldq_idx = _RANDOM_31[6:4];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_31[9:7];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_34[30];	// @[util.scala:466:20]
        uops_2_uses_ldq = _RANDOM_34[31];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_35[0];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_41[19:12];	// @[util.scala:466:20]
        uops_3_ldq_idx = _RANDOM_43[10:8];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_43[13:11];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_47[2];	// @[util.scala:466:20]
        uops_3_uses_ldq = _RANDOM_47[3];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_47[4];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_48[21:20];	// @[Counter.scala:61:40]
        deq_ptr_value = _RANDOM_48[23:22];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_48[24];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_valid = ~_io_empty_T_1 & _GEN_0 & (io_brupdate_b1_mispredict_mask & out_uop_br_mask) == 8'h0 & ~(io_flush & out_uop_uses_ldq);	// @[util.scala:118:{51,59}, :473:25, :476:{42,69}, :508:19, :509:{108,111,122}]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[451:388];	// @[util.scala:464:20]
  assign io_deq_bits_is_hella = _ram_ext_R0_data[452];	// @[util.scala:464:20]
endmodule
