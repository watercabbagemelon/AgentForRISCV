...
module TLMonitor_41(
  ...
  wire [130:0] _a_opcodes_set_T_1 = {127'h0, _T_722 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [142:0] _d_sizes_clr_T_5 = 143'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [130:0] _a_sizes_set_T_1 = {127'h0, _T_722 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_722 ? _a_set_T[9:0] : 10'h0)) & ~(_T_737 ? _d_clr_T[9:0] : 10'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_722 ? _a_opcodes_set_T_1[39:0] : 40'h0)) & ~(_T_737 ? _d_opcodes_clr_T_5[39:0] : 40'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_722 ? _a_sizes_set_T_1[39:0] : 40'h0)) & ~(_T_737 ? _d_sizes_clr_T_5[39:0] : 40'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [9:0]      _T_723 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [9:0]      _T_742 = inflight >> _GEN_29;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [9:0]      _T_828 = 10'h0 >> _GEN_29;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_770 & ~d_release_ack ? _d_clr_wo_ready_T[9:0] : 10'h0) | a_set_wo_ready == 10'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 1 (connected at BankedL2Params.scala:65:103)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 10'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Bundles.scala:259:74, Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_first_counter_1 = _RANDOM_4[29:27];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_4[31:30], _RANDOM_5[0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_5[31:1], _RANDOM_6[0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_8[31:30], _RANDOM_9[0]};	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
