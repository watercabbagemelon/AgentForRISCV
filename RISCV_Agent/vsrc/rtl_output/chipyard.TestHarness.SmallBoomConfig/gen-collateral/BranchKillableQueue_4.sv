...
module BranchKillableQueue_4(
  ...
  wire [847:0]    _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  wire [7:0][7:0] _GEN_2 = {{uops_0_br_mask}, {uops_6_br_mask}, {uops_5_br_mask}, {uops_4_br_mask}, {uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [7:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [7:0][4:0] _GEN_3 = {{uops_0_rob_idx}, {uops_6_rob_idx}, {uops_5_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][2:0] _GEN_4 = {{uops_0_stq_idx}, {uops_6_stq_idx}, {uops_5_stq_idx}, {uops_4_stq_idx}, {uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 3'h0) & (_GEN_11 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_1 <= ~(do_deq & deq_ptr_value == 3'h1) & (_GEN_13 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_2 <= ~(do_deq & deq_ptr_value == 3'h2) & (_GEN_15 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_3 <= ~(do_deq & deq_ptr_value == 3'h3) & (_GEN_17 | valids_3 & (io_brupdate_b1_mispredict_mask & uops_3_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_4 <= ~(do_deq & deq_ptr_value == 3'h4) & (_GEN_19 | valids_4 & (io_brupdate_b1_mispredict_mask & uops_4_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_5 <= ~(do_deq & deq_ptr_value == 3'h5) & (_GEN_21 | valids_5 & (io_brupdate_b1_mispredict_mask & uops_5_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_6 <= ~(do_deq & deq_ptr_value == 3'h6) & (_GEN_23 | valids_6 & (io_brupdate_b1_mispredict_mask & uops_6_br_mask) == 8'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[10:3];	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_6[30:26];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[4:2];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[12:7];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_10[25];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_10[27];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_11[26:25];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[0];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_12[17:11];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_17[14:7];	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_18[31:30], _RANDOM_19[2:0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_19[8:6];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_19[16:11];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_22[29];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_22[31];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_23[30:29];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_24[4];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_24[21:15];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_29[18:11];	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_31[6:2];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_31[12:10];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_31[20:15];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_35[1];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_35[3];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_36[2:1];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_36[8];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_36[25:19];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_41[22:15];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_43[10:6];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_43[16:14];	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_43[24:19];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_47[5];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_47[7];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_48[6:5];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_48[12];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_48[29:23];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_53[26:19];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_55[14:10];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_55[20:18];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_55[28:23];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_59[9];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_59[11];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_60[10:9];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_60[16];	// @[util.scala:466:20]
        uops_5_uopc = {_RANDOM_60[31:27], _RANDOM_61[1:0]};	// @[util.scala:466:20]
        uops_5_br_mask = _RANDOM_65[30:23];	// @[util.scala:466:20]
        uops_5_rob_idx = _RANDOM_67[18:14];	// @[util.scala:466:20]
        uops_5_stq_idx = _RANDOM_67[24:22];	// @[util.scala:466:20]
        uops_5_pdst = {_RANDOM_67[31:27], _RANDOM_68[0]};	// @[util.scala:466:20]
        uops_5_is_amo = _RANDOM_71[13];	// @[util.scala:466:20]
        uops_5_uses_stq = _RANDOM_71[15];	// @[util.scala:466:20]
        uops_5_dst_rtype = _RANDOM_72[14:13];	// @[util.scala:466:20]
        uops_5_fp_val = _RANDOM_72[20];	// @[util.scala:466:20]
        uops_6_uopc = {_RANDOM_72[31], _RANDOM_73[5:0]};	// @[util.scala:466:20]
        uops_6_br_mask = {_RANDOM_77[31:27], _RANDOM_78[2:0]};	// @[util.scala:466:20]
        uops_6_rob_idx = _RANDOM_79[22:18];	// @[util.scala:466:20]
        uops_6_stq_idx = _RANDOM_79[28:26];	// @[util.scala:466:20]
        uops_6_pdst = {_RANDOM_79[31], _RANDOM_80[4:0]};	// @[util.scala:466:20]
        uops_6_is_amo = _RANDOM_83[17];	// @[util.scala:466:20]
        uops_6_uses_stq = _RANDOM_83[19];	// @[util.scala:466:20]
        uops_6_dst_rtype = _RANDOM_84[18:17];	// @[util.scala:466:20]
        uops_6_fp_val = _RANDOM_84[24];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_85[5:3];	// @[Counter.scala:61:40]
        deq_ptr_value = _RANDOM_85[8:6];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_85[9];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_35 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_valid = _io_empty_output ? io_enq_valid : ~_io_empty_output & _GEN_0 & (io_brupdate_b1_mispredict_mask & out_uop_br_mask) == 8'h0 & ~io_flush;	// @[util.scala:118:{51,59}, :473:25, :476:{42,69}, :508:19, :509:{27,108,111}, :515:21, :516:20]
  ...
  assign io_deq_bits_data = _io_empty_output ? io_enq_bits_data : _ram_ext_R0_data[452:388];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_predicated = ~_io_empty_output & _ram_ext_R0_data[453];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_valid = _io_empty_output ? io_enq_bits_fflags_valid : _ram_ext_R0_data[454];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? io_enq_bits_fflags_bits_uop_rob_idx : _ram_ext_R0_data[670:666];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? io_enq_bits_fflags_bits_flags : _ram_ext_R0_data[847:843];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
