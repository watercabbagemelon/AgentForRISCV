...
module FDivSqrtUnit(
  ...
  reg  [7:0]  r_buffer_req_uop_br_mask;	// @[fdiv.scala:96:25]
  reg  [4:0]  r_buffer_req_uop_rob_idx;	// @[fdiv.scala:96:25]
  ...
  reg  [7:0]  r_divsqrt_uop_br_mask;	// @[fdiv.scala:146:26]
  reg  [4:0]  r_divsqrt_uop_rob_idx;	// @[fdiv.scala:146:26]
  ...
  reg  [7:0]  r_out_uop_br_mask;	// @[fdiv.scala:183:22]
  reg  [4:0]  r_out_uop_rob_idx;	// @[fdiv.scala:183:22]
  ...
  wire [7:0]  _io_resp_valid_T = io_brupdate_b1_mispredict_mask & r_out_uop_br_mask;	// @[fdiv.scala:183:22, util.scala:118:51]
  ...
  wire        _io_resp_valid_output = r_out_val & _io_resp_valid_T == 8'h0;	// @[fdiv.scala:182:26, :216:30, util.scala:118:{51,59}]
  wire [7:0]  _r_divsqrt_killed_T_4 = io_brupdate_b1_mispredict_mask & r_buffer_req_uop_br_mask;	// @[fdiv.scala:96:25, util.scala:118:51]
  wire        _T_5 = io_req_valid & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 8'h0 & ~io_req_bits_kill;	// @[fdiv.scala:103:71, :119:73, util.scala:118:{51,59}]
  wire [7:0]  _r_out_val_T_1 = io_brupdate_b1_mispredict_mask & r_divsqrt_uop_br_mask;	// @[fdiv.scala:146:26, util.scala:118:51]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      r_buffer_val <= ~_T_12 & (_T_5 | _r_divsqrt_killed_T_4 == 8'h0 & ~io_req_bits_kill & r_buffer_val);	// @[fdiv.scala:95:29, :103:{16,71,89}, :119:{73,95}, :120:18, :168:{24,42}, :171:18, util.scala:118:{51,59}]
      r_divsqrt_val <= ~_T_21 & (_T_12 | r_divsqrt_val);	// @[fdiv.scala:143:30, :168:{24,42}, :172:19, :194:{33,62}, :195:19]
      if (_T_21)	// @[fdiv.scala:194:33]
        r_out_val <= ~r_divsqrt_killed & _r_out_val_T_1 == 8'h0 & ~io_req_bits_kill;	// @[fdiv.scala:103:71, :144:29, :182:26, :197:{18,85}, util.scala:118:{51,59}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_buffer_req_uop_br_mask = {_RANDOM_4[31:29], _RANDOM_5[4:0]};	// @[fdiv.scala:96:25]
        r_buffer_req_uop_rob_idx = _RANDOM_6[24:20];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_pdst = _RANDOM_7[6:1];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_is_amo = _RANDOM_10[19];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_uses_ldq = _RANDOM_10[20];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_uses_stq = _RANDOM_10[21];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_dst_rtype = _RANDOM_11[20:19];	// @[fdiv.scala:96:25]
        r_buffer_req_uop_fp_val = _RANDOM_11[26];	// @[fdiv.scala:96:25]
        r_buffer_fin_typeTagIn = _RANDOM_18[18:17];	// @[fdiv.scala:97:25]
        r_buffer_fin_div = _RANDOM_18[25];	// @[fdiv.scala:97:25]
        r_buffer_fin_sqrt = _RANDOM_18[26];	// @[fdiv.scala:97:25]
        r_buffer_fin_rm = _RANDOM_18[30:28];	// @[fdiv.scala:97:25]
        r_buffer_fin_in1 = {_RANDOM_19[31:5], _RANDOM_20, _RANDOM_21[5:0]};	// @[fdiv.scala:97:25]
        r_buffer_fin_in2 = {_RANDOM_21[31:6], _RANDOM_22, _RANDOM_23[6:0]};	// @[fdiv.scala:97:25]
        r_divsqrt_val = _RANDOM_25[8];	// @[fdiv.scala:143:30]
        r_divsqrt_killed = _RANDOM_25[9];	// @[fdiv.scala:143:30, :144:29]
        r_divsqrt_fin_typeTagIn = _RANDOM_25[18:17];	// @[fdiv.scala:143:30, :145:26]
        r_divsqrt_fin_rm = _RANDOM_25[30:28];	// @[fdiv.scala:143:30, :145:26]
        r_divsqrt_uop_br_mask = _RANDOM_37[11:4];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_rob_idx = _RANDOM_38[31:27];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_pdst = _RANDOM_39[13:8];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_is_amo = _RANDOM_42[26];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_uses_ldq = _RANDOM_42[27];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_uses_stq = _RANDOM_42[28];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_dst_rtype = _RANDOM_43[27:26];	// @[fdiv.scala:146:26]
        r_divsqrt_uop_fp_val = _RANDOM_44[1];	// @[fdiv.scala:146:26]
        r_out_val = _RANDOM_44[12];	// @[fdiv.scala:146:26, :182:26]
        r_out_uop_br_mask = _RANDOM_49[16:9];	// @[fdiv.scala:183:22]
        r_out_uop_rob_idx = _RANDOM_51[4:0];	// @[fdiv.scala:183:22]
        r_out_uop_pdst = _RANDOM_51[18:13];	// @[fdiv.scala:183:22]
        r_out_uop_is_amo = _RANDOM_54[31];	// @[fdiv.scala:183:22]
        r_out_uop_uses_ldq = _RANDOM_55[0];	// @[fdiv.scala:183:22]
        r_out_uop_uses_stq = _RANDOM_55[1];	// @[fdiv.scala:183:22]
        r_out_uop_dst_rtype = {_RANDOM_55[31], _RANDOM_56[0]};	// @[fdiv.scala:183:22]
        r_out_uop_fp_val = _RANDOM_56[6];	// @[fdiv.scala:183:22]
        r_out_flags_double = _RANDOM_56[21:17];	// @[fdiv.scala:183:22, :184:31]
        r_out_wdata_double = {_RANDOM_56[31:22], _RANDOM_57, _RANDOM_58[22:0]};	// @[fdiv.scala:183:22, :185:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
