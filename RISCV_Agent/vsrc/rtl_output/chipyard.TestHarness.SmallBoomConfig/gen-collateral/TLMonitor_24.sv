...
module TLMonitor_24(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [67:0]     _GEN_22 = {61'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire  [67:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_22;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [16:0]     _GEN_23 = {12'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [16:0]     _T_758 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    wire  [67:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_22;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [31:0]     _d_clr_wo_ready_T = 32'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [16:0]     _T_844 = 17'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [67:0]     _c_size_lookup_T_1 = 68'h0 >> _GEN_22;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:17], _RANDOM_1[12:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        inflight_sizes = {_RANDOM_4[31:20], _RANDOM_5, _RANDOM_6[23:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_6[26:24];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_6[29:27];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_6[31:30], _RANDOM_7[29:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_12[28:26];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
