...
module ram_combMem_16(	// @[Decoupled.scala:273:95]
  input          R0_addr,
                 ...
                 W0_clk,
  input  [106:0] W0_data,
  output [106:0] R0_data
);

  reg [106:0] Memory[0:0];	// @[Decoupled.scala:273:95]
    ...
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 1; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[106:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 107'bx;	// @[Decoupled.scala:273:95]
endmodule
