...
module PeripheryBus(
  ...
  wire [4:0]  _coupler_to_device_named_uart_0_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [4:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [8:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [4:0]  _buffer_1_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [4:0]  _atomics_auto_in_d_bits_source;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [4:0]  _atomics_auto_out_a_bits_source;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [4:0]  _buffer_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [4:0]  _out_xbar_auto_in_d_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [4:0]  _out_xbar_auto_out_1_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [4:0]  _out_xbar_auto_out_0_a_bits_source;	// @[PeripheryBus.scala:50:30]
  ...
  wire [4:0]  _fixer_auto_in_d_bits_source;	// @[PeripheryBus.scala:47:33]
  ...
  wire [4:0]  _fixer_auto_out_a_bits_source;	// @[PeripheryBus.scala:47:33]
