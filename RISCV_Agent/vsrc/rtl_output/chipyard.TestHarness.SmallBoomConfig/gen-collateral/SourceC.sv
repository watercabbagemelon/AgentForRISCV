...
module SourceC(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_tag = _RANDOM_0[30:18];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        ...
        s2_req_source = _RANDOM_1[22:20];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:23], _RANDOM_2[3:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_2[13:4];	// @[Reg.scala:19:16]
        s3_valid = _RANDOM_2[22];	// @[Reg.scala:19:16, SourceC.scala:100:25]
        s3_req_opcode = _RANDOM_2[25:23];	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_2[28:26];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_2[31:29];	// @[Reg.scala:19:16]
        s3_req_tag = _RANDOM_3[12:0];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_3[22:13];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_43 queue (	// @[SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
