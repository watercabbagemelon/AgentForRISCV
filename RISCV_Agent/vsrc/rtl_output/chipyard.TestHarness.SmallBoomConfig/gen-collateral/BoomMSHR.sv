...
module BoomMSHR(
  ...
  wire [8:0]       beats1 = io_mem_grant_bits_opcode[0] ? ~(_beats1_decode_T_1[11:3]) : 9'h0;	// @[Edges.scala:105:36, :220:14, :228:27, package.scala:235:{46,71,76}]
  reg  [8:0]       counter;	// @[Edges.scala:228:27]
  wire [8:0]       counter1 = counter - 9'h1;	// @[Edges.scala:228:27, :229:28]
  wire             refill_done = (counter == 9'h1 | beats1 == 9'h0) & _T_204;	// @[Decoupled.scala:51:35, Edges.scala:220:14, :228:27, :231:{25,37,47}, :232:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_mem_cmd = _RANDOM_10[17:13];	// @[mshrs.scala:109:20]
        req_addr = {_RANDOM_12[31:9], _RANDOM_13[16:0]};	// @[mshrs.scala:109:20]
        req_old_meta_coh_state = _RANDOM_15[20:19];	// @[mshrs.scala:109:20]
        req_old_meta_tag = {_RANDOM_15[31:21], _RANDOM_16[8:0]};	// @[mshrs.scala:109:20]
        req_way_en = _RANDOM_16[12:9];	// @[mshrs.scala:109:20]
        req_needs_wb = _RANDOM_16[18];	// @[mshrs.scala:109:20, :113:29]
        new_coh_state = _RANDOM_16[20:19];	// @[mshrs.scala:109:20, :115:24]
        counter = _RANDOM_16[29:21];	// @[Edges.scala:228:27, mshrs.scala:109:20]
        grantack_valid = _RANDOM_16[30];	// @[mshrs.scala:109:20, :138:21]
        grantack_bits_sink = {_RANDOM_16[31], _RANDOM_17[1:0]};	// @[mshrs.scala:109:20, :138:21]
        refill_ctr = _RANDOM_17[4:2];	// @[mshrs.scala:138:21, :139:24]
        commit_line = _RANDOM_17[5];	// @[mshrs.scala:138:21, :140:24]
        grant_had_data = _RANDOM_17[6];	// @[mshrs.scala:138:21, :141:27]
        finish_to_prefetch = _RANDOM_17[7];	// @[mshrs.scala:138:21, :142:31]
        meta_hazard = _RANDOM_17[9:8];	// @[mshrs.scala:138:21, :145:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_lb_write_bits_offset = beats1[2:0] & ~(counter1[2:0]);	// @[Edges.scala:220:14, :229:28, :233:{25,27}]
