...
module TilePRCIDomain(
  ...
  wire [2:0]  _buffer_1_auto_in_b_bits_source;	// @[Buffer.scala:69:28]
  wire [31:0] _buffer_1_auto_in_b_bits_address;	// @[Buffer.scala:69:28]
  wire [7:0]  _buffer_1_auto_in_b_bits_mask;	// @[Buffer.scala:69:28]
  ...
  wire [2:0]  _buffer_1_auto_in_d_bits_source;	// @[Buffer.scala:69:28]
  wire [2:0]  _buffer_1_auto_in_d_bits_sink;	// @[Buffer.scala:69:28]
  ...
  wire        _tile_reset_domain_boom_tile_auto_master_out_a_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_a_bits_opcode;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_a_bits_param;	// @[HasTiles.scala:251:53]
  wire [3:0]  _tile_reset_domain_boom_tile_auto_master_out_a_bits_size;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_a_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_boom_tile_auto_master_out_a_bits_address;	// @[HasTiles.scala:251:53]
  wire [7:0]  _tile_reset_domain_boom_tile_auto_master_out_a_bits_mask;	// @[HasTiles.scala:251:53]
  wire [63:0] _tile_reset_domain_boom_tile_auto_master_out_a_bits_data;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_a_bits_corrupt;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_b_ready;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_c_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_c_bits_opcode;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_c_bits_param;	// @[HasTiles.scala:251:53]
  wire [3:0]  _tile_reset_domain_boom_tile_auto_master_out_c_bits_size;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_c_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_boom_tile_auto_master_out_c_bits_address;	// @[HasTiles.scala:251:53]
  wire [63:0] _tile_reset_domain_boom_tile_auto_master_out_c_bits_data;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_c_bits_corrupt;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_d_ready;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_boom_tile_auto_master_out_e_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_boom_tile_auto_master_out_e_bits_sink;	// @[HasTiles.scala:251:53]
  BoomTile tile_reset_domain_boom_tile (	// @[HasTiles.scala:251:53]
    .clock                          (auto_tap_clock_in_clock),
    .reset                          (auto_tap_clock_in_reset),
    .auto_master_out_a_ready        (_buffer_1_auto_in_a_ready),	// @[Buffer.scala:69:28]
    .auto_master_out_b_valid        (_buffer_1_auto_in_b_valid),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_opcode  (_buffer_1_auto_in_b_bits_opcode),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_param   (_buffer_1_auto_in_b_bits_param),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_size    (_buffer_1_auto_in_b_bits_size),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_source  (_buffer_1_auto_in_b_bits_source),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_address (_buffer_1_auto_in_b_bits_address),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_mask    (_buffer_1_auto_in_b_bits_mask),	// @[Buffer.scala:69:28]
    .auto_master_out_b_bits_corrupt (_buffer_1_auto_in_b_bits_corrupt),	// @[Buffer.scala:69:28]
    .auto_master_out_c_ready        (_buffer_1_auto_in_c_ready),	// @[Buffer.scala:69:28]
    .auto_master_out_d_valid        (_buffer_1_auto_in_d_valid),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_opcode  (_buffer_1_auto_in_d_bits_opcode),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_param   (_buffer_1_auto_in_d_bits_param),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_size    (_buffer_1_auto_in_d_bits_size),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_source  (_buffer_1_auto_in_d_bits_source),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_sink    (_buffer_1_auto_in_d_bits_sink),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_denied  (_buffer_1_auto_in_d_bits_denied),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_data    (_buffer_1_auto_in_d_bits_data),	// @[Buffer.scala:69:28]
    .auto_master_out_d_bits_corrupt (_buffer_1_auto_in_d_bits_corrupt),	// @[Buffer.scala:69:28]
    .auto_master_out_e_ready        (_buffer_1_auto_in_e_ready),	// @[Buffer.scala:69:28]
    ...
    .auto_master_out_a_bits_corrupt (_tile_reset_domain_boom_tile_auto_master_out_a_bits_corrupt),
    ...
    .auto_master_out_c_bits_corrupt (_tile_reset_domain_boom_tile_auto_master_out_c_bits_corrupt),
  ...
  TLBuffer_18 buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    .auto_in_a_valid         (_tile_reset_domain_boom_tile_auto_master_out_a_valid),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_opcode   (_tile_reset_domain_boom_tile_auto_master_out_a_bits_opcode),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_param    (_tile_reset_domain_boom_tile_auto_master_out_a_bits_param),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_size     (_tile_reset_domain_boom_tile_auto_master_out_a_bits_size),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_source   (_tile_reset_domain_boom_tile_auto_master_out_a_bits_source),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_address  (_tile_reset_domain_boom_tile_auto_master_out_a_bits_address),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_mask     (_tile_reset_domain_boom_tile_auto_master_out_a_bits_mask),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_data     (_tile_reset_domain_boom_tile_auto_master_out_a_bits_data),	// @[HasTiles.scala:251:53]
    .auto_in_a_bits_corrupt  (_tile_reset_domain_boom_tile_auto_master_out_a_bits_corrupt),	// @[HasTiles.scala:251:53]
    .auto_in_b_ready         (_tile_reset_domain_boom_tile_auto_master_out_b_ready),	// @[HasTiles.scala:251:53]
    .auto_in_c_valid         (_tile_reset_domain_boom_tile_auto_master_out_c_valid),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_opcode   (_tile_reset_domain_boom_tile_auto_master_out_c_bits_opcode),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_param    (_tile_reset_domain_boom_tile_auto_master_out_c_bits_param),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_size     (_tile_reset_domain_boom_tile_auto_master_out_c_bits_size),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_source   (_tile_reset_domain_boom_tile_auto_master_out_c_bits_source),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_address  (_tile_reset_domain_boom_tile_auto_master_out_c_bits_address),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_data     (_tile_reset_domain_boom_tile_auto_master_out_c_bits_data),	// @[HasTiles.scala:251:53]
    .auto_in_c_bits_corrupt  (_tile_reset_domain_boom_tile_auto_master_out_c_bits_corrupt),	// @[HasTiles.scala:251:53]
    .auto_in_d_ready         (_tile_reset_domain_boom_tile_auto_master_out_d_ready),	// @[HasTiles.scala:251:53]
    .auto_in_e_valid         (_tile_reset_domain_boom_tile_auto_master_out_e_valid),	// @[HasTiles.scala:251:53]
    .auto_in_e_bits_sink     (_tile_reset_domain_boom_tile_auto_master_out_e_bits_sink),	// @[HasTiles.scala:251:53]
