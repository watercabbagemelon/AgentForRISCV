...
module CoherenceManagerWrapper(
  ...
  wire [3:0]  _InclusiveCache_inner_TLBuffer_auto_out_a_bits_source;	// @[Parameters.scala:56:69]
  ...
  wire [3:0]  _InclusiveCache_inner_TLBuffer_auto_out_c_bits_source;	// @[Parameters.scala:56:69]
  ...
  wire [3:0]  _l2_auto_in_d_bits_source;	// @[Configs.scala:76:24]
