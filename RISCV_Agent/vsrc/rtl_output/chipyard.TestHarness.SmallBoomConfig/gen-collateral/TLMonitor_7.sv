...
module TLMonitor_7(
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_804 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [270:0] _d_sizes_clr_T_5 = 271'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [258:0] _a_sizes_set_T_1 = {255'h0, _T_804 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :632:35, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_804 ? _a_set_T[16:0] : 17'h0)) & ~(_T_819 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_804 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_819 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_804 ? _a_sizes_set_T_1[67:0] : 68'h0)) & ~(_T_819 ? _d_sizes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [16:0]     _T_805 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_824 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [16:0]     _T_910 = 17'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_852 & ~d_release_ack ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
