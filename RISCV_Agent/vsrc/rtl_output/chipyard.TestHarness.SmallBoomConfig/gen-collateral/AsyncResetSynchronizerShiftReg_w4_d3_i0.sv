...
module AsyncResetSynchronizerShiftReg_w4_d3_i0(
  ...
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_1 (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_d[1]),	// @[SynchronizerReg.scala:87:41]
    .io_q  (_output_chain_1_io_q)
  );
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_2 (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_d[2]),	// @[SynchronizerReg.scala:87:41]
    .io_q  (_output_chain_2_io_q)
  );
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED output_chain_3 (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
