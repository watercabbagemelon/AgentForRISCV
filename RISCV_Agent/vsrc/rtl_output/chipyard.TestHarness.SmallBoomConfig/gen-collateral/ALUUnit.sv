...
module ALUUnit(
  ...
  wire [7:0]  _T_7 = io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask;	// @[util.scala:118:51]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      r_valids_0 <= io_req_valid & _T_7 == 8'h0 & ~io_req_bits_kill;	// @[functional-unit.scala:226:27, :230:{84,87}, util.scala:118:{51,59}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_ctrl_csr_cmd = _RANDOM_4[19:17];	// @[functional-unit.scala:227:23]
        r_uops_0_br_mask = {_RANDOM_4[31], _RANDOM_5[6:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = {_RANDOM_5[31:22], _RANDOM_6[9:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = _RANDOM_6[26:22];	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[8:3];	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_10[10];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_10[21];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_10[23];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_11[22:21];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_csr_cmd = _RANDOM_16[23:21];	// @[functional-unit.scala:227:23]
        r_uops_1_br_mask = _RANDOM_17[10:3];	// @[functional-unit.scala:227:23]
        r_uops_1_imm_packed = {_RANDOM_17[31:26], _RANDOM_18[13:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = _RANDOM_18[30:26];	// @[functional-unit.scala:227:23]
        r_uops_1_pdst = _RANDOM_19[12:7];	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_22[14];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_22[25];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_22[27];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_23[26:25];	// @[functional-unit.scala:227:23]
        r_uops_2_ctrl_csr_cmd = _RANDOM_28[27:25];	// @[functional-unit.scala:227:23]
        r_uops_2_br_mask = _RANDOM_29[14:7];	// @[functional-unit.scala:227:23]
        r_uops_2_imm_packed = {_RANDOM_29[31:30], _RANDOM_30[17:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_rob_idx = {_RANDOM_30[31:30], _RANDOM_31[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_2_pdst = _RANDOM_31[16:11];	// @[functional-unit.scala:227:23]
        r_uops_2_bypassable = _RANDOM_34[18];	// @[functional-unit.scala:227:23]
        r_uops_2_is_amo = _RANDOM_34[29];	// @[functional-unit.scala:227:23]
        r_uops_2_uses_stq = _RANDOM_34[31];	// @[functional-unit.scala:227:23]
        r_uops_2_dst_rtype = _RANDOM_35[30:29];	// @[functional-unit.scala:227:23]
        r_val_0 = _RANDOM_36[15];	// @[functional-unit.scala:436:23]
        r_val_1 = _RANDOM_36[16];	// @[functional-unit.scala:436:23]
        r_data_0 = {_RANDOM_36[31:18], _RANDOM_37, _RANDOM_38[17:0]};	// @[functional-unit.scala:436:23, :437:19]
        r_data_1 = {_RANDOM_38[31:18], _RANDOM_39, _RANDOM_40[17:0]};	// @[functional-unit.scala:437:19]
        r_data_2 = {_RANDOM_40[31:18], _RANDOM_41, _RANDOM_42[17:0]};	// @[functional-unit.scala:437:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_valid = r_valids_2 & (io_brupdate_b1_mispredict_mask & r_uops_2_br_mask) == 8'h0;	// @[functional-unit.scala:226:27, :227:23, :247:47, util.scala:118:{51,59}]
  assign io_resp_bits_uop_ctrl_csr_cmd = r_uops_2_ctrl_csr_cmd;	// @[functional-unit.scala:227:23]
  assign io_resp_bits_uop_imm_packed = r_uops_2_imm_packed;	// @[functional-unit.scala:227:23]
