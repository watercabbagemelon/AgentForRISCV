...
module AsyncQueueSource_3(
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED source_valid_0 (	// @[AsyncQueue.scala:100:32]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED source_valid_1 (	// @[AsyncQueue.scala:101:32]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED sink_extend (	// @[AsyncQueue.scala:103:30]
  ...
  AsyncValidSync_TestHarness_UNIQUIFIED sink_valid (	// @[AsyncQueue.scala:104:30]
