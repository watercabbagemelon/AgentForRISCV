...
module Queue_59(
  ...
  wire [681:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[453:450];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_br_mask = _ram_ext_R0_data[457:454];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_old_history = _ram_ext_R0_data[521:458];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_current_saw_branch_not_taken = _ram_ext_R0_data[522];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_new_saw_branch_not_taken = _ram_ext_R0_data[523];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_new_saw_branch_taken = _ram_ext_R0_data[524];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_ras_idx = _ram_ext_R0_data[529:525];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_xcpt_pf_if = _ram_ext_R0_data[531];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_xcpt_ae_if = _ram_ext_R0_data[532];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_0 = _ram_ext_R0_data[533];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_1 = _ram_ext_R0_data[534];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_2 = _ram_ext_R0_data[535];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_3 = _ram_ext_R0_data[536];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_0 = _ram_ext_R0_data[537];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_1 = _ram_ext_R0_data[538];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_2 = _ram_ext_R0_data[539];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_3 = _ram_ext_R0_data[540];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bpd_meta_0 = _ram_ext_R0_data[677:558];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_fsrc = _ram_ext_R0_data[679:678];	// @[Decoupled.scala:273:95]
endmodule
