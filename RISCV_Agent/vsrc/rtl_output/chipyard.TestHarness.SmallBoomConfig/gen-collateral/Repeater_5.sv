  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM_0[14:10];	// @[Repeater.scala:19:21, :20:18]
        saved_address = _RANDOM_0[26:15];	// @[Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM_0[31:27], _RANDOM_1[2:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_3[3];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
