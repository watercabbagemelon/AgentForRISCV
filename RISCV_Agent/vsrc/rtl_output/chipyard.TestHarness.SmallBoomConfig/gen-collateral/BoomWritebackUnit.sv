...
module BoomWritebackUnit(
  ...
  wire [7:0][63:0] _GEN = {{wb_buffer_7}, {wb_buffer_6}, {wb_buffer_5}, {wb_buffer_4}, {wb_buffer_3}, {wb_buffer_2}, {wb_buffer_1}, {wb_buffer_0}};	// @[Edges.scala:428:15, dcache.scala:46:22]
  ...
  always @(posedge clock) begin
    ...
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & r2_data_req_cnt[2:0] == 3'h5)) begin	// @[Edges.scala:423:15, dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
      wb_buffer_5 <= io_data_resp;	// @[dcache.scala:46:22]
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & r2_data_req_cnt[2:0] == 3'h6)) begin	// @[Edges.scala:425:15, dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
