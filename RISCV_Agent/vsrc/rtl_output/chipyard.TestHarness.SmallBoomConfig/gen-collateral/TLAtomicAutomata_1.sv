...
module TLAtomicAutomata_1(
  ...
  reg  [4:0]      cam_a_0_bits_source;	// @[AtomicAutomata.scala:79:24]
  ...
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :670:56, :671:42]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[16:12];	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        beatsLeft = _RANDOM_6[8:0];	// @[Arbiter.scala:88:30]
        state_0 = _RANDOM_6[9];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_6[10];	// @[Arbiter.scala:88:30, :117:26]
        d_first_counter = _RANDOM_6[19:11];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? cam_a_0_bits_source : 5'h0) | (muxStateEarly_1 ? auto_in_a_bits_source : 5'h0);	// @[Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
