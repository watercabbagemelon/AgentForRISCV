...
module BranchKillableQueue(
  ...
  wire [524:0]      _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  reg  [7:0]        uops_5_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_5_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_5_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_5_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_5_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_6_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_6_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_6_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_6_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_6_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_7_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_7_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_7_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_7_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_7_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_8_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_8_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_8_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_8_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_8_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_9_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_9_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_9_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_9_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_9_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_10_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_10_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_10_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_10_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_10_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_11_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_11_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_11_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_11_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_11_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_12_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_12_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_12_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_12_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_12_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_13_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_13_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_13_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_13_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_13_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_14_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_14_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_14_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_14_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_14_stq_idx;	// @[util.scala:466:20]
  ...
  reg  [7:0]        uops_15_br_mask;	// @[util.scala:466:20]
  reg  [2:0]        uops_15_br_tag;	// @[util.scala:466:20]
  ...
  reg  [4:0]        uops_15_rob_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_15_ldq_idx;	// @[util.scala:466:20]
  reg  [2:0]        uops_15_stq_idx;	// @[util.scala:466:20]
  ...
  wire [15:0][7:0]  _GEN_25 = {{uops_15_br_mask}, {uops_14_br_mask}, {uops_13_br_mask}, {uops_12_br_mask}, {uops_11_br_mask}, {uops_10_br_mask}, {uops_9_br_mask}, {uops_8_br_mask}, {uops_7_br_mask}, {uops_6_br_mask}, {uops_5_br_mask}, {uops_4_br_mask}, {uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [7:0]        out_uop_br_mask = _GEN_25[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [15:0][2:0]  _GEN_26 = {{uops_15_br_tag}, {uops_14_br_tag}, {uops_13_br_tag}, {uops_12_br_tag}, {uops_11_br_tag}, {uops_10_br_tag}, {uops_9_br_tag}, {uops_8_br_tag}, {uops_7_br_tag}, {uops_6_br_tag}, {uops_5_br_tag}, {uops_4_br_tag}, {uops_3_br_tag}, {uops_2_br_tag}, {uops_1_br_tag}, {uops_0_br_tag}};	// @[util.scala:466:20, :508:19]
  wire [15:0][3:0]  _GEN_27 = {{uops_15_ftq_idx}, {uops_14_ftq_idx}, {uops_13_ftq_idx}, {uops_12_ftq_idx}, {uops_11_ftq_idx}, {uops_10_ftq_idx}, {uops_9_ftq_idx}, {uops_8_ftq_idx}, {uops_7_ftq_idx}, {uops_6_ftq_idx}, {uops_5_ftq_idx}, {uops_4_ftq_idx}, {uops_3_ftq_idx}, {uops_2_ftq_idx}, {uops_1_ftq_idx}, {uops_0_ftq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  wire [15:0][4:0]  _GEN_33 = {{uops_15_rob_idx}, {uops_14_rob_idx}, {uops_13_rob_idx}, {uops_12_rob_idx}, {uops_11_rob_idx}, {uops_10_rob_idx}, {uops_9_rob_idx}, {uops_8_rob_idx}, {uops_7_rob_idx}, {uops_6_rob_idx}, {uops_5_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [15:0][2:0]  _GEN_34 = {{uops_15_ldq_idx}, {uops_14_ldq_idx}, {uops_13_ldq_idx}, {uops_12_ldq_idx}, {uops_11_ldq_idx}, {uops_10_ldq_idx}, {uops_9_ldq_idx}, {uops_8_ldq_idx}, {uops_7_ldq_idx}, {uops_6_ldq_idx}, {uops_5_ldq_idx}, {uops_4_ldq_idx}, {uops_3_ldq_idx}, {uops_2_ldq_idx}, {uops_1_ldq_idx}, {uops_0_ldq_idx}};	// @[util.scala:466:20, :508:19]
  wire [15:0][2:0]  _GEN_35 = {{uops_15_stq_idx}, {uops_14_stq_idx}, {uops_13_stq_idx}, {uops_12_stq_idx}, {uops_11_stq_idx}, {uops_10_stq_idx}, {uops_9_stq_idx}, {uops_8_stq_idx}, {uops_7_stq_idx}, {uops_6_stq_idx}, {uops_5_stq_idx}, {uops_4_stq_idx}, {uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  ...
  wire [15:0][3:0]  _GEN_41 = {{uops_15_ppred}, {uops_14_ppred}, {uops_13_ppred}, {uops_12_ppred}, {uops_11_ppred}, {uops_10_ppred}, {uops_9_ppred}, {uops_8_ppred}, {uops_7_ppred}, {uops_6_ppred}, {uops_5_ppred}, {uops_4_ppred}, {uops_3_ppred}, {uops_2_ppred}, {uops_1_ppred}, {uops_0_ppred}};	// @[util.scala:466:20, :508:19]
  ...
  wire [7:0]        _uops_br_mask_T_1 = io_enq_bits_uop_br_mask & ~io_brupdate_b1_resolve_mask;	// @[util.scala:85:{25,27}]
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 4'h0) & (_GEN_81 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 8'h0 & ~(io_flush & uops_0_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_1 <= ~(do_deq & deq_ptr_value == 4'h1) & (_GEN_83 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 8'h0 & ~(io_flush & uops_1_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_2 <= ~(do_deq & deq_ptr_value == 4'h2) & (_GEN_85 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h0 & ~(io_flush & uops_2_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_3 <= ~(do_deq & deq_ptr_value == 4'h3) & (_GEN_87 | valids_3 & (io_brupdate_b1_mispredict_mask & uops_3_br_mask) == 8'h0 & ~(io_flush & uops_3_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_4 <= ~(do_deq & deq_ptr_value == 4'h4) & (_GEN_89 | valids_4 & (io_brupdate_b1_mispredict_mask & uops_4_br_mask) == 8'h0 & ~(io_flush & uops_4_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_5 <= ~(do_deq & deq_ptr_value == 4'h5) & (_GEN_91 | valids_5 & (io_brupdate_b1_mispredict_mask & uops_5_br_mask) == 8'h0 & ~(io_flush & uops_5_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_6 <= ~(do_deq & deq_ptr_value == 4'h6) & (_GEN_93 | valids_6 & (io_brupdate_b1_mispredict_mask & uops_6_br_mask) == 8'h0 & ~(io_flush & uops_6_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_7 <= ~(do_deq & deq_ptr_value == 4'h7) & (_GEN_95 | valids_7 & (io_brupdate_b1_mispredict_mask & uops_7_br_mask) == 8'h0 & ~(io_flush & uops_7_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_8 <= ~(do_deq & deq_ptr_value == 4'h8) & (_GEN_97 | valids_8 & (io_brupdate_b1_mispredict_mask & uops_8_br_mask) == 8'h0 & ~(io_flush & uops_8_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_9 <= ~(do_deq & deq_ptr_value == 4'h9) & (_GEN_99 | valids_9 & (io_brupdate_b1_mispredict_mask & uops_9_br_mask) == 8'h0 & ~(io_flush & uops_9_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_10 <= ~(do_deq & deq_ptr_value == 4'hA) & (_GEN_101 | valids_10 & (io_brupdate_b1_mispredict_mask & uops_10_br_mask) == 8'h0 & ~(io_flush & uops_10_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_11 <= ~(do_deq & deq_ptr_value == 4'hB) & (_GEN_103 | valids_11 & (io_brupdate_b1_mispredict_mask & uops_11_br_mask) == 8'h0 & ~(io_flush & uops_11_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_12 <= ~(do_deq & deq_ptr_value == 4'hC) & (_GEN_105 | valids_12 & (io_brupdate_b1_mispredict_mask & uops_12_br_mask) == 8'h0 & ~(io_flush & uops_12_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_13 <= ~(do_deq & deq_ptr_value == 4'hD) & (_GEN_107 | valids_13 & (io_brupdate_b1_mispredict_mask & uops_13_br_mask) == 8'h0 & ~(io_flush & uops_13_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_14 <= ~(do_deq & deq_ptr_value == 4'hE) & (_GEN_109 | valids_14 & (io_brupdate_b1_mispredict_mask & uops_14_br_mask) == 8'h0 & ~(io_flush & uops_14_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
      valids_15 <= ~(do_deq & (&deq_ptr_value)) & (_GEN_110 | valids_15 & (io_brupdate_b1_mispredict_mask & uops_15_br_mask) == 8'h0 & ~(io_flush & uops_15_uses_ldq));	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:66, :481:{16,69,72,83}, :487:17, :489:33, :495:17, :496:27]
    ...
    if (do_enq & _GEN_80)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_0_br_mask <= ({8{~valids_0}} | ~io_brupdate_b1_resolve_mask) & uops_0_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_82)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_1_br_mask <= ({8{~valids_1}} | ~io_brupdate_b1_resolve_mask) & uops_1_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_84)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_2_br_mask <= ({8{~valids_2}} | ~io_brupdate_b1_resolve_mask) & uops_2_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_86)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_3_br_mask <= ({8{~valids_3}} | ~io_brupdate_b1_resolve_mask) & uops_3_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_88)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_4_br_mask <= ({8{~valids_4}} | ~io_brupdate_b1_resolve_mask) & uops_4_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_90)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_5_br_mask <= ({8{~valids_5}} | ~io_brupdate_b1_resolve_mask) & uops_5_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_92)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_6_br_mask <= ({8{~valids_6}} | ~io_brupdate_b1_resolve_mask) & uops_6_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_94)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_7_br_mask <= ({8{~valids_7}} | ~io_brupdate_b1_resolve_mask) & uops_7_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_96)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_8_br_mask <= ({8{~valids_8}} | ~io_brupdate_b1_resolve_mask) & uops_8_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_98)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_9_br_mask <= ({8{~valids_9}} | ~io_brupdate_b1_resolve_mask) & uops_9_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_100)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_10_br_mask <= ({8{~valids_10}} | ~io_brupdate_b1_resolve_mask) & uops_10_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_102)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_11_br_mask <= ({8{~valids_11}} | ~io_brupdate_b1_resolve_mask) & uops_11_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_104)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_12_br_mask <= ({8{~valids_12}} | ~io_brupdate_b1_resolve_mask) & uops_12_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_106)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_13_br_mask <= ({8{~valids_13}} | ~io_brupdate_b1_resolve_mask) & uops_13_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & _GEN_108)	// @[Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_14_br_mask <= ({8{~valids_14}} | ~io_brupdate_b1_resolve_mask) & uops_14_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
    ...
    if (do_enq & (&enq_ptr_value))	// @[Counter.scala:61:40, Decoupled.scala:51:35, util.scala:482:22, :487:17, :489:33, :491:33]
      ...
      uops_15_br_mask <= ({8{~valids_15}} | ~io_brupdate_b1_resolve_mask) & uops_15_br_mask;	// @[util.scala:89:23, :465:24, :466:20, :482:22, :483:23]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[19:12];	// @[util.scala:466:20]
        uops_0_br_tag = _RANDOM_5[22:20];	// @[util.scala:466:20]
        uops_0_ftq_idx = _RANDOM_5[26:23];	// @[util.scala:466:20]
        uops_0_edge_inst = _RANDOM_5[27];	// @[util.scala:466:20]
        uops_0_pc_lob = {_RANDOM_5[31:28], _RANDOM_6[1:0]};	// @[util.scala:466:20]
        uops_0_taken = _RANDOM_6[2];	// @[util.scala:466:20]
        uops_0_imm_packed = _RANDOM_6[22:3];	// @[util.scala:466:20]
        uops_0_csr_addr = {_RANDOM_6[31:23], _RANDOM_7[2:0]};	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_7[7:3];	// @[util.scala:466:20]
        uops_0_ldq_idx = _RANDOM_7[10:8];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[13:11];	// @[util.scala:466:20]
        uops_0_rxq_idx = _RANDOM_7[15:14];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[21:16];	// @[util.scala:466:20]
        uops_0_prs1 = _RANDOM_7[27:22];	// @[util.scala:466:20]
        uops_0_prs2 = {_RANDOM_7[31:28], _RANDOM_8[1:0]};	// @[util.scala:466:20]
        uops_0_prs3 = _RANDOM_8[7:2];	// @[util.scala:466:20]
        uops_0_ppred = _RANDOM_8[11:8];	// @[util.scala:466:20]
        uops_0_prs1_busy = _RANDOM_8[12];	// @[util.scala:466:20]
        uops_0_prs2_busy = _RANDOM_8[13];	// @[util.scala:466:20]
        uops_0_prs3_busy = _RANDOM_8[14];	// @[util.scala:466:20]
        uops_0_ppred_busy = _RANDOM_8[15];	// @[util.scala:466:20]
        uops_0_stale_pdst = _RANDOM_8[21:16];	// @[util.scala:466:20]
        uops_0_exception = _RANDOM_8[22];	// @[util.scala:466:20]
        uops_0_exc_cause = {_RANDOM_8[31:23], _RANDOM_9, _RANDOM_10[22:0]};	// @[util.scala:466:20]
        uops_0_bypassable = _RANDOM_10[23];	// @[util.scala:466:20]
        uops_0_mem_cmd = _RANDOM_10[28:24];	// @[util.scala:466:20]
        uops_0_mem_size = _RANDOM_10[30:29];	// @[util.scala:466:20]
        uops_0_mem_signed = _RANDOM_10[31];	// @[util.scala:466:20]
        uops_0_is_fence = _RANDOM_11[0];	// @[util.scala:466:20]
        uops_0_is_fencei = _RANDOM_11[1];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[2];	// @[util.scala:466:20]
        uops_0_uses_ldq = _RANDOM_11[3];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[4];	// @[util.scala:466:20]
        uops_0_is_sys_pc2epc = _RANDOM_11[5];	// @[util.scala:466:20]
        uops_0_is_unique = _RANDOM_11[6];	// @[util.scala:466:20]
        uops_0_flush_on_commit = _RANDOM_11[7];	// @[util.scala:466:20]
        uops_0_ldst_is_rs1 = _RANDOM_11[8];	// @[util.scala:466:20]
        uops_0_ldst = _RANDOM_11[14:9];	// @[util.scala:466:20]
        uops_0_lrs1 = _RANDOM_11[20:15];	// @[util.scala:466:20]
        uops_0_lrs2 = _RANDOM_11[26:21];	// @[util.scala:466:20]
        uops_0_lrs3 = {_RANDOM_11[31:27], _RANDOM_12[0]};	// @[util.scala:466:20]
        uops_0_ldst_val = _RANDOM_12[1];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[3:2];	// @[util.scala:466:20]
        uops_0_lrs1_rtype = _RANDOM_12[5:4];	// @[util.scala:466:20]
        uops_0_lrs2_rtype = _RANDOM_12[7:6];	// @[util.scala:466:20]
        uops_0_frs3_en = _RANDOM_12[8];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[9];	// @[util.scala:466:20]
        uops_0_fp_single = _RANDOM_12[10];	// @[util.scala:466:20]
        uops_0_xcpt_pf_if = _RANDOM_12[11];	// @[util.scala:466:20]
        uops_0_xcpt_ae_if = _RANDOM_12[12];	// @[util.scala:466:20]
        uops_0_xcpt_ma_if = _RANDOM_12[13];	// @[util.scala:466:20]
        uops_0_bp_debug_if = _RANDOM_12[14];	// @[util.scala:466:20]
        uops_0_bp_xcpt_if = _RANDOM_12[15];	// @[util.scala:466:20]
        uops_0_debug_fsrc = _RANDOM_12[17:16];	// @[util.scala:466:20]
        uops_0_debug_tsrc = _RANDOM_12[19:18];	// @[util.scala:466:20]
        uops_1_uopc = _RANDOM_12[26:20];	// @[util.scala:466:20]
        uops_1_inst = {_RANDOM_12[31:27], _RANDOM_13[26:0]};	// @[util.scala:466:20]
        uops_1_debug_inst = {_RANDOM_13[31:27], _RANDOM_14[26:0]};	// @[util.scala:466:20]
        uops_1_is_rvc = _RANDOM_14[27];	// @[util.scala:466:20]
        uops_1_debug_pc = {_RANDOM_14[31:28], _RANDOM_15, _RANDOM_16[3:0]};	// @[util.scala:466:20]
        uops_1_iq_type = _RANDOM_16[6:4];	// @[util.scala:466:20]
        uops_1_fu_code = _RANDOM_16[16:7];	// @[util.scala:466:20]
        uops_1_ctrl_br_type = _RANDOM_16[20:17];	// @[util.scala:466:20]
        uops_1_ctrl_op1_sel = _RANDOM_16[22:21];	// @[util.scala:466:20]
        uops_1_ctrl_op2_sel = _RANDOM_16[25:23];	// @[util.scala:466:20]
        uops_1_ctrl_imm_sel = _RANDOM_16[28:26];	// @[util.scala:466:20]
        uops_1_ctrl_op_fcn = {_RANDOM_16[31:29], _RANDOM_17[0]};	// @[util.scala:466:20]
        uops_1_ctrl_fcn_dw = _RANDOM_17[1];	// @[util.scala:466:20]
        uops_1_ctrl_csr_cmd = _RANDOM_17[4:2];	// @[util.scala:466:20]
        uops_1_ctrl_is_load = _RANDOM_17[5];	// @[util.scala:466:20]
        uops_1_ctrl_is_sta = _RANDOM_17[6];	// @[util.scala:466:20]
        uops_1_ctrl_is_std = _RANDOM_17[7];	// @[util.scala:466:20]
        uops_1_iw_state = _RANDOM_17[9:8];	// @[util.scala:466:20]
        uops_1_iw_p1_poisoned = _RANDOM_17[10];	// @[util.scala:466:20]
        uops_1_iw_p2_poisoned = _RANDOM_17[11];	// @[util.scala:466:20]
        uops_1_is_br = _RANDOM_17[12];	// @[util.scala:466:20]
        uops_1_is_jalr = _RANDOM_17[13];	// @[util.scala:466:20]
        uops_1_is_jal = _RANDOM_17[14];	// @[util.scala:466:20]
        uops_1_is_sfb = _RANDOM_17[15];	// @[util.scala:466:20]
        uops_1_br_mask = _RANDOM_17[23:16];	// @[util.scala:466:20]
        uops_1_br_tag = _RANDOM_17[26:24];	// @[util.scala:466:20]
        uops_1_ftq_idx = _RANDOM_17[30:27];	// @[util.scala:466:20]
        uops_1_edge_inst = _RANDOM_17[31];	// @[util.scala:466:20]
        uops_1_pc_lob = _RANDOM_18[5:0];	// @[util.scala:466:20]
        uops_1_taken = _RANDOM_18[6];	// @[util.scala:466:20]
        uops_1_imm_packed = _RANDOM_18[26:7];	// @[util.scala:466:20]
        uops_1_csr_addr = {_RANDOM_18[31:27], _RANDOM_19[6:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = _RANDOM_19[11:7];	// @[util.scala:466:20]
        uops_1_ldq_idx = _RANDOM_19[14:12];	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_19[17:15];	// @[util.scala:466:20]
        uops_1_rxq_idx = _RANDOM_19[19:18];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_19[25:20];	// @[util.scala:466:20]
        uops_1_prs1 = _RANDOM_19[31:26];	// @[util.scala:466:20]
        uops_1_prs2 = _RANDOM_20[5:0];	// @[util.scala:466:20]
        uops_1_prs3 = _RANDOM_20[11:6];	// @[util.scala:466:20]
        uops_1_ppred = _RANDOM_20[15:12];	// @[util.scala:466:20]
        uops_1_prs1_busy = _RANDOM_20[16];	// @[util.scala:466:20]
        uops_1_prs2_busy = _RANDOM_20[17];	// @[util.scala:466:20]
        uops_1_prs3_busy = _RANDOM_20[18];	// @[util.scala:466:20]
        uops_1_ppred_busy = _RANDOM_20[19];	// @[util.scala:466:20]
        uops_1_stale_pdst = _RANDOM_20[25:20];	// @[util.scala:466:20]
        uops_1_exception = _RANDOM_20[26];	// @[util.scala:466:20]
        uops_1_exc_cause = {_RANDOM_20[31:27], _RANDOM_21, _RANDOM_22[26:0]};	// @[util.scala:466:20]
        uops_1_bypassable = _RANDOM_22[27];	// @[util.scala:466:20]
        uops_1_mem_cmd = {_RANDOM_22[31:28], _RANDOM_23[0]};	// @[util.scala:466:20]
        uops_1_mem_size = _RANDOM_23[2:1];	// @[util.scala:466:20]
        uops_1_mem_signed = _RANDOM_23[3];	// @[util.scala:466:20]
        uops_1_is_fence = _RANDOM_23[4];	// @[util.scala:466:20]
        uops_1_is_fencei = _RANDOM_23[5];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_23[6];	// @[util.scala:466:20]
        uops_1_uses_ldq = _RANDOM_23[7];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_23[8];	// @[util.scala:466:20]
        uops_1_is_sys_pc2epc = _RANDOM_23[9];	// @[util.scala:466:20]
        uops_1_is_unique = _RANDOM_23[10];	// @[util.scala:466:20]
        uops_1_flush_on_commit = _RANDOM_23[11];	// @[util.scala:466:20]
        uops_1_ldst_is_rs1 = _RANDOM_23[12];	// @[util.scala:466:20]
        uops_1_ldst = _RANDOM_23[18:13];	// @[util.scala:466:20]
        uops_1_lrs1 = _RANDOM_23[24:19];	// @[util.scala:466:20]
        uops_1_lrs2 = _RANDOM_23[30:25];	// @[util.scala:466:20]
        uops_1_lrs3 = {_RANDOM_23[31], _RANDOM_24[4:0]};	// @[util.scala:466:20]
        uops_1_ldst_val = _RANDOM_24[5];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_24[7:6];	// @[util.scala:466:20]
        uops_1_lrs1_rtype = _RANDOM_24[9:8];	// @[util.scala:466:20]
        uops_1_lrs2_rtype = _RANDOM_24[11:10];	// @[util.scala:466:20]
        uops_1_frs3_en = _RANDOM_24[12];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_24[13];	// @[util.scala:466:20]
        uops_1_fp_single = _RANDOM_24[14];	// @[util.scala:466:20]
        uops_1_xcpt_pf_if = _RANDOM_24[15];	// @[util.scala:466:20]
        uops_1_xcpt_ae_if = _RANDOM_24[16];	// @[util.scala:466:20]
        uops_1_xcpt_ma_if = _RANDOM_24[17];	// @[util.scala:466:20]
        uops_1_bp_debug_if = _RANDOM_24[18];	// @[util.scala:466:20]
        uops_1_bp_xcpt_if = _RANDOM_24[19];	// @[util.scala:466:20]
        uops_1_debug_fsrc = _RANDOM_24[21:20];	// @[util.scala:466:20]
        uops_1_debug_tsrc = _RANDOM_24[23:22];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_24[30:24];	// @[util.scala:466:20]
        uops_2_inst = {_RANDOM_24[31], _RANDOM_25[30:0]};	// @[util.scala:466:20]
        uops_2_debug_inst = {_RANDOM_25[31], _RANDOM_26[30:0]};	// @[util.scala:466:20]
        uops_2_is_rvc = _RANDOM_26[31];	// @[util.scala:466:20]
        uops_2_debug_pc = {_RANDOM_27, _RANDOM_28[7:0]};	// @[util.scala:466:20]
        uops_2_iq_type = _RANDOM_28[10:8];	// @[util.scala:466:20]
        uops_2_fu_code = _RANDOM_28[20:11];	// @[util.scala:466:20]
        uops_2_ctrl_br_type = _RANDOM_28[24:21];	// @[util.scala:466:20]
        uops_2_ctrl_op1_sel = _RANDOM_28[26:25];	// @[util.scala:466:20]
        uops_2_ctrl_op2_sel = _RANDOM_28[29:27];	// @[util.scala:466:20]
        uops_2_ctrl_imm_sel = {_RANDOM_28[31:30], _RANDOM_29[0]};	// @[util.scala:466:20]
        uops_2_ctrl_op_fcn = _RANDOM_29[4:1];	// @[util.scala:466:20]
        uops_2_ctrl_fcn_dw = _RANDOM_29[5];	// @[util.scala:466:20]
        uops_2_ctrl_csr_cmd = _RANDOM_29[8:6];	// @[util.scala:466:20]
        uops_2_ctrl_is_load = _RANDOM_29[9];	// @[util.scala:466:20]
        uops_2_ctrl_is_sta = _RANDOM_29[10];	// @[util.scala:466:20]
        uops_2_ctrl_is_std = _RANDOM_29[11];	// @[util.scala:466:20]
        uops_2_iw_state = _RANDOM_29[13:12];	// @[util.scala:466:20]
        uops_2_iw_p1_poisoned = _RANDOM_29[14];	// @[util.scala:466:20]
        uops_2_iw_p2_poisoned = _RANDOM_29[15];	// @[util.scala:466:20]
        uops_2_is_br = _RANDOM_29[16];	// @[util.scala:466:20]
        uops_2_is_jalr = _RANDOM_29[17];	// @[util.scala:466:20]
        uops_2_is_jal = _RANDOM_29[18];	// @[util.scala:466:20]
        uops_2_is_sfb = _RANDOM_29[19];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_29[27:20];	// @[util.scala:466:20]
        uops_2_br_tag = _RANDOM_29[30:28];	// @[util.scala:466:20]
        uops_2_ftq_idx = {_RANDOM_29[31], _RANDOM_30[2:0]};	// @[util.scala:466:20]
        uops_2_edge_inst = _RANDOM_30[3];	// @[util.scala:466:20]
        uops_2_pc_lob = _RANDOM_30[9:4];	// @[util.scala:466:20]
        uops_2_taken = _RANDOM_30[10];	// @[util.scala:466:20]
        uops_2_imm_packed = _RANDOM_30[30:11];	// @[util.scala:466:20]
        uops_2_csr_addr = {_RANDOM_30[31], _RANDOM_31[10:0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_31[15:11];	// @[util.scala:466:20]
        uops_2_ldq_idx = _RANDOM_31[18:16];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_31[21:19];	// @[util.scala:466:20]
        uops_2_rxq_idx = _RANDOM_31[23:22];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_31[29:24];	// @[util.scala:466:20]
        uops_2_prs1 = {_RANDOM_31[31:30], _RANDOM_32[3:0]};	// @[util.scala:466:20]
        uops_2_prs2 = _RANDOM_32[9:4];	// @[util.scala:466:20]
        uops_2_prs3 = _RANDOM_32[15:10];	// @[util.scala:466:20]
        uops_2_ppred = _RANDOM_32[19:16];	// @[util.scala:466:20]
        uops_2_prs1_busy = _RANDOM_32[20];	// @[util.scala:466:20]
        uops_2_prs2_busy = _RANDOM_32[21];	// @[util.scala:466:20]
        uops_2_prs3_busy = _RANDOM_32[22];	// @[util.scala:466:20]
        uops_2_ppred_busy = _RANDOM_32[23];	// @[util.scala:466:20]
        uops_2_stale_pdst = _RANDOM_32[29:24];	// @[util.scala:466:20]
        uops_2_exception = _RANDOM_32[30];	// @[util.scala:466:20]
        uops_2_exc_cause = {_RANDOM_32[31], _RANDOM_33, _RANDOM_34[30:0]};	// @[util.scala:466:20]
        uops_2_bypassable = _RANDOM_34[31];	// @[util.scala:466:20]
        uops_2_mem_cmd = _RANDOM_35[4:0];	// @[util.scala:466:20]
        uops_2_mem_size = _RANDOM_35[6:5];	// @[util.scala:466:20]
        uops_2_mem_signed = _RANDOM_35[7];	// @[util.scala:466:20]
        uops_2_is_fence = _RANDOM_35[8];	// @[util.scala:466:20]
        uops_2_is_fencei = _RANDOM_35[9];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_35[10];	// @[util.scala:466:20]
        uops_2_uses_ldq = _RANDOM_35[11];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_35[12];	// @[util.scala:466:20]
        uops_2_is_sys_pc2epc = _RANDOM_35[13];	// @[util.scala:466:20]
        uops_2_is_unique = _RANDOM_35[14];	// @[util.scala:466:20]
        uops_2_flush_on_commit = _RANDOM_35[15];	// @[util.scala:466:20]
        uops_2_ldst_is_rs1 = _RANDOM_35[16];	// @[util.scala:466:20]
        uops_2_ldst = _RANDOM_35[22:17];	// @[util.scala:466:20]
        uops_2_lrs1 = _RANDOM_35[28:23];	// @[util.scala:466:20]
        uops_2_lrs2 = {_RANDOM_35[31:29], _RANDOM_36[2:0]};	// @[util.scala:466:20]
        uops_2_lrs3 = _RANDOM_36[8:3];	// @[util.scala:466:20]
        uops_2_ldst_val = _RANDOM_36[9];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_36[11:10];	// @[util.scala:466:20]
        uops_2_lrs1_rtype = _RANDOM_36[13:12];	// @[util.scala:466:20]
        uops_2_lrs2_rtype = _RANDOM_36[15:14];	// @[util.scala:466:20]
        uops_2_frs3_en = _RANDOM_36[16];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_36[17];	// @[util.scala:466:20]
        uops_2_fp_single = _RANDOM_36[18];	// @[util.scala:466:20]
        uops_2_xcpt_pf_if = _RANDOM_36[19];	// @[util.scala:466:20]
        uops_2_xcpt_ae_if = _RANDOM_36[20];	// @[util.scala:466:20]
        uops_2_xcpt_ma_if = _RANDOM_36[21];	// @[util.scala:466:20]
        uops_2_bp_debug_if = _RANDOM_36[22];	// @[util.scala:466:20]
        uops_2_bp_xcpt_if = _RANDOM_36[23];	// @[util.scala:466:20]
        uops_2_debug_fsrc = _RANDOM_36[25:24];	// @[util.scala:466:20]
        uops_2_debug_tsrc = _RANDOM_36[27:26];	// @[util.scala:466:20]
        uops_3_uopc = {_RANDOM_36[31:28], _RANDOM_37[2:0]};	// @[util.scala:466:20]
        uops_3_inst = {_RANDOM_37[31:3], _RANDOM_38[2:0]};	// @[util.scala:466:20]
        uops_3_debug_inst = {_RANDOM_38[31:3], _RANDOM_39[2:0]};	// @[util.scala:466:20]
        uops_3_is_rvc = _RANDOM_39[3];	// @[util.scala:466:20]
        uops_3_debug_pc = {_RANDOM_39[31:4], _RANDOM_40[11:0]};	// @[util.scala:466:20]
        uops_3_iq_type = _RANDOM_40[14:12];	// @[util.scala:466:20]
        uops_3_fu_code = _RANDOM_40[24:15];	// @[util.scala:466:20]
        uops_3_ctrl_br_type = _RANDOM_40[28:25];	// @[util.scala:466:20]
        uops_3_ctrl_op1_sel = _RANDOM_40[30:29];	// @[util.scala:466:20]
        uops_3_ctrl_op2_sel = {_RANDOM_40[31], _RANDOM_41[1:0]};	// @[util.scala:466:20]
        uops_3_ctrl_imm_sel = _RANDOM_41[4:2];	// @[util.scala:466:20]
        uops_3_ctrl_op_fcn = _RANDOM_41[8:5];	// @[util.scala:466:20]
        uops_3_ctrl_fcn_dw = _RANDOM_41[9];	// @[util.scala:466:20]
        uops_3_ctrl_csr_cmd = _RANDOM_41[12:10];	// @[util.scala:466:20]
        uops_3_ctrl_is_load = _RANDOM_41[13];	// @[util.scala:466:20]
        uops_3_ctrl_is_sta = _RANDOM_41[14];	// @[util.scala:466:20]
        uops_3_ctrl_is_std = _RANDOM_41[15];	// @[util.scala:466:20]
        uops_3_iw_state = _RANDOM_41[17:16];	// @[util.scala:466:20]
        uops_3_iw_p1_poisoned = _RANDOM_41[18];	// @[util.scala:466:20]
        uops_3_iw_p2_poisoned = _RANDOM_41[19];	// @[util.scala:466:20]
        uops_3_is_br = _RANDOM_41[20];	// @[util.scala:466:20]
        uops_3_is_jalr = _RANDOM_41[21];	// @[util.scala:466:20]
        uops_3_is_jal = _RANDOM_41[22];	// @[util.scala:466:20]
        uops_3_is_sfb = _RANDOM_41[23];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_41[31:24];	// @[util.scala:466:20]
        uops_3_br_tag = _RANDOM_42[2:0];	// @[util.scala:466:20]
        uops_3_ftq_idx = _RANDOM_42[6:3];	// @[util.scala:466:20]
        uops_3_edge_inst = _RANDOM_42[7];	// @[util.scala:466:20]
        uops_3_pc_lob = _RANDOM_42[13:8];	// @[util.scala:466:20]
        uops_3_taken = _RANDOM_42[14];	// @[util.scala:466:20]
        uops_3_imm_packed = {_RANDOM_42[31:15], _RANDOM_43[2:0]};	// @[util.scala:466:20]
        uops_3_csr_addr = _RANDOM_43[14:3];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_43[19:15];	// @[util.scala:466:20]
        uops_3_ldq_idx = _RANDOM_43[22:20];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_43[25:23];	// @[util.scala:466:20]
        uops_3_rxq_idx = _RANDOM_43[27:26];	// @[util.scala:466:20]
        uops_3_pdst = {_RANDOM_43[31:28], _RANDOM_44[1:0]};	// @[util.scala:466:20]
        uops_3_prs1 = _RANDOM_44[7:2];	// @[util.scala:466:20]
        uops_3_prs2 = _RANDOM_44[13:8];	// @[util.scala:466:20]
        uops_3_prs3 = _RANDOM_44[19:14];	// @[util.scala:466:20]
        uops_3_ppred = _RANDOM_44[23:20];	// @[util.scala:466:20]
        uops_3_prs1_busy = _RANDOM_44[24];	// @[util.scala:466:20]
        uops_3_prs2_busy = _RANDOM_44[25];	// @[util.scala:466:20]
        uops_3_prs3_busy = _RANDOM_44[26];	// @[util.scala:466:20]
        uops_3_ppred_busy = _RANDOM_44[27];	// @[util.scala:466:20]
        uops_3_stale_pdst = {_RANDOM_44[31:28], _RANDOM_45[1:0]};	// @[util.scala:466:20]
        uops_3_exception = _RANDOM_45[2];	// @[util.scala:466:20]
        uops_3_exc_cause = {_RANDOM_45[31:3], _RANDOM_46, _RANDOM_47[2:0]};	// @[util.scala:466:20]
        uops_3_bypassable = _RANDOM_47[3];	// @[util.scala:466:20]
        uops_3_mem_cmd = _RANDOM_47[8:4];	// @[util.scala:466:20]
        uops_3_mem_size = _RANDOM_47[10:9];	// @[util.scala:466:20]
        uops_3_mem_signed = _RANDOM_47[11];	// @[util.scala:466:20]
        uops_3_is_fence = _RANDOM_47[12];	// @[util.scala:466:20]
        uops_3_is_fencei = _RANDOM_47[13];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_47[14];	// @[util.scala:466:20]
        uops_3_uses_ldq = _RANDOM_47[15];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_47[16];	// @[util.scala:466:20]
        uops_3_is_sys_pc2epc = _RANDOM_47[17];	// @[util.scala:466:20]
        uops_3_is_unique = _RANDOM_47[18];	// @[util.scala:466:20]
        uops_3_flush_on_commit = _RANDOM_47[19];	// @[util.scala:466:20]
        uops_3_ldst_is_rs1 = _RANDOM_47[20];	// @[util.scala:466:20]
        uops_3_ldst = _RANDOM_47[26:21];	// @[util.scala:466:20]
        uops_3_lrs1 = {_RANDOM_47[31:27], _RANDOM_48[0]};	// @[util.scala:466:20]
        uops_3_lrs2 = _RANDOM_48[6:1];	// @[util.scala:466:20]
        uops_3_lrs3 = _RANDOM_48[12:7];	// @[util.scala:466:20]
        uops_3_ldst_val = _RANDOM_48[13];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_48[15:14];	// @[util.scala:466:20]
        uops_3_lrs1_rtype = _RANDOM_48[17:16];	// @[util.scala:466:20]
        uops_3_lrs2_rtype = _RANDOM_48[19:18];	// @[util.scala:466:20]
        uops_3_frs3_en = _RANDOM_48[20];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_48[21];	// @[util.scala:466:20]
        uops_3_fp_single = _RANDOM_48[22];	// @[util.scala:466:20]
        uops_3_xcpt_pf_if = _RANDOM_48[23];	// @[util.scala:466:20]
        uops_3_xcpt_ae_if = _RANDOM_48[24];	// @[util.scala:466:20]
        uops_3_xcpt_ma_if = _RANDOM_48[25];	// @[util.scala:466:20]
        uops_3_bp_debug_if = _RANDOM_48[26];	// @[util.scala:466:20]
        uops_3_bp_xcpt_if = _RANDOM_48[27];	// @[util.scala:466:20]
        uops_3_debug_fsrc = _RANDOM_48[29:28];	// @[util.scala:466:20]
        uops_3_debug_tsrc = _RANDOM_48[31:30];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_49[6:0];	// @[util.scala:466:20]
        uops_4_inst = {_RANDOM_49[31:7], _RANDOM_50[6:0]};	// @[util.scala:466:20]
        uops_4_debug_inst = {_RANDOM_50[31:7], _RANDOM_51[6:0]};	// @[util.scala:466:20]
        uops_4_is_rvc = _RANDOM_51[7];	// @[util.scala:466:20]
        uops_4_debug_pc = {_RANDOM_51[31:8], _RANDOM_52[15:0]};	// @[util.scala:466:20]
        uops_4_iq_type = _RANDOM_52[18:16];	// @[util.scala:466:20]
        uops_4_fu_code = _RANDOM_52[28:19];	// @[util.scala:466:20]
        uops_4_ctrl_br_type = {_RANDOM_52[31:29], _RANDOM_53[0]};	// @[util.scala:466:20]
        uops_4_ctrl_op1_sel = _RANDOM_53[2:1];	// @[util.scala:466:20]
        uops_4_ctrl_op2_sel = _RANDOM_53[5:3];	// @[util.scala:466:20]
        uops_4_ctrl_imm_sel = _RANDOM_53[8:6];	// @[util.scala:466:20]
        uops_4_ctrl_op_fcn = _RANDOM_53[12:9];	// @[util.scala:466:20]
        uops_4_ctrl_fcn_dw = _RANDOM_53[13];	// @[util.scala:466:20]
        uops_4_ctrl_csr_cmd = _RANDOM_53[16:14];	// @[util.scala:466:20]
        uops_4_ctrl_is_load = _RANDOM_53[17];	// @[util.scala:466:20]
        uops_4_ctrl_is_sta = _RANDOM_53[18];	// @[util.scala:466:20]
        uops_4_ctrl_is_std = _RANDOM_53[19];	// @[util.scala:466:20]
        uops_4_iw_state = _RANDOM_53[21:20];	// @[util.scala:466:20]
        uops_4_iw_p1_poisoned = _RANDOM_53[22];	// @[util.scala:466:20]
        uops_4_iw_p2_poisoned = _RANDOM_53[23];	// @[util.scala:466:20]
        uops_4_is_br = _RANDOM_53[24];	// @[util.scala:466:20]
        uops_4_is_jalr = _RANDOM_53[25];	// @[util.scala:466:20]
        uops_4_is_jal = _RANDOM_53[26];	// @[util.scala:466:20]
        uops_4_is_sfb = _RANDOM_53[27];	// @[util.scala:466:20]
        uops_4_br_mask = {_RANDOM_53[31:28], _RANDOM_54[3:0]};	// @[util.scala:466:20]
        uops_4_br_tag = _RANDOM_54[6:4];	// @[util.scala:466:20]
        uops_4_ftq_idx = _RANDOM_54[10:7];	// @[util.scala:466:20]
        uops_4_edge_inst = _RANDOM_54[11];	// @[util.scala:466:20]
        uops_4_pc_lob = _RANDOM_54[17:12];	// @[util.scala:466:20]
        uops_4_taken = _RANDOM_54[18];	// @[util.scala:466:20]
        uops_4_imm_packed = {_RANDOM_54[31:19], _RANDOM_55[6:0]};	// @[util.scala:466:20]
        uops_4_csr_addr = _RANDOM_55[18:7];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_55[23:19];	// @[util.scala:466:20]
        uops_4_ldq_idx = _RANDOM_55[26:24];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_55[29:27];	// @[util.scala:466:20]
        uops_4_rxq_idx = _RANDOM_55[31:30];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_56[5:0];	// @[util.scala:466:20]
        uops_4_prs1 = _RANDOM_56[11:6];	// @[util.scala:466:20]
        uops_4_prs2 = _RANDOM_56[17:12];	// @[util.scala:466:20]
        uops_4_prs3 = _RANDOM_56[23:18];	// @[util.scala:466:20]
        uops_4_ppred = _RANDOM_56[27:24];	// @[util.scala:466:20]
        uops_4_prs1_busy = _RANDOM_56[28];	// @[util.scala:466:20]
        uops_4_prs2_busy = _RANDOM_56[29];	// @[util.scala:466:20]
        uops_4_prs3_busy = _RANDOM_56[30];	// @[util.scala:466:20]
        uops_4_ppred_busy = _RANDOM_56[31];	// @[util.scala:466:20]
        uops_4_stale_pdst = _RANDOM_57[5:0];	// @[util.scala:466:20]
        uops_4_exception = _RANDOM_57[6];	// @[util.scala:466:20]
        uops_4_exc_cause = {_RANDOM_57[31:7], _RANDOM_58, _RANDOM_59[6:0]};	// @[util.scala:466:20]
        uops_4_bypassable = _RANDOM_59[7];	// @[util.scala:466:20]
        uops_4_mem_cmd = _RANDOM_59[12:8];	// @[util.scala:466:20]
        uops_4_mem_size = _RANDOM_59[14:13];	// @[util.scala:466:20]
        uops_4_mem_signed = _RANDOM_59[15];	// @[util.scala:466:20]
        uops_4_is_fence = _RANDOM_59[16];	// @[util.scala:466:20]
        uops_4_is_fencei = _RANDOM_59[17];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_59[18];	// @[util.scala:466:20]
        uops_4_uses_ldq = _RANDOM_59[19];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_59[20];	// @[util.scala:466:20]
        uops_4_is_sys_pc2epc = _RANDOM_59[21];	// @[util.scala:466:20]
        uops_4_is_unique = _RANDOM_59[22];	// @[util.scala:466:20]
        uops_4_flush_on_commit = _RANDOM_59[23];	// @[util.scala:466:20]
        uops_4_ldst_is_rs1 = _RANDOM_59[24];	// @[util.scala:466:20]
        uops_4_ldst = _RANDOM_59[30:25];	// @[util.scala:466:20]
        uops_4_lrs1 = {_RANDOM_59[31], _RANDOM_60[4:0]};	// @[util.scala:466:20]
        uops_4_lrs2 = _RANDOM_60[10:5];	// @[util.scala:466:20]
        uops_4_lrs3 = _RANDOM_60[16:11];	// @[util.scala:466:20]
        uops_4_ldst_val = _RANDOM_60[17];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_60[19:18];	// @[util.scala:466:20]
        uops_4_lrs1_rtype = _RANDOM_60[21:20];	// @[util.scala:466:20]
        uops_4_lrs2_rtype = _RANDOM_60[23:22];	// @[util.scala:466:20]
        uops_4_frs3_en = _RANDOM_60[24];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_60[25];	// @[util.scala:466:20]
        uops_4_fp_single = _RANDOM_60[26];	// @[util.scala:466:20]
        uops_4_xcpt_pf_if = _RANDOM_60[27];	// @[util.scala:466:20]
        uops_4_xcpt_ae_if = _RANDOM_60[28];	// @[util.scala:466:20]
        uops_4_xcpt_ma_if = _RANDOM_60[29];	// @[util.scala:466:20]
        uops_4_bp_debug_if = _RANDOM_60[30];	// @[util.scala:466:20]
        uops_4_bp_xcpt_if = _RANDOM_60[31];	// @[util.scala:466:20]
        uops_4_debug_fsrc = _RANDOM_61[1:0];	// @[util.scala:466:20]
        uops_4_debug_tsrc = _RANDOM_61[3:2];	// @[util.scala:466:20]
        uops_5_uopc = _RANDOM_61[10:4];	// @[util.scala:466:20]
        uops_5_inst = {_RANDOM_61[31:11], _RANDOM_62[10:0]};	// @[util.scala:466:20]
        uops_5_debug_inst = {_RANDOM_62[31:11], _RANDOM_63[10:0]};	// @[util.scala:466:20]
        uops_5_is_rvc = _RANDOM_63[11];	// @[util.scala:466:20]
        uops_5_debug_pc = {_RANDOM_63[31:12], _RANDOM_64[19:0]};	// @[util.scala:466:20]
        uops_5_iq_type = _RANDOM_64[22:20];	// @[util.scala:466:20]
        uops_5_fu_code = {_RANDOM_64[31:23], _RANDOM_65[0]};	// @[util.scala:466:20]
        uops_5_ctrl_br_type = _RANDOM_65[4:1];	// @[util.scala:466:20]
        uops_5_ctrl_op1_sel = _RANDOM_65[6:5];	// @[util.scala:466:20]
        uops_5_ctrl_op2_sel = _RANDOM_65[9:7];	// @[util.scala:466:20]
        uops_5_ctrl_imm_sel = _RANDOM_65[12:10];	// @[util.scala:466:20]
        uops_5_ctrl_op_fcn = _RANDOM_65[16:13];	// @[util.scala:466:20]
        uops_5_ctrl_fcn_dw = _RANDOM_65[17];	// @[util.scala:466:20]
        uops_5_ctrl_csr_cmd = _RANDOM_65[20:18];	// @[util.scala:466:20]
        uops_5_ctrl_is_load = _RANDOM_65[21];	// @[util.scala:466:20]
        uops_5_ctrl_is_sta = _RANDOM_65[22];	// @[util.scala:466:20]
        uops_5_ctrl_is_std = _RANDOM_65[23];	// @[util.scala:466:20]
        uops_5_iw_state = _RANDOM_65[25:24];	// @[util.scala:466:20]
        uops_5_iw_p1_poisoned = _RANDOM_65[26];	// @[util.scala:466:20]
        uops_5_iw_p2_poisoned = _RANDOM_65[27];	// @[util.scala:466:20]
        uops_5_is_br = _RANDOM_65[28];	// @[util.scala:466:20]
        uops_5_is_jalr = _RANDOM_65[29];	// @[util.scala:466:20]
        uops_5_is_jal = _RANDOM_65[30];	// @[util.scala:466:20]
        uops_5_is_sfb = _RANDOM_65[31];	// @[util.scala:466:20]
        uops_5_br_mask = _RANDOM_66[7:0];	// @[util.scala:466:20]
        uops_5_br_tag = _RANDOM_66[10:8];	// @[util.scala:466:20]
        uops_5_ftq_idx = _RANDOM_66[14:11];	// @[util.scala:466:20]
        uops_5_edge_inst = _RANDOM_66[15];	// @[util.scala:466:20]
        uops_5_pc_lob = _RANDOM_66[21:16];	// @[util.scala:466:20]
        uops_5_taken = _RANDOM_66[22];	// @[util.scala:466:20]
        uops_5_imm_packed = {_RANDOM_66[31:23], _RANDOM_67[10:0]};	// @[util.scala:466:20]
        uops_5_csr_addr = _RANDOM_67[22:11];	// @[util.scala:466:20]
        uops_5_rob_idx = _RANDOM_67[27:23];	// @[util.scala:466:20]
        uops_5_ldq_idx = _RANDOM_67[30:28];	// @[util.scala:466:20]
        uops_5_stq_idx = {_RANDOM_67[31], _RANDOM_68[1:0]};	// @[util.scala:466:20]
        uops_5_rxq_idx = _RANDOM_68[3:2];	// @[util.scala:466:20]
        uops_5_pdst = _RANDOM_68[9:4];	// @[util.scala:466:20]
        uops_5_prs1 = _RANDOM_68[15:10];	// @[util.scala:466:20]
        uops_5_prs2 = _RANDOM_68[21:16];	// @[util.scala:466:20]
        uops_5_prs3 = _RANDOM_68[27:22];	// @[util.scala:466:20]
        uops_5_ppred = _RANDOM_68[31:28];	// @[util.scala:466:20]
        uops_5_prs1_busy = _RANDOM_69[0];	// @[util.scala:466:20]
        uops_5_prs2_busy = _RANDOM_69[1];	// @[util.scala:466:20]
        uops_5_prs3_busy = _RANDOM_69[2];	// @[util.scala:466:20]
        uops_5_ppred_busy = _RANDOM_69[3];	// @[util.scala:466:20]
        uops_5_stale_pdst = _RANDOM_69[9:4];	// @[util.scala:466:20]
        uops_5_exception = _RANDOM_69[10];	// @[util.scala:466:20]
        uops_5_exc_cause = {_RANDOM_69[31:11], _RANDOM_70, _RANDOM_71[10:0]};	// @[util.scala:466:20]
        uops_5_bypassable = _RANDOM_71[11];	// @[util.scala:466:20]
        uops_5_mem_cmd = _RANDOM_71[16:12];	// @[util.scala:466:20]
        uops_5_mem_size = _RANDOM_71[18:17];	// @[util.scala:466:20]
        uops_5_mem_signed = _RANDOM_71[19];	// @[util.scala:466:20]
        uops_5_is_fence = _RANDOM_71[20];	// @[util.scala:466:20]
        uops_5_is_fencei = _RANDOM_71[21];	// @[util.scala:466:20]
        uops_5_is_amo = _RANDOM_71[22];	// @[util.scala:466:20]
        uops_5_uses_ldq = _RANDOM_71[23];	// @[util.scala:466:20]
        uops_5_uses_stq = _RANDOM_71[24];	// @[util.scala:466:20]
        uops_5_is_sys_pc2epc = _RANDOM_71[25];	// @[util.scala:466:20]
        uops_5_is_unique = _RANDOM_71[26];	// @[util.scala:466:20]
        uops_5_flush_on_commit = _RANDOM_71[27];	// @[util.scala:466:20]
        uops_5_ldst_is_rs1 = _RANDOM_71[28];	// @[util.scala:466:20]
        uops_5_ldst = {_RANDOM_71[31:29], _RANDOM_72[2:0]};	// @[util.scala:466:20]
        uops_5_lrs1 = _RANDOM_72[8:3];	// @[util.scala:466:20]
        uops_5_lrs2 = _RANDOM_72[14:9];	// @[util.scala:466:20]
        uops_5_lrs3 = _RANDOM_72[20:15];	// @[util.scala:466:20]
        uops_5_ldst_val = _RANDOM_72[21];	// @[util.scala:466:20]
        uops_5_dst_rtype = _RANDOM_72[23:22];	// @[util.scala:466:20]
        uops_5_lrs1_rtype = _RANDOM_72[25:24];	// @[util.scala:466:20]
        uops_5_lrs2_rtype = _RANDOM_72[27:26];	// @[util.scala:466:20]
        uops_5_frs3_en = _RANDOM_72[28];	// @[util.scala:466:20]
        uops_5_fp_val = _RANDOM_72[29];	// @[util.scala:466:20]
        uops_5_fp_single = _RANDOM_72[30];	// @[util.scala:466:20]
        uops_5_xcpt_pf_if = _RANDOM_72[31];	// @[util.scala:466:20]
        uops_5_xcpt_ae_if = _RANDOM_73[0];	// @[util.scala:466:20]
        uops_5_xcpt_ma_if = _RANDOM_73[1];	// @[util.scala:466:20]
        uops_5_bp_debug_if = _RANDOM_73[2];	// @[util.scala:466:20]
        uops_5_bp_xcpt_if = _RANDOM_73[3];	// @[util.scala:466:20]
        uops_5_debug_fsrc = _RANDOM_73[5:4];	// @[util.scala:466:20]
        uops_5_debug_tsrc = _RANDOM_73[7:6];	// @[util.scala:466:20]
        uops_6_uopc = _RANDOM_73[14:8];	// @[util.scala:466:20]
        uops_6_inst = {_RANDOM_73[31:15], _RANDOM_74[14:0]};	// @[util.scala:466:20]
        uops_6_debug_inst = {_RANDOM_74[31:15], _RANDOM_75[14:0]};	// @[util.scala:466:20]
        uops_6_is_rvc = _RANDOM_75[15];	// @[util.scala:466:20]
        uops_6_debug_pc = {_RANDOM_75[31:16], _RANDOM_76[23:0]};	// @[util.scala:466:20]
        uops_6_iq_type = _RANDOM_76[26:24];	// @[util.scala:466:20]
        uops_6_fu_code = {_RANDOM_76[31:27], _RANDOM_77[4:0]};	// @[util.scala:466:20]
        uops_6_ctrl_br_type = _RANDOM_77[8:5];	// @[util.scala:466:20]
        uops_6_ctrl_op1_sel = _RANDOM_77[10:9];	// @[util.scala:466:20]
        uops_6_ctrl_op2_sel = _RANDOM_77[13:11];	// @[util.scala:466:20]
        uops_6_ctrl_imm_sel = _RANDOM_77[16:14];	// @[util.scala:466:20]
        uops_6_ctrl_op_fcn = _RANDOM_77[20:17];	// @[util.scala:466:20]
        uops_6_ctrl_fcn_dw = _RANDOM_77[21];	// @[util.scala:466:20]
        uops_6_ctrl_csr_cmd = _RANDOM_77[24:22];	// @[util.scala:466:20]
        uops_6_ctrl_is_load = _RANDOM_77[25];	// @[util.scala:466:20]
        uops_6_ctrl_is_sta = _RANDOM_77[26];	// @[util.scala:466:20]
        uops_6_ctrl_is_std = _RANDOM_77[27];	// @[util.scala:466:20]
        uops_6_iw_state = _RANDOM_77[29:28];	// @[util.scala:466:20]
        uops_6_iw_p1_poisoned = _RANDOM_77[30];	// @[util.scala:466:20]
        uops_6_iw_p2_poisoned = _RANDOM_77[31];	// @[util.scala:466:20]
        uops_6_is_br = _RANDOM_78[0];	// @[util.scala:466:20]
        uops_6_is_jalr = _RANDOM_78[1];	// @[util.scala:466:20]
        uops_6_is_jal = _RANDOM_78[2];	// @[util.scala:466:20]
        uops_6_is_sfb = _RANDOM_78[3];	// @[util.scala:466:20]
        uops_6_br_mask = _RANDOM_78[11:4];	// @[util.scala:466:20]
        uops_6_br_tag = _RANDOM_78[14:12];	// @[util.scala:466:20]
        uops_6_ftq_idx = _RANDOM_78[18:15];	// @[util.scala:466:20]
        uops_6_edge_inst = _RANDOM_78[19];	// @[util.scala:466:20]
        uops_6_pc_lob = _RANDOM_78[25:20];	// @[util.scala:466:20]
        uops_6_taken = _RANDOM_78[26];	// @[util.scala:466:20]
        uops_6_imm_packed = {_RANDOM_78[31:27], _RANDOM_79[14:0]};	// @[util.scala:466:20]
        uops_6_csr_addr = _RANDOM_79[26:15];	// @[util.scala:466:20]
        uops_6_rob_idx = _RANDOM_79[31:27];	// @[util.scala:466:20]
        uops_6_ldq_idx = _RANDOM_80[2:0];	// @[util.scala:466:20]
        uops_6_stq_idx = _RANDOM_80[5:3];	// @[util.scala:466:20]
        uops_6_rxq_idx = _RANDOM_80[7:6];	// @[util.scala:466:20]
        uops_6_pdst = _RANDOM_80[13:8];	// @[util.scala:466:20]
        uops_6_prs1 = _RANDOM_80[19:14];	// @[util.scala:466:20]
        uops_6_prs2 = _RANDOM_80[25:20];	// @[util.scala:466:20]
        uops_6_prs3 = _RANDOM_80[31:26];	// @[util.scala:466:20]
        uops_6_ppred = _RANDOM_81[3:0];	// @[util.scala:466:20]
        uops_6_prs1_busy = _RANDOM_81[4];	// @[util.scala:466:20]
        uops_6_prs2_busy = _RANDOM_81[5];	// @[util.scala:466:20]
        uops_6_prs3_busy = _RANDOM_81[6];	// @[util.scala:466:20]
        uops_6_ppred_busy = _RANDOM_81[7];	// @[util.scala:466:20]
        uops_6_stale_pdst = _RANDOM_81[13:8];	// @[util.scala:466:20]
        uops_6_exception = _RANDOM_81[14];	// @[util.scala:466:20]
        uops_6_exc_cause = {_RANDOM_81[31:15], _RANDOM_82, _RANDOM_83[14:0]};	// @[util.scala:466:20]
        uops_6_bypassable = _RANDOM_83[15];	// @[util.scala:466:20]
        uops_6_mem_cmd = _RANDOM_83[20:16];	// @[util.scala:466:20]
        uops_6_mem_size = _RANDOM_83[22:21];	// @[util.scala:466:20]
        uops_6_mem_signed = _RANDOM_83[23];	// @[util.scala:466:20]
        uops_6_is_fence = _RANDOM_83[24];	// @[util.scala:466:20]
        uops_6_is_fencei = _RANDOM_83[25];	// @[util.scala:466:20]
        uops_6_is_amo = _RANDOM_83[26];	// @[util.scala:466:20]
        uops_6_uses_ldq = _RANDOM_83[27];	// @[util.scala:466:20]
        uops_6_uses_stq = _RANDOM_83[28];	// @[util.scala:466:20]
        uops_6_is_sys_pc2epc = _RANDOM_83[29];	// @[util.scala:466:20]
        uops_6_is_unique = _RANDOM_83[30];	// @[util.scala:466:20]
        uops_6_flush_on_commit = _RANDOM_83[31];	// @[util.scala:466:20]
        uops_6_ldst_is_rs1 = _RANDOM_84[0];	// @[util.scala:466:20]
        uops_6_ldst = _RANDOM_84[6:1];	// @[util.scala:466:20]
        uops_6_lrs1 = _RANDOM_84[12:7];	// @[util.scala:466:20]
        uops_6_lrs2 = _RANDOM_84[18:13];	// @[util.scala:466:20]
        uops_6_lrs3 = _RANDOM_84[24:19];	// @[util.scala:466:20]
        uops_6_ldst_val = _RANDOM_84[25];	// @[util.scala:466:20]
        uops_6_dst_rtype = _RANDOM_84[27:26];	// @[util.scala:466:20]
        uops_6_lrs1_rtype = _RANDOM_84[29:28];	// @[util.scala:466:20]
        uops_6_lrs2_rtype = _RANDOM_84[31:30];	// @[util.scala:466:20]
        uops_6_frs3_en = _RANDOM_85[0];	// @[util.scala:466:20]
        uops_6_fp_val = _RANDOM_85[1];	// @[util.scala:466:20]
        uops_6_fp_single = _RANDOM_85[2];	// @[util.scala:466:20]
        uops_6_xcpt_pf_if = _RANDOM_85[3];	// @[util.scala:466:20]
        uops_6_xcpt_ae_if = _RANDOM_85[4];	// @[util.scala:466:20]
        uops_6_xcpt_ma_if = _RANDOM_85[5];	// @[util.scala:466:20]
        uops_6_bp_debug_if = _RANDOM_85[6];	// @[util.scala:466:20]
        uops_6_bp_xcpt_if = _RANDOM_85[7];	// @[util.scala:466:20]
        uops_6_debug_fsrc = _RANDOM_85[9:8];	// @[util.scala:466:20]
        uops_6_debug_tsrc = _RANDOM_85[11:10];	// @[util.scala:466:20]
        uops_7_uopc = _RANDOM_85[18:12];	// @[util.scala:466:20]
        uops_7_inst = {_RANDOM_85[31:19], _RANDOM_86[18:0]};	// @[util.scala:466:20]
        uops_7_debug_inst = {_RANDOM_86[31:19], _RANDOM_87[18:0]};	// @[util.scala:466:20]
        uops_7_is_rvc = _RANDOM_87[19];	// @[util.scala:466:20]
        uops_7_debug_pc = {_RANDOM_87[31:20], _RANDOM_88[27:0]};	// @[util.scala:466:20]
        uops_7_iq_type = _RANDOM_88[30:28];	// @[util.scala:466:20]
        uops_7_fu_code = {_RANDOM_88[31], _RANDOM_89[8:0]};	// @[util.scala:466:20]
        uops_7_ctrl_br_type = _RANDOM_89[12:9];	// @[util.scala:466:20]
        uops_7_ctrl_op1_sel = _RANDOM_89[14:13];	// @[util.scala:466:20]
        uops_7_ctrl_op2_sel = _RANDOM_89[17:15];	// @[util.scala:466:20]
        uops_7_ctrl_imm_sel = _RANDOM_89[20:18];	// @[util.scala:466:20]
        uops_7_ctrl_op_fcn = _RANDOM_89[24:21];	// @[util.scala:466:20]
        uops_7_ctrl_fcn_dw = _RANDOM_89[25];	// @[util.scala:466:20]
        uops_7_ctrl_csr_cmd = _RANDOM_89[28:26];	// @[util.scala:466:20]
        uops_7_ctrl_is_load = _RANDOM_89[29];	// @[util.scala:466:20]
        uops_7_ctrl_is_sta = _RANDOM_89[30];	// @[util.scala:466:20]
        uops_7_ctrl_is_std = _RANDOM_89[31];	// @[util.scala:466:20]
        uops_7_iw_state = _RANDOM_90[1:0];	// @[util.scala:466:20]
        uops_7_iw_p1_poisoned = _RANDOM_90[2];	// @[util.scala:466:20]
        uops_7_iw_p2_poisoned = _RANDOM_90[3];	// @[util.scala:466:20]
        uops_7_is_br = _RANDOM_90[4];	// @[util.scala:466:20]
        uops_7_is_jalr = _RANDOM_90[5];	// @[util.scala:466:20]
        uops_7_is_jal = _RANDOM_90[6];	// @[util.scala:466:20]
        uops_7_is_sfb = _RANDOM_90[7];	// @[util.scala:466:20]
        uops_7_br_mask = _RANDOM_90[15:8];	// @[util.scala:466:20]
        uops_7_br_tag = _RANDOM_90[18:16];	// @[util.scala:466:20]
        uops_7_ftq_idx = _RANDOM_90[22:19];	// @[util.scala:466:20]
        uops_7_edge_inst = _RANDOM_90[23];	// @[util.scala:466:20]
        uops_7_pc_lob = _RANDOM_90[29:24];	// @[util.scala:466:20]
        uops_7_taken = _RANDOM_90[30];	// @[util.scala:466:20]
        uops_7_imm_packed = {_RANDOM_90[31], _RANDOM_91[18:0]};	// @[util.scala:466:20]
        uops_7_csr_addr = _RANDOM_91[30:19];	// @[util.scala:466:20]
        uops_7_rob_idx = {_RANDOM_91[31], _RANDOM_92[3:0]};	// @[util.scala:466:20]
        uops_7_ldq_idx = _RANDOM_92[6:4];	// @[util.scala:466:20]
        uops_7_stq_idx = _RANDOM_92[9:7];	// @[util.scala:466:20]
        uops_7_rxq_idx = _RANDOM_92[11:10];	// @[util.scala:466:20]
        uops_7_pdst = _RANDOM_92[17:12];	// @[util.scala:466:20]
        uops_7_prs1 = _RANDOM_92[23:18];	// @[util.scala:466:20]
        uops_7_prs2 = _RANDOM_92[29:24];	// @[util.scala:466:20]
        uops_7_prs3 = {_RANDOM_92[31:30], _RANDOM_93[3:0]};	// @[util.scala:466:20]
        uops_7_ppred = _RANDOM_93[7:4];	// @[util.scala:466:20]
        uops_7_prs1_busy = _RANDOM_93[8];	// @[util.scala:466:20]
        uops_7_prs2_busy = _RANDOM_93[9];	// @[util.scala:466:20]
        uops_7_prs3_busy = _RANDOM_93[10];	// @[util.scala:466:20]
        uops_7_ppred_busy = _RANDOM_93[11];	// @[util.scala:466:20]
        uops_7_stale_pdst = _RANDOM_93[17:12];	// @[util.scala:466:20]
        uops_7_exception = _RANDOM_93[18];	// @[util.scala:466:20]
        uops_7_exc_cause = {_RANDOM_93[31:19], _RANDOM_94, _RANDOM_95[18:0]};	// @[util.scala:466:20]
        uops_7_bypassable = _RANDOM_95[19];	// @[util.scala:466:20]
        uops_7_mem_cmd = _RANDOM_95[24:20];	// @[util.scala:466:20]
        uops_7_mem_size = _RANDOM_95[26:25];	// @[util.scala:466:20]
        uops_7_mem_signed = _RANDOM_95[27];	// @[util.scala:466:20]
        uops_7_is_fence = _RANDOM_95[28];	// @[util.scala:466:20]
        uops_7_is_fencei = _RANDOM_95[29];	// @[util.scala:466:20]
        uops_7_is_amo = _RANDOM_95[30];	// @[util.scala:466:20]
        uops_7_uses_ldq = _RANDOM_95[31];	// @[util.scala:466:20]
        uops_7_uses_stq = _RANDOM_96[0];	// @[util.scala:466:20]
        uops_7_is_sys_pc2epc = _RANDOM_96[1];	// @[util.scala:466:20]
        uops_7_is_unique = _RANDOM_96[2];	// @[util.scala:466:20]
        uops_7_flush_on_commit = _RANDOM_96[3];	// @[util.scala:466:20]
        uops_7_ldst_is_rs1 = _RANDOM_96[4];	// @[util.scala:466:20]
        uops_7_ldst = _RANDOM_96[10:5];	// @[util.scala:466:20]
        uops_7_lrs1 = _RANDOM_96[16:11];	// @[util.scala:466:20]
        uops_7_lrs2 = _RANDOM_96[22:17];	// @[util.scala:466:20]
        uops_7_lrs3 = _RANDOM_96[28:23];	// @[util.scala:466:20]
        uops_7_ldst_val = _RANDOM_96[29];	// @[util.scala:466:20]
        uops_7_dst_rtype = _RANDOM_96[31:30];	// @[util.scala:466:20]
        uops_7_lrs1_rtype = _RANDOM_97[1:0];	// @[util.scala:466:20]
        uops_7_lrs2_rtype = _RANDOM_97[3:2];	// @[util.scala:466:20]
        uops_7_frs3_en = _RANDOM_97[4];	// @[util.scala:466:20]
        uops_7_fp_val = _RANDOM_97[5];	// @[util.scala:466:20]
        uops_7_fp_single = _RANDOM_97[6];	// @[util.scala:466:20]
        uops_7_xcpt_pf_if = _RANDOM_97[7];	// @[util.scala:466:20]
        uops_7_xcpt_ae_if = _RANDOM_97[8];	// @[util.scala:466:20]
        uops_7_xcpt_ma_if = _RANDOM_97[9];	// @[util.scala:466:20]
        uops_7_bp_debug_if = _RANDOM_97[10];	// @[util.scala:466:20]
        uops_7_bp_xcpt_if = _RANDOM_97[11];	// @[util.scala:466:20]
        uops_7_debug_fsrc = _RANDOM_97[13:12];	// @[util.scala:466:20]
        uops_7_debug_tsrc = _RANDOM_97[15:14];	// @[util.scala:466:20]
        uops_8_uopc = _RANDOM_97[22:16];	// @[util.scala:466:20]
        uops_8_inst = {_RANDOM_97[31:23], _RANDOM_98[22:0]};	// @[util.scala:466:20]
        uops_8_debug_inst = {_RANDOM_98[31:23], _RANDOM_99[22:0]};	// @[util.scala:466:20]
        uops_8_is_rvc = _RANDOM_99[23];	// @[util.scala:466:20]
        uops_8_debug_pc = {_RANDOM_99[31:24], _RANDOM_100};	// @[util.scala:466:20]
        uops_8_iq_type = _RANDOM_101[2:0];	// @[util.scala:466:20]
        uops_8_fu_code = _RANDOM_101[12:3];	// @[util.scala:466:20]
        uops_8_ctrl_br_type = _RANDOM_101[16:13];	// @[util.scala:466:20]
        uops_8_ctrl_op1_sel = _RANDOM_101[18:17];	// @[util.scala:466:20]
        uops_8_ctrl_op2_sel = _RANDOM_101[21:19];	// @[util.scala:466:20]
        uops_8_ctrl_imm_sel = _RANDOM_101[24:22];	// @[util.scala:466:20]
        uops_8_ctrl_op_fcn = _RANDOM_101[28:25];	// @[util.scala:466:20]
        uops_8_ctrl_fcn_dw = _RANDOM_101[29];	// @[util.scala:466:20]
        uops_8_ctrl_csr_cmd = {_RANDOM_101[31:30], _RANDOM_102[0]};	// @[util.scala:466:20]
        uops_8_ctrl_is_load = _RANDOM_102[1];	// @[util.scala:466:20]
        uops_8_ctrl_is_sta = _RANDOM_102[2];	// @[util.scala:466:20]
        uops_8_ctrl_is_std = _RANDOM_102[3];	// @[util.scala:466:20]
        uops_8_iw_state = _RANDOM_102[5:4];	// @[util.scala:466:20]
        uops_8_iw_p1_poisoned = _RANDOM_102[6];	// @[util.scala:466:20]
        uops_8_iw_p2_poisoned = _RANDOM_102[7];	// @[util.scala:466:20]
        uops_8_is_br = _RANDOM_102[8];	// @[util.scala:466:20]
        uops_8_is_jalr = _RANDOM_102[9];	// @[util.scala:466:20]
        uops_8_is_jal = _RANDOM_102[10];	// @[util.scala:466:20]
        uops_8_is_sfb = _RANDOM_102[11];	// @[util.scala:466:20]
        uops_8_br_mask = _RANDOM_102[19:12];	// @[util.scala:466:20]
        uops_8_br_tag = _RANDOM_102[22:20];	// @[util.scala:466:20]
        uops_8_ftq_idx = _RANDOM_102[26:23];	// @[util.scala:466:20]
        uops_8_edge_inst = _RANDOM_102[27];	// @[util.scala:466:20]
        uops_8_pc_lob = {_RANDOM_102[31:28], _RANDOM_103[1:0]};	// @[util.scala:466:20]
        uops_8_taken = _RANDOM_103[2];	// @[util.scala:466:20]
        uops_8_imm_packed = _RANDOM_103[22:3];	// @[util.scala:466:20]
        uops_8_csr_addr = {_RANDOM_103[31:23], _RANDOM_104[2:0]};	// @[util.scala:466:20]
        uops_8_rob_idx = _RANDOM_104[7:3];	// @[util.scala:466:20]
        uops_8_ldq_idx = _RANDOM_104[10:8];	// @[util.scala:466:20]
        uops_8_stq_idx = _RANDOM_104[13:11];	// @[util.scala:466:20]
        uops_8_rxq_idx = _RANDOM_104[15:14];	// @[util.scala:466:20]
        uops_8_pdst = _RANDOM_104[21:16];	// @[util.scala:466:20]
        uops_8_prs1 = _RANDOM_104[27:22];	// @[util.scala:466:20]
        uops_8_prs2 = {_RANDOM_104[31:28], _RANDOM_105[1:0]};	// @[util.scala:466:20]
        uops_8_prs3 = _RANDOM_105[7:2];	// @[util.scala:466:20]
        uops_8_ppred = _RANDOM_105[11:8];	// @[util.scala:466:20]
        uops_8_prs1_busy = _RANDOM_105[12];	// @[util.scala:466:20]
        uops_8_prs2_busy = _RANDOM_105[13];	// @[util.scala:466:20]
        uops_8_prs3_busy = _RANDOM_105[14];	// @[util.scala:466:20]
        uops_8_ppred_busy = _RANDOM_105[15];	// @[util.scala:466:20]
        uops_8_stale_pdst = _RANDOM_105[21:16];	// @[util.scala:466:20]
        uops_8_exception = _RANDOM_105[22];	// @[util.scala:466:20]
        uops_8_exc_cause = {_RANDOM_105[31:23], _RANDOM_106, _RANDOM_107[22:0]};	// @[util.scala:466:20]
        uops_8_bypassable = _RANDOM_107[23];	// @[util.scala:466:20]
        uops_8_mem_cmd = _RANDOM_107[28:24];	// @[util.scala:466:20]
        uops_8_mem_size = _RANDOM_107[30:29];	// @[util.scala:466:20]
        uops_8_mem_signed = _RANDOM_107[31];	// @[util.scala:466:20]
        uops_8_is_fence = _RANDOM_108[0];	// @[util.scala:466:20]
        uops_8_is_fencei = _RANDOM_108[1];	// @[util.scala:466:20]
        uops_8_is_amo = _RANDOM_108[2];	// @[util.scala:466:20]
        uops_8_uses_ldq = _RANDOM_108[3];	// @[util.scala:466:20]
        uops_8_uses_stq = _RANDOM_108[4];	// @[util.scala:466:20]
        uops_8_is_sys_pc2epc = _RANDOM_108[5];	// @[util.scala:466:20]
        uops_8_is_unique = _RANDOM_108[6];	// @[util.scala:466:20]
        uops_8_flush_on_commit = _RANDOM_108[7];	// @[util.scala:466:20]
        uops_8_ldst_is_rs1 = _RANDOM_108[8];	// @[util.scala:466:20]
        uops_8_ldst = _RANDOM_108[14:9];	// @[util.scala:466:20]
        uops_8_lrs1 = _RANDOM_108[20:15];	// @[util.scala:466:20]
        uops_8_lrs2 = _RANDOM_108[26:21];	// @[util.scala:466:20]
        uops_8_lrs3 = {_RANDOM_108[31:27], _RANDOM_109[0]};	// @[util.scala:466:20]
        uops_8_ldst_val = _RANDOM_109[1];	// @[util.scala:466:20]
        uops_8_dst_rtype = _RANDOM_109[3:2];	// @[util.scala:466:20]
        uops_8_lrs1_rtype = _RANDOM_109[5:4];	// @[util.scala:466:20]
        uops_8_lrs2_rtype = _RANDOM_109[7:6];	// @[util.scala:466:20]
        uops_8_frs3_en = _RANDOM_109[8];	// @[util.scala:466:20]
        uops_8_fp_val = _RANDOM_109[9];	// @[util.scala:466:20]
        uops_8_fp_single = _RANDOM_109[10];	// @[util.scala:466:20]
        uops_8_xcpt_pf_if = _RANDOM_109[11];	// @[util.scala:466:20]
        uops_8_xcpt_ae_if = _RANDOM_109[12];	// @[util.scala:466:20]
        uops_8_xcpt_ma_if = _RANDOM_109[13];	// @[util.scala:466:20]
        uops_8_bp_debug_if = _RANDOM_109[14];	// @[util.scala:466:20]
        uops_8_bp_xcpt_if = _RANDOM_109[15];	// @[util.scala:466:20]
        uops_8_debug_fsrc = _RANDOM_109[17:16];	// @[util.scala:466:20]
        uops_8_debug_tsrc = _RANDOM_109[19:18];	// @[util.scala:466:20]
        uops_9_uopc = _RANDOM_109[26:20];	// @[util.scala:466:20]
        uops_9_inst = {_RANDOM_109[31:27], _RANDOM_110[26:0]};	// @[util.scala:466:20]
        uops_9_debug_inst = {_RANDOM_110[31:27], _RANDOM_111[26:0]};	// @[util.scala:466:20]
        uops_9_is_rvc = _RANDOM_111[27];	// @[util.scala:466:20]
        uops_9_debug_pc = {_RANDOM_111[31:28], _RANDOM_112, _RANDOM_113[3:0]};	// @[util.scala:466:20]
        uops_9_iq_type = _RANDOM_113[6:4];	// @[util.scala:466:20]
        uops_9_fu_code = _RANDOM_113[16:7];	// @[util.scala:466:20]
        uops_9_ctrl_br_type = _RANDOM_113[20:17];	// @[util.scala:466:20]
        uops_9_ctrl_op1_sel = _RANDOM_113[22:21];	// @[util.scala:466:20]
        uops_9_ctrl_op2_sel = _RANDOM_113[25:23];	// @[util.scala:466:20]
        uops_9_ctrl_imm_sel = _RANDOM_113[28:26];	// @[util.scala:466:20]
        uops_9_ctrl_op_fcn = {_RANDOM_113[31:29], _RANDOM_114[0]};	// @[util.scala:466:20]
        uops_9_ctrl_fcn_dw = _RANDOM_114[1];	// @[util.scala:466:20]
        uops_9_ctrl_csr_cmd = _RANDOM_114[4:2];	// @[util.scala:466:20]
        uops_9_ctrl_is_load = _RANDOM_114[5];	// @[util.scala:466:20]
        uops_9_ctrl_is_sta = _RANDOM_114[6];	// @[util.scala:466:20]
        uops_9_ctrl_is_std = _RANDOM_114[7];	// @[util.scala:466:20]
        uops_9_iw_state = _RANDOM_114[9:8];	// @[util.scala:466:20]
        uops_9_iw_p1_poisoned = _RANDOM_114[10];	// @[util.scala:466:20]
        uops_9_iw_p2_poisoned = _RANDOM_114[11];	// @[util.scala:466:20]
        uops_9_is_br = _RANDOM_114[12];	// @[util.scala:466:20]
        uops_9_is_jalr = _RANDOM_114[13];	// @[util.scala:466:20]
        uops_9_is_jal = _RANDOM_114[14];	// @[util.scala:466:20]
        uops_9_is_sfb = _RANDOM_114[15];	// @[util.scala:466:20]
        uops_9_br_mask = _RANDOM_114[23:16];	// @[util.scala:466:20]
        uops_9_br_tag = _RANDOM_114[26:24];	// @[util.scala:466:20]
        uops_9_ftq_idx = _RANDOM_114[30:27];	// @[util.scala:466:20]
        uops_9_edge_inst = _RANDOM_114[31];	// @[util.scala:466:20]
        uops_9_pc_lob = _RANDOM_115[5:0];	// @[util.scala:466:20]
        uops_9_taken = _RANDOM_115[6];	// @[util.scala:466:20]
        uops_9_imm_packed = _RANDOM_115[26:7];	// @[util.scala:466:20]
        uops_9_csr_addr = {_RANDOM_115[31:27], _RANDOM_116[6:0]};	// @[util.scala:466:20]
        uops_9_rob_idx = _RANDOM_116[11:7];	// @[util.scala:466:20]
        uops_9_ldq_idx = _RANDOM_116[14:12];	// @[util.scala:466:20]
        uops_9_stq_idx = _RANDOM_116[17:15];	// @[util.scala:466:20]
        uops_9_rxq_idx = _RANDOM_116[19:18];	// @[util.scala:466:20]
        uops_9_pdst = _RANDOM_116[25:20];	// @[util.scala:466:20]
        uops_9_prs1 = _RANDOM_116[31:26];	// @[util.scala:466:20]
        uops_9_prs2 = _RANDOM_117[5:0];	// @[util.scala:466:20]
        uops_9_prs3 = _RANDOM_117[11:6];	// @[util.scala:466:20]
        uops_9_ppred = _RANDOM_117[15:12];	// @[util.scala:466:20]
        uops_9_prs1_busy = _RANDOM_117[16];	// @[util.scala:466:20]
        uops_9_prs2_busy = _RANDOM_117[17];	// @[util.scala:466:20]
        uops_9_prs3_busy = _RANDOM_117[18];	// @[util.scala:466:20]
        uops_9_ppred_busy = _RANDOM_117[19];	// @[util.scala:466:20]
        uops_9_stale_pdst = _RANDOM_117[25:20];	// @[util.scala:466:20]
        uops_9_exception = _RANDOM_117[26];	// @[util.scala:466:20]
        uops_9_exc_cause = {_RANDOM_117[31:27], _RANDOM_118, _RANDOM_119[26:0]};	// @[util.scala:466:20]
        uops_9_bypassable = _RANDOM_119[27];	// @[util.scala:466:20]
        uops_9_mem_cmd = {_RANDOM_119[31:28], _RANDOM_120[0]};	// @[util.scala:466:20]
        uops_9_mem_size = _RANDOM_120[2:1];	// @[util.scala:466:20]
        uops_9_mem_signed = _RANDOM_120[3];	// @[util.scala:466:20]
        uops_9_is_fence = _RANDOM_120[4];	// @[util.scala:466:20]
        uops_9_is_fencei = _RANDOM_120[5];	// @[util.scala:466:20]
        uops_9_is_amo = _RANDOM_120[6];	// @[util.scala:466:20]
        uops_9_uses_ldq = _RANDOM_120[7];	// @[util.scala:466:20]
        uops_9_uses_stq = _RANDOM_120[8];	// @[util.scala:466:20]
        uops_9_is_sys_pc2epc = _RANDOM_120[9];	// @[util.scala:466:20]
        uops_9_is_unique = _RANDOM_120[10];	// @[util.scala:466:20]
        uops_9_flush_on_commit = _RANDOM_120[11];	// @[util.scala:466:20]
        uops_9_ldst_is_rs1 = _RANDOM_120[12];	// @[util.scala:466:20]
        uops_9_ldst = _RANDOM_120[18:13];	// @[util.scala:466:20]
        uops_9_lrs1 = _RANDOM_120[24:19];	// @[util.scala:466:20]
        uops_9_lrs2 = _RANDOM_120[30:25];	// @[util.scala:466:20]
        uops_9_lrs3 = {_RANDOM_120[31], _RANDOM_121[4:0]};	// @[util.scala:466:20]
        uops_9_ldst_val = _RANDOM_121[5];	// @[util.scala:466:20]
        uops_9_dst_rtype = _RANDOM_121[7:6];	// @[util.scala:466:20]
        uops_9_lrs1_rtype = _RANDOM_121[9:8];	// @[util.scala:466:20]
        uops_9_lrs2_rtype = _RANDOM_121[11:10];	// @[util.scala:466:20]
        uops_9_frs3_en = _RANDOM_121[12];	// @[util.scala:466:20]
        uops_9_fp_val = _RANDOM_121[13];	// @[util.scala:466:20]
        uops_9_fp_single = _RANDOM_121[14];	// @[util.scala:466:20]
        uops_9_xcpt_pf_if = _RANDOM_121[15];	// @[util.scala:466:20]
        uops_9_xcpt_ae_if = _RANDOM_121[16];	// @[util.scala:466:20]
        uops_9_xcpt_ma_if = _RANDOM_121[17];	// @[util.scala:466:20]
        uops_9_bp_debug_if = _RANDOM_121[18];	// @[util.scala:466:20]
        uops_9_bp_xcpt_if = _RANDOM_121[19];	// @[util.scala:466:20]
        uops_9_debug_fsrc = _RANDOM_121[21:20];	// @[util.scala:466:20]
        uops_9_debug_tsrc = _RANDOM_121[23:22];	// @[util.scala:466:20]
        uops_10_uopc = _RANDOM_121[30:24];	// @[util.scala:466:20]
        uops_10_inst = {_RANDOM_121[31], _RANDOM_122[30:0]};	// @[util.scala:466:20]
        uops_10_debug_inst = {_RANDOM_122[31], _RANDOM_123[30:0]};	// @[util.scala:466:20]
        uops_10_is_rvc = _RANDOM_123[31];	// @[util.scala:466:20]
        uops_10_debug_pc = {_RANDOM_124, _RANDOM_125[7:0]};	// @[util.scala:466:20]
        uops_10_iq_type = _RANDOM_125[10:8];	// @[util.scala:466:20]
        uops_10_fu_code = _RANDOM_125[20:11];	// @[util.scala:466:20]
        uops_10_ctrl_br_type = _RANDOM_125[24:21];	// @[util.scala:466:20]
        uops_10_ctrl_op1_sel = _RANDOM_125[26:25];	// @[util.scala:466:20]
        uops_10_ctrl_op2_sel = _RANDOM_125[29:27];	// @[util.scala:466:20]
        uops_10_ctrl_imm_sel = {_RANDOM_125[31:30], _RANDOM_126[0]};	// @[util.scala:466:20]
        uops_10_ctrl_op_fcn = _RANDOM_126[4:1];	// @[util.scala:466:20]
        uops_10_ctrl_fcn_dw = _RANDOM_126[5];	// @[util.scala:466:20]
        uops_10_ctrl_csr_cmd = _RANDOM_126[8:6];	// @[util.scala:466:20]
        uops_10_ctrl_is_load = _RANDOM_126[9];	// @[util.scala:466:20]
        uops_10_ctrl_is_sta = _RANDOM_126[10];	// @[util.scala:466:20]
        uops_10_ctrl_is_std = _RANDOM_126[11];	// @[util.scala:466:20]
        uops_10_iw_state = _RANDOM_126[13:12];	// @[util.scala:466:20]
        uops_10_iw_p1_poisoned = _RANDOM_126[14];	// @[util.scala:466:20]
        uops_10_iw_p2_poisoned = _RANDOM_126[15];	// @[util.scala:466:20]
        uops_10_is_br = _RANDOM_126[16];	// @[util.scala:466:20]
        uops_10_is_jalr = _RANDOM_126[17];	// @[util.scala:466:20]
        uops_10_is_jal = _RANDOM_126[18];	// @[util.scala:466:20]
        uops_10_is_sfb = _RANDOM_126[19];	// @[util.scala:466:20]
        uops_10_br_mask = _RANDOM_126[27:20];	// @[util.scala:466:20]
        uops_10_br_tag = _RANDOM_126[30:28];	// @[util.scala:466:20]
        uops_10_ftq_idx = {_RANDOM_126[31], _RANDOM_127[2:0]};	// @[util.scala:466:20]
        uops_10_edge_inst = _RANDOM_127[3];	// @[util.scala:466:20]
        uops_10_pc_lob = _RANDOM_127[9:4];	// @[util.scala:466:20]
        uops_10_taken = _RANDOM_127[10];	// @[util.scala:466:20]
        uops_10_imm_packed = _RANDOM_127[30:11];	// @[util.scala:466:20]
        uops_10_csr_addr = {_RANDOM_127[31], _RANDOM_128[10:0]};	// @[util.scala:466:20]
        uops_10_rob_idx = _RANDOM_128[15:11];	// @[util.scala:466:20]
        uops_10_ldq_idx = _RANDOM_128[18:16];	// @[util.scala:466:20]
        uops_10_stq_idx = _RANDOM_128[21:19];	// @[util.scala:466:20]
        uops_10_rxq_idx = _RANDOM_128[23:22];	// @[util.scala:466:20]
        uops_10_pdst = _RANDOM_128[29:24];	// @[util.scala:466:20]
        uops_10_prs1 = {_RANDOM_128[31:30], _RANDOM_129[3:0]};	// @[util.scala:466:20]
        uops_10_prs2 = _RANDOM_129[9:4];	// @[util.scala:466:20]
        uops_10_prs3 = _RANDOM_129[15:10];	// @[util.scala:466:20]
        uops_10_ppred = _RANDOM_129[19:16];	// @[util.scala:466:20]
        uops_10_prs1_busy = _RANDOM_129[20];	// @[util.scala:466:20]
        uops_10_prs2_busy = _RANDOM_129[21];	// @[util.scala:466:20]
        uops_10_prs3_busy = _RANDOM_129[22];	// @[util.scala:466:20]
        uops_10_ppred_busy = _RANDOM_129[23];	// @[util.scala:466:20]
        uops_10_stale_pdst = _RANDOM_129[29:24];	// @[util.scala:466:20]
        uops_10_exception = _RANDOM_129[30];	// @[util.scala:466:20]
        uops_10_exc_cause = {_RANDOM_129[31], _RANDOM_130, _RANDOM_131[30:0]};	// @[util.scala:466:20]
        uops_10_bypassable = _RANDOM_131[31];	// @[util.scala:466:20]
        uops_10_mem_cmd = _RANDOM_132[4:0];	// @[util.scala:466:20]
        uops_10_mem_size = _RANDOM_132[6:5];	// @[util.scala:466:20]
        uops_10_mem_signed = _RANDOM_132[7];	// @[util.scala:466:20]
        uops_10_is_fence = _RANDOM_132[8];	// @[util.scala:466:20]
        uops_10_is_fencei = _RANDOM_132[9];	// @[util.scala:466:20]
        uops_10_is_amo = _RANDOM_132[10];	// @[util.scala:466:20]
        uops_10_uses_ldq = _RANDOM_132[11];	// @[util.scala:466:20]
        uops_10_uses_stq = _RANDOM_132[12];	// @[util.scala:466:20]
        uops_10_is_sys_pc2epc = _RANDOM_132[13];	// @[util.scala:466:20]
        uops_10_is_unique = _RANDOM_132[14];	// @[util.scala:466:20]
        uops_10_flush_on_commit = _RANDOM_132[15];	// @[util.scala:466:20]
        uops_10_ldst_is_rs1 = _RANDOM_132[16];	// @[util.scala:466:20]
        uops_10_ldst = _RANDOM_132[22:17];	// @[util.scala:466:20]
        uops_10_lrs1 = _RANDOM_132[28:23];	// @[util.scala:466:20]
        uops_10_lrs2 = {_RANDOM_132[31:29], _RANDOM_133[2:0]};	// @[util.scala:466:20]
        uops_10_lrs3 = _RANDOM_133[8:3];	// @[util.scala:466:20]
        uops_10_ldst_val = _RANDOM_133[9];	// @[util.scala:466:20]
        uops_10_dst_rtype = _RANDOM_133[11:10];	// @[util.scala:466:20]
        uops_10_lrs1_rtype = _RANDOM_133[13:12];	// @[util.scala:466:20]
        uops_10_lrs2_rtype = _RANDOM_133[15:14];	// @[util.scala:466:20]
        uops_10_frs3_en = _RANDOM_133[16];	// @[util.scala:466:20]
        uops_10_fp_val = _RANDOM_133[17];	// @[util.scala:466:20]
        uops_10_fp_single = _RANDOM_133[18];	// @[util.scala:466:20]
        uops_10_xcpt_pf_if = _RANDOM_133[19];	// @[util.scala:466:20]
        uops_10_xcpt_ae_if = _RANDOM_133[20];	// @[util.scala:466:20]
        uops_10_xcpt_ma_if = _RANDOM_133[21];	// @[util.scala:466:20]
        uops_10_bp_debug_if = _RANDOM_133[22];	// @[util.scala:466:20]
        uops_10_bp_xcpt_if = _RANDOM_133[23];	// @[util.scala:466:20]
        uops_10_debug_fsrc = _RANDOM_133[25:24];	// @[util.scala:466:20]
        uops_10_debug_tsrc = _RANDOM_133[27:26];	// @[util.scala:466:20]
        uops_11_uopc = {_RANDOM_133[31:28], _RANDOM_134[2:0]};	// @[util.scala:466:20]
        uops_11_inst = {_RANDOM_134[31:3], _RANDOM_135[2:0]};	// @[util.scala:466:20]
        uops_11_debug_inst = {_RANDOM_135[31:3], _RANDOM_136[2:0]};	// @[util.scala:466:20]
        uops_11_is_rvc = _RANDOM_136[3];	// @[util.scala:466:20]
        uops_11_debug_pc = {_RANDOM_136[31:4], _RANDOM_137[11:0]};	// @[util.scala:466:20]
        uops_11_iq_type = _RANDOM_137[14:12];	// @[util.scala:466:20]
        uops_11_fu_code = _RANDOM_137[24:15];	// @[util.scala:466:20]
        uops_11_ctrl_br_type = _RANDOM_137[28:25];	// @[util.scala:466:20]
        uops_11_ctrl_op1_sel = _RANDOM_137[30:29];	// @[util.scala:466:20]
        uops_11_ctrl_op2_sel = {_RANDOM_137[31], _RANDOM_138[1:0]};	// @[util.scala:466:20]
        uops_11_ctrl_imm_sel = _RANDOM_138[4:2];	// @[util.scala:466:20]
        uops_11_ctrl_op_fcn = _RANDOM_138[8:5];	// @[util.scala:466:20]
        uops_11_ctrl_fcn_dw = _RANDOM_138[9];	// @[util.scala:466:20]
        uops_11_ctrl_csr_cmd = _RANDOM_138[12:10];	// @[util.scala:466:20]
        uops_11_ctrl_is_load = _RANDOM_138[13];	// @[util.scala:466:20]
        uops_11_ctrl_is_sta = _RANDOM_138[14];	// @[util.scala:466:20]
        uops_11_ctrl_is_std = _RANDOM_138[15];	// @[util.scala:466:20]
        uops_11_iw_state = _RANDOM_138[17:16];	// @[util.scala:466:20]
        uops_11_iw_p1_poisoned = _RANDOM_138[18];	// @[util.scala:466:20]
        uops_11_iw_p2_poisoned = _RANDOM_138[19];	// @[util.scala:466:20]
        uops_11_is_br = _RANDOM_138[20];	// @[util.scala:466:20]
        uops_11_is_jalr = _RANDOM_138[21];	// @[util.scala:466:20]
        uops_11_is_jal = _RANDOM_138[22];	// @[util.scala:466:20]
        uops_11_is_sfb = _RANDOM_138[23];	// @[util.scala:466:20]
        uops_11_br_mask = _RANDOM_138[31:24];	// @[util.scala:466:20]
        uops_11_br_tag = _RANDOM_139[2:0];	// @[util.scala:466:20]
        uops_11_ftq_idx = _RANDOM_139[6:3];	// @[util.scala:466:20]
        uops_11_edge_inst = _RANDOM_139[7];	// @[util.scala:466:20]
        uops_11_pc_lob = _RANDOM_139[13:8];	// @[util.scala:466:20]
        uops_11_taken = _RANDOM_139[14];	// @[util.scala:466:20]
        uops_11_imm_packed = {_RANDOM_139[31:15], _RANDOM_140[2:0]};	// @[util.scala:466:20]
        uops_11_csr_addr = _RANDOM_140[14:3];	// @[util.scala:466:20]
        uops_11_rob_idx = _RANDOM_140[19:15];	// @[util.scala:466:20]
        uops_11_ldq_idx = _RANDOM_140[22:20];	// @[util.scala:466:20]
        uops_11_stq_idx = _RANDOM_140[25:23];	// @[util.scala:466:20]
        uops_11_rxq_idx = _RANDOM_140[27:26];	// @[util.scala:466:20]
        uops_11_pdst = {_RANDOM_140[31:28], _RANDOM_141[1:0]};	// @[util.scala:466:20]
        uops_11_prs1 = _RANDOM_141[7:2];	// @[util.scala:466:20]
        uops_11_prs2 = _RANDOM_141[13:8];	// @[util.scala:466:20]
        uops_11_prs3 = _RANDOM_141[19:14];	// @[util.scala:466:20]
        uops_11_ppred = _RANDOM_141[23:20];	// @[util.scala:466:20]
        uops_11_prs1_busy = _RANDOM_141[24];	// @[util.scala:466:20]
        uops_11_prs2_busy = _RANDOM_141[25];	// @[util.scala:466:20]
        uops_11_prs3_busy = _RANDOM_141[26];	// @[util.scala:466:20]
        uops_11_ppred_busy = _RANDOM_141[27];	// @[util.scala:466:20]
        uops_11_stale_pdst = {_RANDOM_141[31:28], _RANDOM_142[1:0]};	// @[util.scala:466:20]
        uops_11_exception = _RANDOM_142[2];	// @[util.scala:466:20]
        uops_11_exc_cause = {_RANDOM_142[31:3], _RANDOM_143, _RANDOM_144[2:0]};	// @[util.scala:466:20]
        uops_11_bypassable = _RANDOM_144[3];	// @[util.scala:466:20]
        uops_11_mem_cmd = _RANDOM_144[8:4];	// @[util.scala:466:20]
        uops_11_mem_size = _RANDOM_144[10:9];	// @[util.scala:466:20]
        uops_11_mem_signed = _RANDOM_144[11];	// @[util.scala:466:20]
        uops_11_is_fence = _RANDOM_144[12];	// @[util.scala:466:20]
        uops_11_is_fencei = _RANDOM_144[13];	// @[util.scala:466:20]
        uops_11_is_amo = _RANDOM_144[14];	// @[util.scala:466:20]
        uops_11_uses_ldq = _RANDOM_144[15];	// @[util.scala:466:20]
        uops_11_uses_stq = _RANDOM_144[16];	// @[util.scala:466:20]
        uops_11_is_sys_pc2epc = _RANDOM_144[17];	// @[util.scala:466:20]
        uops_11_is_unique = _RANDOM_144[18];	// @[util.scala:466:20]
        uops_11_flush_on_commit = _RANDOM_144[19];	// @[util.scala:466:20]
        uops_11_ldst_is_rs1 = _RANDOM_144[20];	// @[util.scala:466:20]
        uops_11_ldst = _RANDOM_144[26:21];	// @[util.scala:466:20]
        uops_11_lrs1 = {_RANDOM_144[31:27], _RANDOM_145[0]};	// @[util.scala:466:20]
        uops_11_lrs2 = _RANDOM_145[6:1];	// @[util.scala:466:20]
        uops_11_lrs3 = _RANDOM_145[12:7];	// @[util.scala:466:20]
        uops_11_ldst_val = _RANDOM_145[13];	// @[util.scala:466:20]
        uops_11_dst_rtype = _RANDOM_145[15:14];	// @[util.scala:466:20]
        uops_11_lrs1_rtype = _RANDOM_145[17:16];	// @[util.scala:466:20]
        uops_11_lrs2_rtype = _RANDOM_145[19:18];	// @[util.scala:466:20]
        uops_11_frs3_en = _RANDOM_145[20];	// @[util.scala:466:20]
        uops_11_fp_val = _RANDOM_145[21];	// @[util.scala:466:20]
        uops_11_fp_single = _RANDOM_145[22];	// @[util.scala:466:20]
        uops_11_xcpt_pf_if = _RANDOM_145[23];	// @[util.scala:466:20]
        uops_11_xcpt_ae_if = _RANDOM_145[24];	// @[util.scala:466:20]
        uops_11_xcpt_ma_if = _RANDOM_145[25];	// @[util.scala:466:20]
        uops_11_bp_debug_if = _RANDOM_145[26];	// @[util.scala:466:20]
        uops_11_bp_xcpt_if = _RANDOM_145[27];	// @[util.scala:466:20]
        uops_11_debug_fsrc = _RANDOM_145[29:28];	// @[util.scala:466:20]
        uops_11_debug_tsrc = _RANDOM_145[31:30];	// @[util.scala:466:20]
        uops_12_uopc = _RANDOM_146[6:0];	// @[util.scala:466:20]
        uops_12_inst = {_RANDOM_146[31:7], _RANDOM_147[6:0]};	// @[util.scala:466:20]
        uops_12_debug_inst = {_RANDOM_147[31:7], _RANDOM_148[6:0]};	// @[util.scala:466:20]
        uops_12_is_rvc = _RANDOM_148[7];	// @[util.scala:466:20]
        uops_12_debug_pc = {_RANDOM_148[31:8], _RANDOM_149[15:0]};	// @[util.scala:466:20]
        uops_12_iq_type = _RANDOM_149[18:16];	// @[util.scala:466:20]
        uops_12_fu_code = _RANDOM_149[28:19];	// @[util.scala:466:20]
        uops_12_ctrl_br_type = {_RANDOM_149[31:29], _RANDOM_150[0]};	// @[util.scala:466:20]
        uops_12_ctrl_op1_sel = _RANDOM_150[2:1];	// @[util.scala:466:20]
        uops_12_ctrl_op2_sel = _RANDOM_150[5:3];	// @[util.scala:466:20]
        uops_12_ctrl_imm_sel = _RANDOM_150[8:6];	// @[util.scala:466:20]
        uops_12_ctrl_op_fcn = _RANDOM_150[12:9];	// @[util.scala:466:20]
        uops_12_ctrl_fcn_dw = _RANDOM_150[13];	// @[util.scala:466:20]
        uops_12_ctrl_csr_cmd = _RANDOM_150[16:14];	// @[util.scala:466:20]
        uops_12_ctrl_is_load = _RANDOM_150[17];	// @[util.scala:466:20]
        uops_12_ctrl_is_sta = _RANDOM_150[18];	// @[util.scala:466:20]
        uops_12_ctrl_is_std = _RANDOM_150[19];	// @[util.scala:466:20]
        uops_12_iw_state = _RANDOM_150[21:20];	// @[util.scala:466:20]
        uops_12_iw_p1_poisoned = _RANDOM_150[22];	// @[util.scala:466:20]
        uops_12_iw_p2_poisoned = _RANDOM_150[23];	// @[util.scala:466:20]
        uops_12_is_br = _RANDOM_150[24];	// @[util.scala:466:20]
        uops_12_is_jalr = _RANDOM_150[25];	// @[util.scala:466:20]
        uops_12_is_jal = _RANDOM_150[26];	// @[util.scala:466:20]
        uops_12_is_sfb = _RANDOM_150[27];	// @[util.scala:466:20]
        uops_12_br_mask = {_RANDOM_150[31:28], _RANDOM_151[3:0]};	// @[util.scala:466:20]
        uops_12_br_tag = _RANDOM_151[6:4];	// @[util.scala:466:20]
        uops_12_ftq_idx = _RANDOM_151[10:7];	// @[util.scala:466:20]
        uops_12_edge_inst = _RANDOM_151[11];	// @[util.scala:466:20]
        uops_12_pc_lob = _RANDOM_151[17:12];	// @[util.scala:466:20]
        uops_12_taken = _RANDOM_151[18];	// @[util.scala:466:20]
        uops_12_imm_packed = {_RANDOM_151[31:19], _RANDOM_152[6:0]};	// @[util.scala:466:20]
        uops_12_csr_addr = _RANDOM_152[18:7];	// @[util.scala:466:20]
        uops_12_rob_idx = _RANDOM_152[23:19];	// @[util.scala:466:20]
        uops_12_ldq_idx = _RANDOM_152[26:24];	// @[util.scala:466:20]
        uops_12_stq_idx = _RANDOM_152[29:27];	// @[util.scala:466:20]
        uops_12_rxq_idx = _RANDOM_152[31:30];	// @[util.scala:466:20]
        uops_12_pdst = _RANDOM_153[5:0];	// @[util.scala:466:20]
        uops_12_prs1 = _RANDOM_153[11:6];	// @[util.scala:466:20]
        uops_12_prs2 = _RANDOM_153[17:12];	// @[util.scala:466:20]
        uops_12_prs3 = _RANDOM_153[23:18];	// @[util.scala:466:20]
        uops_12_ppred = _RANDOM_153[27:24];	// @[util.scala:466:20]
        uops_12_prs1_busy = _RANDOM_153[28];	// @[util.scala:466:20]
        uops_12_prs2_busy = _RANDOM_153[29];	// @[util.scala:466:20]
        uops_12_prs3_busy = _RANDOM_153[30];	// @[util.scala:466:20]
        uops_12_ppred_busy = _RANDOM_153[31];	// @[util.scala:466:20]
        uops_12_stale_pdst = _RANDOM_154[5:0];	// @[util.scala:466:20]
        uops_12_exception = _RANDOM_154[6];	// @[util.scala:466:20]
        uops_12_exc_cause = {_RANDOM_154[31:7], _RANDOM_155, _RANDOM_156[6:0]};	// @[util.scala:466:20]
        uops_12_bypassable = _RANDOM_156[7];	// @[util.scala:466:20]
        uops_12_mem_cmd = _RANDOM_156[12:8];	// @[util.scala:466:20]
        uops_12_mem_size = _RANDOM_156[14:13];	// @[util.scala:466:20]
        uops_12_mem_signed = _RANDOM_156[15];	// @[util.scala:466:20]
        uops_12_is_fence = _RANDOM_156[16];	// @[util.scala:466:20]
        uops_12_is_fencei = _RANDOM_156[17];	// @[util.scala:466:20]
        uops_12_is_amo = _RANDOM_156[18];	// @[util.scala:466:20]
        uops_12_uses_ldq = _RANDOM_156[19];	// @[util.scala:466:20]
        uops_12_uses_stq = _RANDOM_156[20];	// @[util.scala:466:20]
        uops_12_is_sys_pc2epc = _RANDOM_156[21];	// @[util.scala:466:20]
        uops_12_is_unique = _RANDOM_156[22];	// @[util.scala:466:20]
        uops_12_flush_on_commit = _RANDOM_156[23];	// @[util.scala:466:20]
        uops_12_ldst_is_rs1 = _RANDOM_156[24];	// @[util.scala:466:20]
        uops_12_ldst = _RANDOM_156[30:25];	// @[util.scala:466:20]
        uops_12_lrs1 = {_RANDOM_156[31], _RANDOM_157[4:0]};	// @[util.scala:466:20]
        uops_12_lrs2 = _RANDOM_157[10:5];	// @[util.scala:466:20]
        uops_12_lrs3 = _RANDOM_157[16:11];	// @[util.scala:466:20]
        uops_12_ldst_val = _RANDOM_157[17];	// @[util.scala:466:20]
        uops_12_dst_rtype = _RANDOM_157[19:18];	// @[util.scala:466:20]
        uops_12_lrs1_rtype = _RANDOM_157[21:20];	// @[util.scala:466:20]
        uops_12_lrs2_rtype = _RANDOM_157[23:22];	// @[util.scala:466:20]
        uops_12_frs3_en = _RANDOM_157[24];	// @[util.scala:466:20]
        uops_12_fp_val = _RANDOM_157[25];	// @[util.scala:466:20]
        uops_12_fp_single = _RANDOM_157[26];	// @[util.scala:466:20]
        uops_12_xcpt_pf_if = _RANDOM_157[27];	// @[util.scala:466:20]
        uops_12_xcpt_ae_if = _RANDOM_157[28];	// @[util.scala:466:20]
        uops_12_xcpt_ma_if = _RANDOM_157[29];	// @[util.scala:466:20]
        uops_12_bp_debug_if = _RANDOM_157[30];	// @[util.scala:466:20]
        uops_12_bp_xcpt_if = _RANDOM_157[31];	// @[util.scala:466:20]
        uops_12_debug_fsrc = _RANDOM_158[1:0];	// @[util.scala:466:20]
        uops_12_debug_tsrc = _RANDOM_158[3:2];	// @[util.scala:466:20]
        uops_13_uopc = _RANDOM_158[10:4];	// @[util.scala:466:20]
        uops_13_inst = {_RANDOM_158[31:11], _RANDOM_159[10:0]};	// @[util.scala:466:20]
        uops_13_debug_inst = {_RANDOM_159[31:11], _RANDOM_160[10:0]};	// @[util.scala:466:20]
        uops_13_is_rvc = _RANDOM_160[11];	// @[util.scala:466:20]
        uops_13_debug_pc = {_RANDOM_160[31:12], _RANDOM_161[19:0]};	// @[util.scala:466:20]
        uops_13_iq_type = _RANDOM_161[22:20];	// @[util.scala:466:20]
        uops_13_fu_code = {_RANDOM_161[31:23], _RANDOM_162[0]};	// @[util.scala:466:20]
        uops_13_ctrl_br_type = _RANDOM_162[4:1];	// @[util.scala:466:20]
        uops_13_ctrl_op1_sel = _RANDOM_162[6:5];	// @[util.scala:466:20]
        uops_13_ctrl_op2_sel = _RANDOM_162[9:7];	// @[util.scala:466:20]
        uops_13_ctrl_imm_sel = _RANDOM_162[12:10];	// @[util.scala:466:20]
        uops_13_ctrl_op_fcn = _RANDOM_162[16:13];	// @[util.scala:466:20]
        uops_13_ctrl_fcn_dw = _RANDOM_162[17];	// @[util.scala:466:20]
        uops_13_ctrl_csr_cmd = _RANDOM_162[20:18];	// @[util.scala:466:20]
        uops_13_ctrl_is_load = _RANDOM_162[21];	// @[util.scala:466:20]
        uops_13_ctrl_is_sta = _RANDOM_162[22];	// @[util.scala:466:20]
        uops_13_ctrl_is_std = _RANDOM_162[23];	// @[util.scala:466:20]
        uops_13_iw_state = _RANDOM_162[25:24];	// @[util.scala:466:20]
        uops_13_iw_p1_poisoned = _RANDOM_162[26];	// @[util.scala:466:20]
        uops_13_iw_p2_poisoned = _RANDOM_162[27];	// @[util.scala:466:20]
        uops_13_is_br = _RANDOM_162[28];	// @[util.scala:466:20]
        uops_13_is_jalr = _RANDOM_162[29];	// @[util.scala:466:20]
        uops_13_is_jal = _RANDOM_162[30];	// @[util.scala:466:20]
        uops_13_is_sfb = _RANDOM_162[31];	// @[util.scala:466:20]
        uops_13_br_mask = _RANDOM_163[7:0];	// @[util.scala:466:20]
        uops_13_br_tag = _RANDOM_163[10:8];	// @[util.scala:466:20]
        uops_13_ftq_idx = _RANDOM_163[14:11];	// @[util.scala:466:20]
        uops_13_edge_inst = _RANDOM_163[15];	// @[util.scala:466:20]
        uops_13_pc_lob = _RANDOM_163[21:16];	// @[util.scala:466:20]
        uops_13_taken = _RANDOM_163[22];	// @[util.scala:466:20]
        uops_13_imm_packed = {_RANDOM_163[31:23], _RANDOM_164[10:0]};	// @[util.scala:466:20]
        uops_13_csr_addr = _RANDOM_164[22:11];	// @[util.scala:466:20]
        uops_13_rob_idx = _RANDOM_164[27:23];	// @[util.scala:466:20]
        uops_13_ldq_idx = _RANDOM_164[30:28];	// @[util.scala:466:20]
        uops_13_stq_idx = {_RANDOM_164[31], _RANDOM_165[1:0]};	// @[util.scala:466:20]
        uops_13_rxq_idx = _RANDOM_165[3:2];	// @[util.scala:466:20]
        uops_13_pdst = _RANDOM_165[9:4];	// @[util.scala:466:20]
        uops_13_prs1 = _RANDOM_165[15:10];	// @[util.scala:466:20]
        uops_13_prs2 = _RANDOM_165[21:16];	// @[util.scala:466:20]
        uops_13_prs3 = _RANDOM_165[27:22];	// @[util.scala:466:20]
        uops_13_ppred = _RANDOM_165[31:28];	// @[util.scala:466:20]
        uops_13_prs1_busy = _RANDOM_166[0];	// @[util.scala:466:20]
        uops_13_prs2_busy = _RANDOM_166[1];	// @[util.scala:466:20]
        uops_13_prs3_busy = _RANDOM_166[2];	// @[util.scala:466:20]
        uops_13_ppred_busy = _RANDOM_166[3];	// @[util.scala:466:20]
        uops_13_stale_pdst = _RANDOM_166[9:4];	// @[util.scala:466:20]
        uops_13_exception = _RANDOM_166[10];	// @[util.scala:466:20]
        uops_13_exc_cause = {_RANDOM_166[31:11], _RANDOM_167, _RANDOM_168[10:0]};	// @[util.scala:466:20]
        uops_13_bypassable = _RANDOM_168[11];	// @[util.scala:466:20]
        uops_13_mem_cmd = _RANDOM_168[16:12];	// @[util.scala:466:20]
        uops_13_mem_size = _RANDOM_168[18:17];	// @[util.scala:466:20]
        uops_13_mem_signed = _RANDOM_168[19];	// @[util.scala:466:20]
        uops_13_is_fence = _RANDOM_168[20];	// @[util.scala:466:20]
        uops_13_is_fencei = _RANDOM_168[21];	// @[util.scala:466:20]
        uops_13_is_amo = _RANDOM_168[22];	// @[util.scala:466:20]
        uops_13_uses_ldq = _RANDOM_168[23];	// @[util.scala:466:20]
        uops_13_uses_stq = _RANDOM_168[24];	// @[util.scala:466:20]
        uops_13_is_sys_pc2epc = _RANDOM_168[25];	// @[util.scala:466:20]
        uops_13_is_unique = _RANDOM_168[26];	// @[util.scala:466:20]
        uops_13_flush_on_commit = _RANDOM_168[27];	// @[util.scala:466:20]
        uops_13_ldst_is_rs1 = _RANDOM_168[28];	// @[util.scala:466:20]
        uops_13_ldst = {_RANDOM_168[31:29], _RANDOM_169[2:0]};	// @[util.scala:466:20]
        uops_13_lrs1 = _RANDOM_169[8:3];	// @[util.scala:466:20]
        uops_13_lrs2 = _RANDOM_169[14:9];	// @[util.scala:466:20]
        uops_13_lrs3 = _RANDOM_169[20:15];	// @[util.scala:466:20]
        uops_13_ldst_val = _RANDOM_169[21];	// @[util.scala:466:20]
        uops_13_dst_rtype = _RANDOM_169[23:22];	// @[util.scala:466:20]
        uops_13_lrs1_rtype = _RANDOM_169[25:24];	// @[util.scala:466:20]
        uops_13_lrs2_rtype = _RANDOM_169[27:26];	// @[util.scala:466:20]
        uops_13_frs3_en = _RANDOM_169[28];	// @[util.scala:466:20]
        uops_13_fp_val = _RANDOM_169[29];	// @[util.scala:466:20]
        uops_13_fp_single = _RANDOM_169[30];	// @[util.scala:466:20]
        uops_13_xcpt_pf_if = _RANDOM_169[31];	// @[util.scala:466:20]
        uops_13_xcpt_ae_if = _RANDOM_170[0];	// @[util.scala:466:20]
        uops_13_xcpt_ma_if = _RANDOM_170[1];	// @[util.scala:466:20]
        uops_13_bp_debug_if = _RANDOM_170[2];	// @[util.scala:466:20]
        uops_13_bp_xcpt_if = _RANDOM_170[3];	// @[util.scala:466:20]
        uops_13_debug_fsrc = _RANDOM_170[5:4];	// @[util.scala:466:20]
        uops_13_debug_tsrc = _RANDOM_170[7:6];	// @[util.scala:466:20]
        uops_14_uopc = _RANDOM_170[14:8];	// @[util.scala:466:20]
        uops_14_inst = {_RANDOM_170[31:15], _RANDOM_171[14:0]};	// @[util.scala:466:20]
        uops_14_debug_inst = {_RANDOM_171[31:15], _RANDOM_172[14:0]};	// @[util.scala:466:20]
        uops_14_is_rvc = _RANDOM_172[15];	// @[util.scala:466:20]
        uops_14_debug_pc = {_RANDOM_172[31:16], _RANDOM_173[23:0]};	// @[util.scala:466:20]
        uops_14_iq_type = _RANDOM_173[26:24];	// @[util.scala:466:20]
        uops_14_fu_code = {_RANDOM_173[31:27], _RANDOM_174[4:0]};	// @[util.scala:466:20]
        uops_14_ctrl_br_type = _RANDOM_174[8:5];	// @[util.scala:466:20]
        uops_14_ctrl_op1_sel = _RANDOM_174[10:9];	// @[util.scala:466:20]
        uops_14_ctrl_op2_sel = _RANDOM_174[13:11];	// @[util.scala:466:20]
        uops_14_ctrl_imm_sel = _RANDOM_174[16:14];	// @[util.scala:466:20]
        uops_14_ctrl_op_fcn = _RANDOM_174[20:17];	// @[util.scala:466:20]
        uops_14_ctrl_fcn_dw = _RANDOM_174[21];	// @[util.scala:466:20]
        uops_14_ctrl_csr_cmd = _RANDOM_174[24:22];	// @[util.scala:466:20]
        uops_14_ctrl_is_load = _RANDOM_174[25];	// @[util.scala:466:20]
        uops_14_ctrl_is_sta = _RANDOM_174[26];	// @[util.scala:466:20]
        uops_14_ctrl_is_std = _RANDOM_174[27];	// @[util.scala:466:20]
        uops_14_iw_state = _RANDOM_174[29:28];	// @[util.scala:466:20]
        uops_14_iw_p1_poisoned = _RANDOM_174[30];	// @[util.scala:466:20]
        uops_14_iw_p2_poisoned = _RANDOM_174[31];	// @[util.scala:466:20]
        uops_14_is_br = _RANDOM_175[0];	// @[util.scala:466:20]
        uops_14_is_jalr = _RANDOM_175[1];	// @[util.scala:466:20]
        uops_14_is_jal = _RANDOM_175[2];	// @[util.scala:466:20]
        uops_14_is_sfb = _RANDOM_175[3];	// @[util.scala:466:20]
        uops_14_br_mask = _RANDOM_175[11:4];	// @[util.scala:466:20]
        uops_14_br_tag = _RANDOM_175[14:12];	// @[util.scala:466:20]
        uops_14_ftq_idx = _RANDOM_175[18:15];	// @[util.scala:466:20]
        uops_14_edge_inst = _RANDOM_175[19];	// @[util.scala:466:20]
        uops_14_pc_lob = _RANDOM_175[25:20];	// @[util.scala:466:20]
        uops_14_taken = _RANDOM_175[26];	// @[util.scala:466:20]
        uops_14_imm_packed = {_RANDOM_175[31:27], _RANDOM_176[14:0]};	// @[util.scala:466:20]
        uops_14_csr_addr = _RANDOM_176[26:15];	// @[util.scala:466:20]
        uops_14_rob_idx = _RANDOM_176[31:27];	// @[util.scala:466:20]
        uops_14_ldq_idx = _RANDOM_177[2:0];	// @[util.scala:466:20]
        uops_14_stq_idx = _RANDOM_177[5:3];	// @[util.scala:466:20]
        uops_14_rxq_idx = _RANDOM_177[7:6];	// @[util.scala:466:20]
        uops_14_pdst = _RANDOM_177[13:8];	// @[util.scala:466:20]
        uops_14_prs1 = _RANDOM_177[19:14];	// @[util.scala:466:20]
        uops_14_prs2 = _RANDOM_177[25:20];	// @[util.scala:466:20]
        uops_14_prs3 = _RANDOM_177[31:26];	// @[util.scala:466:20]
        uops_14_ppred = _RANDOM_178[3:0];	// @[util.scala:466:20]
        uops_14_prs1_busy = _RANDOM_178[4];	// @[util.scala:466:20]
        uops_14_prs2_busy = _RANDOM_178[5];	// @[util.scala:466:20]
        uops_14_prs3_busy = _RANDOM_178[6];	// @[util.scala:466:20]
        uops_14_ppred_busy = _RANDOM_178[7];	// @[util.scala:466:20]
        uops_14_stale_pdst = _RANDOM_178[13:8];	// @[util.scala:466:20]
        uops_14_exception = _RANDOM_178[14];	// @[util.scala:466:20]
        uops_14_exc_cause = {_RANDOM_178[31:15], _RANDOM_179, _RANDOM_180[14:0]};	// @[util.scala:466:20]
        uops_14_bypassable = _RANDOM_180[15];	// @[util.scala:466:20]
        uops_14_mem_cmd = _RANDOM_180[20:16];	// @[util.scala:466:20]
        uops_14_mem_size = _RANDOM_180[22:21];	// @[util.scala:466:20]
        uops_14_mem_signed = _RANDOM_180[23];	// @[util.scala:466:20]
        uops_14_is_fence = _RANDOM_180[24];	// @[util.scala:466:20]
        uops_14_is_fencei = _RANDOM_180[25];	// @[util.scala:466:20]
        uops_14_is_amo = _RANDOM_180[26];	// @[util.scala:466:20]
        uops_14_uses_ldq = _RANDOM_180[27];	// @[util.scala:466:20]
        uops_14_uses_stq = _RANDOM_180[28];	// @[util.scala:466:20]
        uops_14_is_sys_pc2epc = _RANDOM_180[29];	// @[util.scala:466:20]
        uops_14_is_unique = _RANDOM_180[30];	// @[util.scala:466:20]
        uops_14_flush_on_commit = _RANDOM_180[31];	// @[util.scala:466:20]
        uops_14_ldst_is_rs1 = _RANDOM_181[0];	// @[util.scala:466:20]
        uops_14_ldst = _RANDOM_181[6:1];	// @[util.scala:466:20]
        uops_14_lrs1 = _RANDOM_181[12:7];	// @[util.scala:466:20]
        uops_14_lrs2 = _RANDOM_181[18:13];	// @[util.scala:466:20]
        uops_14_lrs3 = _RANDOM_181[24:19];	// @[util.scala:466:20]
        uops_14_ldst_val = _RANDOM_181[25];	// @[util.scala:466:20]
        uops_14_dst_rtype = _RANDOM_181[27:26];	// @[util.scala:466:20]
        uops_14_lrs1_rtype = _RANDOM_181[29:28];	// @[util.scala:466:20]
        uops_14_lrs2_rtype = _RANDOM_181[31:30];	// @[util.scala:466:20]
        uops_14_frs3_en = _RANDOM_182[0];	// @[util.scala:466:20]
        uops_14_fp_val = _RANDOM_182[1];	// @[util.scala:466:20]
        uops_14_fp_single = _RANDOM_182[2];	// @[util.scala:466:20]
        uops_14_xcpt_pf_if = _RANDOM_182[3];	// @[util.scala:466:20]
        uops_14_xcpt_ae_if = _RANDOM_182[4];	// @[util.scala:466:20]
        uops_14_xcpt_ma_if = _RANDOM_182[5];	// @[util.scala:466:20]
        uops_14_bp_debug_if = _RANDOM_182[6];	// @[util.scala:466:20]
        uops_14_bp_xcpt_if = _RANDOM_182[7];	// @[util.scala:466:20]
        uops_14_debug_fsrc = _RANDOM_182[9:8];	// @[util.scala:466:20]
        uops_14_debug_tsrc = _RANDOM_182[11:10];	// @[util.scala:466:20]
        uops_15_uopc = _RANDOM_182[18:12];	// @[util.scala:466:20]
        uops_15_inst = {_RANDOM_182[31:19], _RANDOM_183[18:0]};	// @[util.scala:466:20]
        uops_15_debug_inst = {_RANDOM_183[31:19], _RANDOM_184[18:0]};	// @[util.scala:466:20]
        uops_15_is_rvc = _RANDOM_184[19];	// @[util.scala:466:20]
        uops_15_debug_pc = {_RANDOM_184[31:20], _RANDOM_185[27:0]};	// @[util.scala:466:20]
        uops_15_iq_type = _RANDOM_185[30:28];	// @[util.scala:466:20]
        uops_15_fu_code = {_RANDOM_185[31], _RANDOM_186[8:0]};	// @[util.scala:466:20]
        uops_15_ctrl_br_type = _RANDOM_186[12:9];	// @[util.scala:466:20]
        uops_15_ctrl_op1_sel = _RANDOM_186[14:13];	// @[util.scala:466:20]
        uops_15_ctrl_op2_sel = _RANDOM_186[17:15];	// @[util.scala:466:20]
        uops_15_ctrl_imm_sel = _RANDOM_186[20:18];	// @[util.scala:466:20]
        uops_15_ctrl_op_fcn = _RANDOM_186[24:21];	// @[util.scala:466:20]
        uops_15_ctrl_fcn_dw = _RANDOM_186[25];	// @[util.scala:466:20]
        uops_15_ctrl_csr_cmd = _RANDOM_186[28:26];	// @[util.scala:466:20]
        uops_15_ctrl_is_load = _RANDOM_186[29];	// @[util.scala:466:20]
        uops_15_ctrl_is_sta = _RANDOM_186[30];	// @[util.scala:466:20]
        uops_15_ctrl_is_std = _RANDOM_186[31];	// @[util.scala:466:20]
        uops_15_iw_state = _RANDOM_187[1:0];	// @[util.scala:466:20]
        uops_15_iw_p1_poisoned = _RANDOM_187[2];	// @[util.scala:466:20]
        uops_15_iw_p2_poisoned = _RANDOM_187[3];	// @[util.scala:466:20]
        uops_15_is_br = _RANDOM_187[4];	// @[util.scala:466:20]
        uops_15_is_jalr = _RANDOM_187[5];	// @[util.scala:466:20]
        uops_15_is_jal = _RANDOM_187[6];	// @[util.scala:466:20]
        uops_15_is_sfb = _RANDOM_187[7];	// @[util.scala:466:20]
        uops_15_br_mask = _RANDOM_187[15:8];	// @[util.scala:466:20]
        uops_15_br_tag = _RANDOM_187[18:16];	// @[util.scala:466:20]
        uops_15_ftq_idx = _RANDOM_187[22:19];	// @[util.scala:466:20]
        uops_15_edge_inst = _RANDOM_187[23];	// @[util.scala:466:20]
        uops_15_pc_lob = _RANDOM_187[29:24];	// @[util.scala:466:20]
        uops_15_taken = _RANDOM_187[30];	// @[util.scala:466:20]
        uops_15_imm_packed = {_RANDOM_187[31], _RANDOM_188[18:0]};	// @[util.scala:466:20]
        uops_15_csr_addr = _RANDOM_188[30:19];	// @[util.scala:466:20]
        uops_15_rob_idx = {_RANDOM_188[31], _RANDOM_189[3:0]};	// @[util.scala:466:20]
        uops_15_ldq_idx = _RANDOM_189[6:4];	// @[util.scala:466:20]
        uops_15_stq_idx = _RANDOM_189[9:7];	// @[util.scala:466:20]
        uops_15_rxq_idx = _RANDOM_189[11:10];	// @[util.scala:466:20]
        uops_15_pdst = _RANDOM_189[17:12];	// @[util.scala:466:20]
        uops_15_prs1 = _RANDOM_189[23:18];	// @[util.scala:466:20]
        uops_15_prs2 = _RANDOM_189[29:24];	// @[util.scala:466:20]
        uops_15_prs3 = {_RANDOM_189[31:30], _RANDOM_190[3:0]};	// @[util.scala:466:20]
        uops_15_ppred = _RANDOM_190[7:4];	// @[util.scala:466:20]
        uops_15_prs1_busy = _RANDOM_190[8];	// @[util.scala:466:20]
        uops_15_prs2_busy = _RANDOM_190[9];	// @[util.scala:466:20]
        uops_15_prs3_busy = _RANDOM_190[10];	// @[util.scala:466:20]
        uops_15_ppred_busy = _RANDOM_190[11];	// @[util.scala:466:20]
        uops_15_stale_pdst = _RANDOM_190[17:12];	// @[util.scala:466:20]
        uops_15_exception = _RANDOM_190[18];	// @[util.scala:466:20]
        uops_15_exc_cause = {_RANDOM_190[31:19], _RANDOM_191, _RANDOM_192[18:0]};	// @[util.scala:466:20]
        uops_15_bypassable = _RANDOM_192[19];	// @[util.scala:466:20]
        uops_15_mem_cmd = _RANDOM_192[24:20];	// @[util.scala:466:20]
        uops_15_mem_size = _RANDOM_192[26:25];	// @[util.scala:466:20]
        uops_15_mem_signed = _RANDOM_192[27];	// @[util.scala:466:20]
        uops_15_is_fence = _RANDOM_192[28];	// @[util.scala:466:20]
        uops_15_is_fencei = _RANDOM_192[29];	// @[util.scala:466:20]
        uops_15_is_amo = _RANDOM_192[30];	// @[util.scala:466:20]
        uops_15_uses_ldq = _RANDOM_192[31];	// @[util.scala:466:20]
        uops_15_uses_stq = _RANDOM_193[0];	// @[util.scala:466:20]
        uops_15_is_sys_pc2epc = _RANDOM_193[1];	// @[util.scala:466:20]
        uops_15_is_unique = _RANDOM_193[2];	// @[util.scala:466:20]
        uops_15_flush_on_commit = _RANDOM_193[3];	// @[util.scala:466:20]
        uops_15_ldst_is_rs1 = _RANDOM_193[4];	// @[util.scala:466:20]
        uops_15_ldst = _RANDOM_193[10:5];	// @[util.scala:466:20]
        uops_15_lrs1 = _RANDOM_193[16:11];	// @[util.scala:466:20]
        uops_15_lrs2 = _RANDOM_193[22:17];	// @[util.scala:466:20]
        uops_15_lrs3 = _RANDOM_193[28:23];	// @[util.scala:466:20]
        uops_15_ldst_val = _RANDOM_193[29];	// @[util.scala:466:20]
        uops_15_dst_rtype = _RANDOM_193[31:30];	// @[util.scala:466:20]
        uops_15_lrs1_rtype = _RANDOM_194[1:0];	// @[util.scala:466:20]
        uops_15_lrs2_rtype = _RANDOM_194[3:2];	// @[util.scala:466:20]
        uops_15_frs3_en = _RANDOM_194[4];	// @[util.scala:466:20]
        uops_15_fp_val = _RANDOM_194[5];	// @[util.scala:466:20]
        uops_15_fp_single = _RANDOM_194[6];	// @[util.scala:466:20]
        uops_15_xcpt_pf_if = _RANDOM_194[7];	// @[util.scala:466:20]
        uops_15_xcpt_ae_if = _RANDOM_194[8];	// @[util.scala:466:20]
        uops_15_xcpt_ma_if = _RANDOM_194[9];	// @[util.scala:466:20]
        uops_15_bp_debug_if = _RANDOM_194[10];	// @[util.scala:466:20]
        uops_15_bp_xcpt_if = _RANDOM_194[11];	// @[util.scala:466:20]
        uops_15_debug_fsrc = _RANDOM_194[13:12];	// @[util.scala:466:20]
        uops_15_debug_tsrc = _RANDOM_194[15:14];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_194[19:16];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_194[23:20];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_194[24];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_31 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_valid = ~_io_empty_output & _GEN_0 & (io_brupdate_b1_mispredict_mask & out_uop_br_mask) == 8'h0 & ~(io_flush & out_uop_uses_ldq);	// @[util.scala:118:{51,59}, :473:25, :476:{42,69}, :508:19, :509:{108,111,122}]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[427:388];	// @[util.scala:464:20]
  assign io_deq_bits_is_hella = _ram_ext_R0_data[492];	// @[util.scala:464:20]
  assign io_deq_bits_sdq_id = _ram_ext_R0_data[524:520];	// @[util.scala:464:20]
