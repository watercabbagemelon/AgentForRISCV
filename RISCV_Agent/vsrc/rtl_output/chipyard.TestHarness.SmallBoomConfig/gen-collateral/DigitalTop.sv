...
module DigitalTop(
  ...
  wire [8:0]  _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_source;	// @[HasChipyardPRCI.scala:37:36]
  ...
  wire [8:0]  _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_source;	// @[HasChipyardPRCI.scala:37:36]
  ...
  wire [8:0]  _uartClockDomainWrapper_auto_uart_0_control_xing_in_d_bits_source;	// @[UART.scala:270:44]
  ...
  wire [8:0]  _bootROMDomainWrapper_auto_bootrom_in_d_bits_source;	// @[BootROM.scala:72:42]
  ...
  wire [8:0]  _tlDM_auto_dmInner_dmInner_tl_in_d_bits_source;	// @[Periphery.scala:85:26]
  ...
  wire [8:0]  _clint_auto_in_d_bits_source;	// @[CLINT.scala:107:27]
  ...
  wire [8:0]  _plicDomainWrapper_auto_plic_in_d_bits_source;	// @[Plic.scala:359:39]
  ...
  wire [3:0]  _subsystem_l2_wrapper_auto_coherent_jbar_in_d_bits_source;	// @[BankedL2Params.scala:47:31]
  ...
  wire [8:0]  _subsystem_l2_wrapper_auto_l2_ctl_in_d_bits_source;	// @[BankedL2Params.scala:47:31]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_slave_named_tileresetsetter_buffer_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_slave_named_clockgater_buffer_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_bootrom_fragmenter_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_debug_fragmenter_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_clint_fragmenter_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_plic_fragmenter_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [4:0]  _subsystem_cbus_auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_cbus_auto_coupler_to_l2_ctrl_buffer_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [3:0]  _subsystem_cbus_auto_bus_xing_in_d_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [8:0]  _subsystem_pbus_auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [4:0]  _subsystem_pbus_auto_bus_xing_in_d_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [3:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_source;	// @[SystemBus.scala:24:26]
  ...
  wire [3:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_c_bits_source;	// @[SystemBus.scala:24:26]
  ...
  wire [3:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_source;	// @[SystemBus.scala:24:26]
