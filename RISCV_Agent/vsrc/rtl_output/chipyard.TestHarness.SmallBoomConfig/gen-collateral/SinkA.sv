      ...
      if (_io_a_ready_output & io_a_valid) begin	// @[Decoupled.scala:51:35, SinkA.scala:78:39]
        if (first) begin	// @[Edges.scala:230:25]
          if (io_a_bits_opcode[2])	// @[Edges.scala:91:37]
            ...
            first_counter <= ~(_first_beats1_decode_T_1[5:3]);	// @[Edges.scala:228:27, package.scala:235:{46,71,76}]
        end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        first_counter = _RANDOM_1[10:8];	// @[Edges.scala:228:27, SinkA.scala:52:22]
