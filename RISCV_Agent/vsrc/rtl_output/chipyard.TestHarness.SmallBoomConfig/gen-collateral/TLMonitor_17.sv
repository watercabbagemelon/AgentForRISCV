...
module TLMonitor_17(
  ...
  wire         _T_1204 = _T_1273 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire         _T_1219 = _T_1341 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    ...
    if (_T_1273 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_1302 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [16:0]     _T_1205 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_1224 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [135:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire  [16:0]     _T_1303 = 17'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (_GEN_5 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_6 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, :706:27, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_434 & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
