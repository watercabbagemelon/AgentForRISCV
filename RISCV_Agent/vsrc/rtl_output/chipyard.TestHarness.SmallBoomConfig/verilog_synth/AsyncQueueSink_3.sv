...
module AsyncQueueSink_3(
  ...
  AsyncResetSynchronizerShiftReg_w4_d3_i0_1 widx_widx_gray (
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
