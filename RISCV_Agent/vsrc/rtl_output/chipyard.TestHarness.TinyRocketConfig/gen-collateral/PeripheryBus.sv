...
module PeripheryBus(
  ...
  wire [2:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [31:0] _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire [7:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source;	// @[LazyModule.scala:489:27]
  wire [14:0] _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_address;	// @[LazyModule.scala:489:27]
  wire [3:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask;	// @[LazyModule.scala:489:27]
  wire [31:0] _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data;	// @[LazyModule.scala:489:27]
  ...
  reg  [31:0] bootAddrReg;	// @[BootAddrReg.scala:34:32]
  ...
  wire        _out_out_bits_data_T_1 = _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_address[11:2] == 10'h0;	// @[Edges.scala:191:34, LazyModule.scala:489:27, RegisterRouter.scala:72:19, :82:24]
  wire        valids_0 = out_woready_3 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[0];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_1 = out_woready_3 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[1];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_2 = out_woready_3 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[2];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_3 = out_woready_3 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[3];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  assign out_woready_3 = _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready & ~out_front_bits_read & _out_out_bits_data_T_1;	// @[LazyModule.scala:489:27, RegisterRouter.scala:71:36, :82:24]
  wire [2:0]  bundleIn_0_1_d_bits_opcode = {2'h0, out_front_bits_read};	// @[RegisterRouter.scala:71:36, :97:19]
  always @(posedge _fixedClockNode_auto_out_0_clock) begin	// @[ClockGroup.scala:110:107]
    if (_fixedClockNode_auto_out_0_reset)	// @[ClockGroup.scala:110:107]
      bootAddrReg <= 32'h80000000;	// @[BootAddrReg.scala:34:32]
    else if (valids_0 | valids_1 | valids_2 | valids_3)	// @[RegField.scala:154:27, RegisterRouter.scala:82:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        bootAddrReg = _RANDOM_0;	// @[BootAddrReg.scala:34:32]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLXbar_2 out_xbar (	// @[PeripheryBus.scala:50:30]
    ...
    .auto_out_2_a_ready        (_coupler_to_device_named_uart_0_auto_tl_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_valid        (_coupler_to_device_named_uart_0_auto_tl_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_opcode  (_coupler_to_device_named_uart_0_auto_tl_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_size    (_coupler_to_device_named_uart_0_auto_tl_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_source  (_coupler_to_device_named_uart_0_auto_tl_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_data    (_coupler_to_device_named_uart_0_auto_tl_in_d_bits_data),	// @[LazyModule.scala:489:27]
    .auto_out_1_a_ready        (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_ready),
    .auto_out_1_d_valid        (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_valid),
    .auto_out_1_d_bits_opcode  (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_opcode),
    .auto_out_1_d_bits_param   (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_param),
    .auto_out_1_d_bits_size    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_size),
    .auto_out_1_d_bits_source  (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_source),
    .auto_out_1_d_bits_sink    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_sink),
    .auto_out_1_d_bits_denied  (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_denied),
    .auto_out_1_d_bits_data    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_data),
    .auto_out_1_d_bits_corrupt (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_bits_corrupt),
    ...
    .auto_out_1_a_valid        (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_valid),
    .auto_out_1_a_bits_opcode  (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_opcode),
    .auto_out_1_a_bits_param   (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_param),
    .auto_out_1_a_bits_size    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_size),
    .auto_out_1_a_bits_source  (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_source),
    .auto_out_1_a_bits_address (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_address),
    .auto_out_1_a_bits_mask    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_mask),
    .auto_out_1_a_bits_data    (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_data),
    .auto_out_1_a_bits_corrupt (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_a_bits_corrupt),
    .auto_out_1_d_ready        (auto_coupler_to_port_named_serial_tl_mem_tlserial_manager_crossing_out_d_ready),
  ...
  TLInterconnectCoupler_4 coupler_to_slave_named_bootaddressreg (	// @[LazyModule.scala:489:27]
    ...
    .auto_fragmenter_out_d_bits_data    (_out_out_bits_data_T_1 ? bootAddrReg : 32'h0),	// @[BootAddrReg.scala:34:32, Bundles.scala:259:74, RegisterRouter.scala:82:24]
