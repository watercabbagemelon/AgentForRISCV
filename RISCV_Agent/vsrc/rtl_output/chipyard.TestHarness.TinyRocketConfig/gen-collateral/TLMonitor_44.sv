...
module TLMonitor_44(
  ...
  wire [66:0] _a_opcodes_set_T_1 = {63'h0, _T_692 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [78:0] _d_sizes_clr_T_5 = 79'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [66:0] _a_sizes_set_T_1 = {63'h0, _T_692 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_740 & ~d_release_ack ? _d_clr_wo_ready_T[4:0] : 5'h0) | a_set_wo_ready == 5'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
