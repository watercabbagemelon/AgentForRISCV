...
module TLMonitor_22(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
