...
module TLXbar_5(
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16], auto_in_a_bits_address[14:13] ^ 2'h1} == 9'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_1 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16], auto_in_a_bits_address[14:13] ^ 2'h2} == 9'h0 | {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16] ^ 2'h2} == 7'h0 | {auto_in_a_bits_address[31], ~(auto_in_a_bits_address[28]), auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16], auto_in_a_bits_address[14:13]} == 8'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92, package.scala:254:43]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], ~(auto_in_a_bits_address[26])} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_3 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25] ^ 2'h1, auto_in_a_bits_address[20], auto_in_a_bits_address[17:16]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {~(auto_in_a_bits_address[31]), auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16], auto_in_a_bits_address[14]} == 8'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16], auto_in_a_bits_address[14:13]} == 9'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{45,65}]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[17:16] ^ 2'h1} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_7 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[17:16], auto_in_a_bits_address[14:13]} == 9'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
  wire [4:0]  _GEN = auto_in_a_bits_address[20:16] ^ 5'h11;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_8 = {auto_in_a_bits_address[31], auto_in_a_bits_address[28], auto_in_a_bits_address[26:25], _GEN[4], _GEN[1:0], auto_in_a_bits_address[14:13]} == 9'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
  ...
  wire        idle = beatsLeft == 10'h0;	// @[Arbiter.scala:88:30, :89:28, Edges.scala:220:14]
  ...
  wire [7:0]  _GEN_0 = _readys_filter_T_1[7:0] | _readys_filter_T_1[8:1];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_1 = auto_out_8_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_2 = auto_out_7_d_valid | auto_out_8_d_valid;	// @[package.scala:254:43]
  ...
  wire        _GEN_7 = _GEN_0[6] | _readys_filter_T_1[8];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire [5:0]  _GEN_8 = _GEN_0[5:0] | _GEN_0[7:2];	// @[package.scala:254:43]
  wire        _GEN_9 = _GEN_1 | _GEN_0[1];	// @[package.scala:254:43]
  wire        _GEN_10 = _GEN_2 | _GEN_0[0];	// @[package.scala:254:43]
  wire        _GEN_11 = _GEN_3 | _GEN_1;	// @[package.scala:254:43]
  wire        _GEN_12 = _GEN_4 | _GEN_2;	// @[package.scala:254:43]
  wire        _GEN_13 = _GEN_8[4] | _readys_filter_T_1[8];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_14 = _GEN_8[3] | _GEN_0[7];	// @[package.scala:254:43]
  wire        _GEN_15 = _GEN_8[2] | _GEN_7;	// @[package.scala:254:43]
  wire [1:0]  _GEN_16 = _GEN_8[1:0] | _GEN_8[5:4];	// @[package.scala:254:43]
  wire [8:0]  readys_readys = ~({readys_mask[8], _readys_filter_T_1[8] | readys_mask[7], _GEN_0[7] | readys_mask[6], _GEN_7 | readys_mask[5], _GEN_8[5] | readys_mask[4], _GEN_13 | readys_mask[3], _GEN_14 | readys_mask[2], _GEN_15 | readys_mask[1], _GEN_16[1] | readys_mask[0]} & {_GEN_16[0] | _readys_filter_T_1[8], _GEN_9 | _GEN_8[3] | _GEN_0[7], _GEN_10 | _GEN_8[2] | _GEN_7, _GEN_11 | _GEN_8[1] | _GEN_8[5], _GEN_12 | _GEN_8[0] | _GEN_13, _GEN_5 | _GEN_3 | _GEN_9 | _GEN_14, _GEN_6 | _GEN_4 | _GEN_10 | _GEN_15, auto_out_2_d_valid | auto_out_3_d_valid | _GEN_5 | _GEN_11 | _GEN_16[1], auto_out_1_d_valid | auto_out_2_d_valid | _GEN_6 | _GEN_12 | _GEN_16[0]});	// @[Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43]
  ...
  wire        out_30_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt | muxStateEarly_4 & auto_out_4_d_bits_corrupt | muxStateEarly_7 & auto_out_7_d_bits_corrupt | muxStateEarly_8 & auto_out_8_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_30_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied | muxStateEarly_4 & auto_out_4_d_bits_denied | muxStateEarly_7 & auto_out_7_d_bits_denied | muxStateEarly_8 & auto_out_8_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_30_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink | muxStateEarly_4 & auto_out_4_d_bits_sink | muxStateEarly_7 & auto_out_7_d_bits_sink | muxStateEarly_8 & auto_out_8_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire [2:0]  out_30_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 3'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 3'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 3'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 3'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_source : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_30_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_param : 2'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_param : 2'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 10'h0;	// @[Arbiter.scala:88:30, Edges.scala:220:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[18:10];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[19];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[20];	// @[Arbiter.scala:88:30, :117:26]
        state_2 = _RANDOM_0[21];	// @[Arbiter.scala:88:30, :117:26]
        state_3 = _RANDOM_0[22];	// @[Arbiter.scala:88:30, :117:26]
        state_4 = _RANDOM_0[23];	// @[Arbiter.scala:88:30, :117:26]
        state_5 = _RANDOM_0[24];	// @[Arbiter.scala:88:30, :117:26]
        state_6 = _RANDOM_0[25];	// @[Arbiter.scala:88:30, :117:26]
        state_7 = _RANDOM_0[26];	// @[Arbiter.scala:88:30, :117:26]
        state_8 = _RANDOM_0[27];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
