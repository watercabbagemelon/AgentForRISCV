...
module TLMonitor_45(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(io_in_a_bits_size != 2'h3 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{31,65}, :670:56, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(io_in_a_bits_source < 8'hA0 & io_in_a_bits_size != 2'h3 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 8'hA0 & io_in_a_bits_size != 2'h3 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_47 = `RANDOM;
        _RANDOM_48 = `RANDOM;
        inflight = {_RANDOM_2[31:2], _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[1:0]};	// @[Monitor.scala:611:27]
        inflight_opcodes = {_RANDOM_7[31:2], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20, _RANDOM_21, _RANDOM_22, _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26, _RANDOM_27[1:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_27[31:2], _RANDOM_28, _RANDOM_29, _RANDOM_30, _RANDOM_31, _RANDOM_32, _RANDOM_33, _RANDOM_34, _RANDOM_35, _RANDOM_36, _RANDOM_37, _RANDOM_38, _RANDOM_39, _RANDOM_40, _RANDOM_41, _RANDOM_42, _RANDOM_43, _RANDOM_44, _RANDOM_45, _RANDOM_46, _RANDOM_47[1:0]};	// @[Monitor.scala:613:35, :615:33]
