...
module TLFragmenter_9(
  ...
  wire [31:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:263:30]
  ...
  wire        drop = ~(auto_out_d_bits_opcode[0]) & ~(auto_out_d_bits_source[5] ? dFirst : auto_out_d_bits_source[3:0] == 4'h0);	// @[Edges.scala:105:36, Fragmenter.scala:190:29, :193:41, :194:29, :195:30, :220:54, :223:{20,30,33,37}]
  ...
  assign auto_in_d_valid = auto_out_d_valid & ~drop;	// @[Fragmenter.scala:223:30, :225:{36,39}]
  assign auto_in_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_d_bits_size = dFirst ? dFirst_size : dOrig;	// @[Cat.scala:33:92, Fragmenter.scala:191:24, :194:29, :228:32]
  assign auto_in_d_bits_source = auto_out_d_bits_source[8:6];	// @[Fragmenter.scala:227:47]
  ...
  assign auto_out_a_bits_source = {_repeater_io_deq_bits_source, _repeater_io_deq_bits_opcode == 3'h0, ~(aFirst ? dToggle : aToggle_r), old_gennum1};	// @[Cat.scala:33:92, Fragmenter.scala:192:30, :263:30, :293:29, :294:30, :298:{23,27}, Mux.scala:81:61, OneHot.scala:64:12, Reg.scala:19:16]
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {26'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};	// @[Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}]
