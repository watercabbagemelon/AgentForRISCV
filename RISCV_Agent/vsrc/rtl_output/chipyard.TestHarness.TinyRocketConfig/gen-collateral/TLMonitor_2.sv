...
module TLMonitor_2(
  ...
  wire [18:0] _a_opcodes_set_T_1 = {15'h0, _T_1127 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {16'h0, io_in_a_bits_source, 2'h0};	// @[Misc.scala:205:21, Monitor.scala:42:11, :138:25, :638:65, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, package.scala:235:71]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_opcodes <= (inflight_opcodes | (_T_1127 ? _a_opcodes_set_T_1[3:0] : 4'h0)) & ~{4{d_clr}};	// @[Monitor.scala:138:25, :613:35, :627:33, :638:65, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:21, :703:{43,60,62}]
      inflight_sizes <= (inflight_sizes | (_T_1127 ? _a_sizes_set_T_1[7:0] : 8'h0)) & ~{8{d_clr}};	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:21, :704:{39,54,56}, :745:35]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_T_1175 & a_first_1 & io_in_a_valid & ~io_in_a_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1175 & ~d_release_ack) | ~a_set_wo_ready)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :670:46, :671:{26,71,74}, :699:{29,48,51}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
