...
module Queue_12(
  ...
  ram_combMem_3 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, 34'h2, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode}),
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[45:14];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[46];
endmodule
