...
module TLFragmenter_11(
  ...
  wire [17:0] _repeater_io_deq_bits_address;
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {12'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};
