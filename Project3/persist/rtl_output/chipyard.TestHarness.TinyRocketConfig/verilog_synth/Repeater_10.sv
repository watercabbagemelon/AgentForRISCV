  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_2 = `RANDOM;
        full = _RANDOM_0[0];
        saved_opcode = _RANDOM_0[3:1];
        saved_param = _RANDOM_0[6:4];
        saved_size = _RANDOM_0[9:7];
        saved_source = _RANDOM_0[12:10];
        saved_address = _RANDOM_0[30:13];
        saved_mask = {_RANDOM_0[31], _RANDOM_1[2:0]};
        saved_corrupt = _RANDOM_2[3];
      `endif // RANDOMIZE_REG_INIT
    end // initial
