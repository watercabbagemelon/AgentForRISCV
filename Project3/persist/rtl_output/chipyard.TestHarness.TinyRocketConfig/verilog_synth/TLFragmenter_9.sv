...
module TLFragmenter_9(
  ...
  wire        drop = ~(auto_out_d_bits_opcode[0]) & ~(auto_out_d_bits_source[5] ? dFirst : auto_out_d_bits_source[3:0] == 4'h0);
  ...
  assign auto_out_a_bits_source = {_repeater_io_deq_bits_source, _repeater_io_deq_bits_opcode == 3'h0, ~(aFirst ? dToggle : aToggle_r), old_gennum1};
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {26'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};
