...
module AsyncQueueSink(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_5 widx_widx_gray (
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
