...
module Queue_11(
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[26:13];
  assign io_deq_bits_mask = _ram_ext_R0_data[30:27];
  assign io_deq_bits_data = _ram_ext_R0_data[62:31];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[63];
endmodule
