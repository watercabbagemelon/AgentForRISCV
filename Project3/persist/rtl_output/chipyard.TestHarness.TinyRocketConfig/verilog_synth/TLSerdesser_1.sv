...
module TLSerdesser_1(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_outArb_io_in_1_ready & auto_client_out_d_valid) begin
        if (merged_bits_last_counter_1 == 4'h0) begin
          if (auto_client_out_d_bits_opcode[0])
            merged_bits_last_counter_1 <= ~(_merged_bits_last_beats1_decode_T_1[5:2]);
          else
            merged_bits_last_counter_1 <= 4'h0;
        end
        else
          merged_bits_last_counter_1 <= merged_bits_last_counter_1 - 4'h1;
      end
      if (_outArb_io_in_4_ready & auto_manager_in_a_valid) begin
        if (merged_bits_last_counter_4 == 4'h0) begin
          if (auto_manager_in_a_bits_opcode[2])
            merged_bits_last_counter_4 <= 4'h0;
          else
            merged_bits_last_counter_4 <= ~(_merged_bits_last_beats1_decode_T_13[5:2]);
        end
        else
          merged_bits_last_counter_4 <= merged_bits_last_counter_4 - 4'h1;
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        merged_bits_last_counter_1 = _RANDOM_0[7:4];
        merged_bits_last_counter_4 = _RANDOM_0[19:16];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  HellaPeekingArbiter_1 outArb (
    ...
    .io_in_1_bits_source  ({5'h0, auto_client_out_d_bits_source}),
    ...
    .io_in_1_bits_last    (merged_bits_last_counter_1 == 4'h1 | (auto_client_out_d_bits_opcode[0] ? ~(_merged_bits_last_beats1_decode_T_1[5:2]) : 4'h0) == 4'h0),
    ...
    .io_in_4_bits_last    (merged_bits_last_counter_4 == 4'h1 | (auto_manager_in_a_bits_opcode[2] ? 4'h0 : ~(_merged_bits_last_beats1_decode_T_13[5:2])) == 4'h0),
  ...
  assign auto_client_out_a_bits_source = _inDes_io_out_bits_source[2:0];
  assign auto_client_out_a_bits_address = _inDes_io_out_bits_address[28:0];
