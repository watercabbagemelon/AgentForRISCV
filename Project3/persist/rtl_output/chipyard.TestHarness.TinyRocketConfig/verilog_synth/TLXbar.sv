...
module TLXbar(
  ...
  wire        out_7_valid = auto_out_d_valid & requestDOI_0_0;
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[1]);
  reg  [9:0]  beatsLeft;
  ...
  wire        winnerQual_1 = readys_readys[1] & auto_in_1_a_valid;
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)
        beatsLeft <= (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_1[11:2]) : 10'h0) | (winnerQual_1 & ~(auto_in_1_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_5[11:2]) : 10'h0);
      else
  ...
  TLMonitor_1 monitor_1 (
    ...
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[0]),
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  ...
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_opcode : 3'h0);
  assign auto_out_a_bits_param = (muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_param : 3'h0);
  assign auto_out_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_size : 4'h0);
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h1, auto_in_0_a_bits_source} : 2'h0) | (muxStateEarly_1 ? {1'h0, auto_in_1_a_bits_source} : 2'h0);
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 4'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 4'h0);
  ...
  assign auto_out_d_ready = requestDOI_0_0 & auto_in_0_d_ready | ~(auto_out_d_bits_source[1]) & auto_in_1_d_ready;
endmodule
