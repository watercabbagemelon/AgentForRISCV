...
module HellaCacheArbiter(
  ...
  assign io_requestor_0_resp_bits_tag = {1'h0, io_mem_resp_bits_tag[6:1]};
  ...
  assign io_mem_req_bits_tag = io_requestor_0_req_valid ? {io_requestor_0_req_bits_tag[5:0], 1'h0} : 7'h1;
  ...
  assign io_mem_req_bits_dprv = io_requestor_0_req_valid ? io_requestor_0_req_bits_dprv : 2'h0;
  assign io_mem_req_bits_no_xcpt = ~io_requestor_0_req_valid;
  assign io_mem_s1_kill = s1_id ? io_requestor_1_s1_kill : io_requestor_0_s1_kill;
  assign io_mem_s1_data_data = s1_id ? io_requestor_1_s1_data_data : io_requestor_0_s1_data_data;
  assign io_mem_s1_data_mask = s1_id ? io_requestor_1_s1_data_mask : 4'h0;
endmodule
