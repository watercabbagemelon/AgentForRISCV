...
module SystemBus(
  ...
  wire        _coupler_from_tile_auto_tl_out_a_valid;
  wire [2:0]  _coupler_from_tile_auto_tl_out_a_bits_opcode;
  wire [2:0]  _coupler_from_tile_auto_tl_out_a_bits_param;
  wire [3:0]  _coupler_from_tile_auto_tl_out_a_bits_size;
  wire        _coupler_from_tile_auto_tl_out_a_bits_source;
  wire [31:0] _coupler_from_tile_auto_tl_out_a_bits_address;
  wire [3:0]  _coupler_from_tile_auto_tl_out_a_bits_mask;
  wire [31:0] _coupler_from_tile_auto_tl_out_a_bits_data;
  wire        _coupler_from_tile_auto_tl_out_a_bits_corrupt;
  wire        _coupler_from_tile_auto_tl_out_d_ready;
  ...
  wire [3:0]  _coupler_from_bus_named_subsystem_fbus_auto_widget_out_a_bits_mask;
  wire [31:0] _coupler_from_bus_named_subsystem_fbus_auto_widget_out_a_bits_data;
  ...
  wire [1:0]  _coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_source;
  ...
  wire [31:0] _coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_data;
  ...
  wire        _fixer_auto_in_1_d_bits_source;
  wire        _fixer_auto_in_1_d_bits_sink;
  wire        _fixer_auto_in_1_d_bits_denied;
  wire [31:0] _fixer_auto_in_1_d_bits_data;
  ...
  wire        _fixer_auto_in_0_d_bits_sink;
  wire        _fixer_auto_in_0_d_bits_denied;
  wire [31:0] _fixer_auto_in_0_d_bits_data;
  ...
  wire        _fixer_auto_out_1_a_bits_source;
  wire [31:0] _fixer_auto_out_1_a_bits_address;
  wire [3:0]  _fixer_auto_out_1_a_bits_mask;
  wire [31:0] _fixer_auto_out_1_a_bits_data;
  ...
  wire [3:0]  _fixer_auto_out_0_a_bits_mask;
  wire [31:0] _fixer_auto_out_0_a_bits_data;
  ...
  wire        _system_bus_xbar_auto_in_1_d_bits_source;
  wire        _system_bus_xbar_auto_in_1_d_bits_sink;
  wire        _system_bus_xbar_auto_in_1_d_bits_denied;
  wire [31:0] _system_bus_xbar_auto_in_1_d_bits_data;
  ...
  wire        _system_bus_xbar_auto_in_0_d_bits_sink;
  wire        _system_bus_xbar_auto_in_0_d_bits_denied;
  wire [31:0] _system_bus_xbar_auto_in_0_d_bits_data;
  wire        _system_bus_xbar_auto_in_0_d_bits_corrupt;
  wire        _system_bus_xbar_auto_out_a_valid;
  wire [2:0]  _system_bus_xbar_auto_out_a_bits_opcode;
  wire [2:0]  _system_bus_xbar_auto_out_a_bits_param;
  wire [3:0]  _system_bus_xbar_auto_out_a_bits_size;
  wire [1:0]  _system_bus_xbar_auto_out_a_bits_source;
  wire [31:0] _system_bus_xbar_auto_out_a_bits_address;
  wire [3:0]  _system_bus_xbar_auto_out_a_bits_mask;
  wire [31:0] _system_bus_xbar_auto_out_a_bits_data;
  wire        _system_bus_xbar_auto_out_a_bits_corrupt;
  wire        _system_bus_xbar_auto_out_d_ready;
  ...
  wire        _subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_clock;
  wire        _subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_reset;
  ClockGroupAggregator subsystem_sbus_clock_groups (
    ...
    .auto_out_member_subsystem_sbus_0_clock (_subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_clock),
    .auto_out_member_subsystem_sbus_0_reset (_subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_reset)
  );
  ClockGroup clockGroup (
    .auto_in_member_subsystem_sbus_0_clock (_subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_clock),
    .auto_in_member_subsystem_sbus_0_reset (_subsystem_sbus_clock_groups_auto_out_member_subsystem_sbus_0_reset),
  ...
  TLXbar system_bus_xbar (
    ...
    .auto_out_a_ready         (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_a_ready),
    .auto_out_d_valid         (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_valid),
    .auto_out_d_bits_opcode   (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_opcode),
    .auto_out_d_bits_param    (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_param),
    .auto_out_d_bits_size     (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_size),
    .auto_out_d_bits_source   (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_source),
    .auto_out_d_bits_sink     (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_sink),
    .auto_out_d_bits_denied   (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_denied),
    .auto_out_d_bits_data     (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_data),
    .auto_out_d_bits_corrupt  (_coupler_to_bus_named_subsystem_cbus_auto_widget_in_d_bits_corrupt),
  ...
  TLFIFOFixer fixer (
    .clock                     (_fixedClockNode_auto_out_0_clock),
    .reset                     (_fixedClockNode_auto_out_0_reset),
    .auto_in_1_a_valid         (_coupler_from_tile_auto_tl_out_a_valid),
    .auto_in_1_a_bits_opcode   (_coupler_from_tile_auto_tl_out_a_bits_opcode),
    .auto_in_1_a_bits_param    (_coupler_from_tile_auto_tl_out_a_bits_param),
    .auto_in_1_a_bits_size     (_coupler_from_tile_auto_tl_out_a_bits_size),
    .auto_in_1_a_bits_source   (_coupler_from_tile_auto_tl_out_a_bits_source),
    .auto_in_1_a_bits_address  (_coupler_from_tile_auto_tl_out_a_bits_address),
    .auto_in_1_a_bits_mask     (_coupler_from_tile_auto_tl_out_a_bits_mask),
    .auto_in_1_a_bits_data     (_coupler_from_tile_auto_tl_out_a_bits_data),
    .auto_in_1_a_bits_corrupt  (_coupler_from_tile_auto_tl_out_a_bits_corrupt),
    .auto_in_1_d_ready         (_coupler_from_tile_auto_tl_out_d_ready),
  ...
  TLInterconnectCoupler coupler_to_bus_named_subsystem_cbus (
    .auto_widget_in_a_valid           (_system_bus_xbar_auto_out_a_valid),
    .auto_widget_in_a_bits_opcode     (_system_bus_xbar_auto_out_a_bits_opcode),
    .auto_widget_in_a_bits_param      (_system_bus_xbar_auto_out_a_bits_param),
    .auto_widget_in_a_bits_size       (_system_bus_xbar_auto_out_a_bits_size),
    .auto_widget_in_a_bits_source     (_system_bus_xbar_auto_out_a_bits_source),
    .auto_widget_in_a_bits_address    (_system_bus_xbar_auto_out_a_bits_address),
    .auto_widget_in_a_bits_mask       (_system_bus_xbar_auto_out_a_bits_mask),
    .auto_widget_in_a_bits_data       (_system_bus_xbar_auto_out_a_bits_data),
    .auto_widget_in_a_bits_corrupt    (_system_bus_xbar_auto_out_a_bits_corrupt),
    .auto_widget_in_d_ready           (_system_bus_xbar_auto_out_d_ready),
  ...
  TLInterconnectCoupler_2 coupler_from_tile (
    .auto_tl_master_clock_xing_in_a_valid        (auto_coupler_from_tile_tl_master_clock_xing_in_a_valid),
    .auto_tl_master_clock_xing_in_a_bits_opcode  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_opcode),
    .auto_tl_master_clock_xing_in_a_bits_param   (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_param),
    .auto_tl_master_clock_xing_in_a_bits_size    (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_size),
    .auto_tl_master_clock_xing_in_a_bits_source  (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_source),
    .auto_tl_master_clock_xing_in_a_bits_address (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_address),
    .auto_tl_master_clock_xing_in_a_bits_mask    (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_mask),
    .auto_tl_master_clock_xing_in_a_bits_data    (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_data),
    .auto_tl_master_clock_xing_in_a_bits_corrupt (auto_coupler_from_tile_tl_master_clock_xing_in_a_bits_corrupt),
    .auto_tl_master_clock_xing_in_d_ready        (auto_coupler_from_tile_tl_master_clock_xing_in_d_ready),
    ...
    .auto_tl_master_clock_xing_in_a_ready        (auto_coupler_from_tile_tl_master_clock_xing_in_a_ready),
    .auto_tl_master_clock_xing_in_d_valid        (auto_coupler_from_tile_tl_master_clock_xing_in_d_valid),
    .auto_tl_master_clock_xing_in_d_bits_opcode  (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_opcode),
    .auto_tl_master_clock_xing_in_d_bits_param   (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_param),
    .auto_tl_master_clock_xing_in_d_bits_size    (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_size),
    .auto_tl_master_clock_xing_in_d_bits_source  (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_source),
    .auto_tl_master_clock_xing_in_d_bits_sink    (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_sink),
    .auto_tl_master_clock_xing_in_d_bits_denied  (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_denied),
    .auto_tl_master_clock_xing_in_d_bits_data    (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_data),
    .auto_tl_master_clock_xing_in_d_bits_corrupt (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_corrupt),
    .auto_tl_out_a_valid                         (_coupler_from_tile_auto_tl_out_a_valid),
    .auto_tl_out_a_bits_opcode                   (_coupler_from_tile_auto_tl_out_a_bits_opcode),
    .auto_tl_out_a_bits_param                    (_coupler_from_tile_auto_tl_out_a_bits_param),
    .auto_tl_out_a_bits_size                     (_coupler_from_tile_auto_tl_out_a_bits_size),
    .auto_tl_out_a_bits_source                   (_coupler_from_tile_auto_tl_out_a_bits_source),
    .auto_tl_out_a_bits_address                  (_coupler_from_tile_auto_tl_out_a_bits_address),
    .auto_tl_out_a_bits_mask                     (_coupler_from_tile_auto_tl_out_a_bits_mask),
    .auto_tl_out_a_bits_data                     (_coupler_from_tile_auto_tl_out_a_bits_data),
    .auto_tl_out_a_bits_corrupt                  (_coupler_from_tile_auto_tl_out_a_bits_corrupt),
