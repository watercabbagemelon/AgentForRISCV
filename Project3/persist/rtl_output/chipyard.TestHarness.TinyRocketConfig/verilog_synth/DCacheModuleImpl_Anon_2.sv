...
module DCacheModuleImpl_Anon_2(
  ...
  assign io_in_3_ready = ~_grant_T;
  assign io_out_valid = _grant_T | io_in_3_valid;
  assign io_out_bits_addr = io_in_0_valid ? io_in_0_bits_addr : io_in_1_valid ? io_in_1_bits_addr : io_in_3_bits_addr;
  assign io_out_bits_write = io_in_0_valid ? io_in_0_bits_write : io_in_1_valid & io_in_1_bits_write;
  assign io_out_bits_wdata = io_in_0_valid ? io_in_0_bits_wdata : io_in_1_valid ? io_in_1_bits_wdata : io_in_3_bits_wdata;
  assign io_out_bits_eccMask = io_in_0_valid ? io_in_0_bits_eccMask : io_in_1_valid ? io_in_1_bits_eccMask : 4'hF;
endmodule
