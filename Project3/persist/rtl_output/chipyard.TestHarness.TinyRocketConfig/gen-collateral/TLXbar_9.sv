...
module TLXbar_9(
  ...
  wire [2:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:2]) : 4'h0) | (winnerQual_1 ? ~(_beatsDO_decode_T_5[5:2]) : 4'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}]
