...
module TLMonitor_15(
  ...
  wire [34:0] _a_opcodes_set_T_1 = {31'h0, _T_1177 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {31'h0, io_in_a_bits_source, 2'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:46:9]
  wire [46:0] _d_sizes_clr_T_5 = 47'hFF << {42'h0, io_in_d_bits_source, 3'h0};	// @[Monitor.scala:677:76, :678:74, :723:35]
  wire [35:0] _a_sizes_set_T_1 = {31'h0, _T_1177 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {31'h0, io_in_a_bits_source, 3'h0};	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, :723:35]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_1177 ? _a_set_T[2:0] : 3'h0)) & ~(_T_1192 ? _d_clr_T[2:0] : 3'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1177 ? _a_opcodes_set_T_1[11:0] : 12'h0)) & ~(_T_1192 ? _d_opcodes_clr_T_5[11:0] : 12'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1177 ? _a_sizes_set_T_1[23:0] : 24'h0)) & ~(_T_1192 ? _d_sizes_clr_T_5[23:0] : 24'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire             source_ok = _source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2;	// @[Parameters.scala:46:9, :1125:46]
    ...
    wire             source_ok_1 = io_in_d_bits_source == 2'h2 | io_in_d_bits_source == 2'h1 | io_in_d_bits_source == 2'h0;	// @[Misc.scala:201:81, Parameters.scala:46:9, :1125:46]
    ...
    wire  [11:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> {8'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, Parameters.scala:46:9]
    ...
    wire  [2:0]      a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[2:0] : 3'h0;	// @[Monitor.scala:624:34, :648:{26,71}, :649:22, :723:35, OneHot.scala:57:35]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_392 & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_392 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:16] == 16'h1 | io_in_a_bits_address[31:16] == 16'h2 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Monitor.scala:42:11, :104:45, :638:40, Parameters.scala:92:42, :137:{31,45,65}, :670:56, :671:42, :672:30]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(_T_494 & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2) & (_T_494 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, :638:40, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :670:56, :671:42, :672:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(_T_595 & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2) & (_T_595 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :638:40, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :670:56, :671:42, :672:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2) & io_in_a_bits_size < 4'h3 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, :638:40, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2) & io_in_a_bits_size < 4'h3 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :638:40, Parameters.scala:46:9, :92:42, :137:{31,45,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_17 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2) & io_in_a_bits_address[31:12] == 20'h3)) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :92:42, :137:{31,65}, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_29 & ~reset & ~(io_in_d_bits_opcode == _GEN_4[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_3[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:42:11, :49:11, :634:{44,152}, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (_T_1225 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1225 & ~d_release_ack ? _d_clr_wo_ready_T[2:0] : 3'h0) | a_set_wo_ready == 3'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 2 (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 3'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Bundles.scala:259:74, Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
