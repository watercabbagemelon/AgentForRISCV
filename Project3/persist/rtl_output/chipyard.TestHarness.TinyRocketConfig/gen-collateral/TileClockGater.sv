...
module TileClockGater(
  ...
  wire       _out_out_bits_data_WIRE_4 = auto_tile_clock_gater_in_1_a_bits_address[11:5] == 7'h0;	// @[Edges.scala:191:34, RegisterRouter.scala:72:19, :82:24]
  ...
  wire [7:0] _GEN = {{1'h1}, {1'h1}, {1'h1}, {_out_out_bits_data_WIRE_4}, {_out_out_bits_data_WIRE_4}, {_out_out_bits_data_WIRE_4}, {_out_out_bits_data_WIRE_4}, {_out_out_bits_data_WIRE_4}};	// @[MuxLiteral.scala:49:10, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  wire [7:0] _GEN_0 = {{1'h0}, {1'h0}, {1'h0}, {_regs_4_io_q}, {_regs_3_io_q}, {_regs_2_io_q}, {_regs_1_io_q}, {_regs_0_io_q}};	// @[MuxLiteral.scala:49:10, RegisterRouter.scala:23:14, TileClockGater.scala:33:53]
  ...
  AsyncResetRegVec_w1_i1 regs_0 (	// @[TileClockGater.scala:33:53]
    ...
    .io_en (_out_wofireMux_T_2 & out_backSel_0 & _out_out_bits_data_WIRE_4 & auto_tile_clock_gater_in_1_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
    .io_q  (_regs_0_io_q)
  );
  AsyncResetRegVec_w1_i1 regs_1 (	// @[TileClockGater.scala:33:53]
    ...
    .io_d  (auto_tile_clock_gater_in_1_a_bits_data[0]),	// @[RegisterRouter.scala:82:24]
    .io_en (_out_wofireMux_T_2 & out_backSel_1 & _out_out_bits_data_WIRE_4 & auto_tile_clock_gater_in_1_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
    .io_q  (_regs_1_io_q)
  );
  AsyncResetRegVec_w1_i1 regs_2 (	// @[TileClockGater.scala:33:53]
    ...
    .io_d  (auto_tile_clock_gater_in_1_a_bits_data[0]),	// @[RegisterRouter.scala:82:24]
    .io_en (_out_wofireMux_T_2 & out_backSel_2 & _out_out_bits_data_WIRE_4 & auto_tile_clock_gater_in_1_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
    .io_q  (_regs_2_io_q)
  );
  AsyncResetRegVec_w1_i1 regs_3 (	// @[TileClockGater.scala:33:53]
    ...
    .io_d  (auto_tile_clock_gater_in_1_a_bits_data[0]),	// @[RegisterRouter.scala:82:24]
    .io_en (_out_wofireMux_T_2 & out_backSel_3 & _out_out_bits_data_WIRE_4 & auto_tile_clock_gater_in_1_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
    .io_q  (_regs_3_io_q)
  );
  AsyncResetRegVec_w1_i1 regs_4 (	// @[TileClockGater.scala:33:53]
    ...
    .io_d  (auto_tile_clock_gater_in_1_a_bits_data[0]),	// @[RegisterRouter.scala:82:24]
    .io_en (_out_wofireMux_T_2 & out_backSel_4 & _out_out_bits_data_WIRE_4 & auto_tile_clock_gater_in_1_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
    .io_q  (_regs_4_io_q)
  );
  ...
  assign auto_tile_clock_gater_in_1_d_bits_data = {31'h0, _GEN[auto_tile_clock_gater_in_1_a_bits_address[4:2]] & _GEN_0[auto_tile_clock_gater_in_1_a_bits_address[4:2]]};	// @[Cat.scala:33:92, MuxLiteral.scala:49:10, RegisterRouter.scala:82:24]
