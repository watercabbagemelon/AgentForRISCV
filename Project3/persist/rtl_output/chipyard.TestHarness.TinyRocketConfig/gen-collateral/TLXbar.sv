...
module TLXbar(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_1[11:2]) : 10'h0) | (winnerQual_1 & ~(auto_in_1_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_5[11:2]) : 10'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Edges.scala:91:{28,37}, :220:14, package.scala:235:{46,71,76}]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h1, auto_in_0_a_bits_source} : 2'h0) | (muxStateEarly_1 ? {1'h0, auto_in_1_a_bits_source} : 2'h0);	// @[Arbiter.scala:118:30, Bundle_ACancel.scala:56:22, Bundles.scala:259:74, Mux.scala:27:73, Parameters.scala:54:32, Xbar.scala:240:{29,55}]
  ...
  assign auto_out_d_ready = requestDOI_0_0 & auto_in_0_d_ready | ~(auto_out_d_bits_source[1]) & auto_in_1_d_ready;	// @[Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}]
endmodule
