...
module ICache(
  ...
  wire [9:0]   beats1 = auto_master_out_d_bits_opcode[0] ? ~(_beats1_decode_T_1[11:2]) : 10'h0;	// @[Edges.scala:105:36, :220:14, :228:27, package.scala:235:{46,71,76}]
  ...
  wire         writeEnable_0 = refill_one_beat & (counter == 10'h1 | beats1 == 10'h0) & auto_master_out_d_valid;	// @[Edges.scala:220:14, :228:27, :231:{25,37,47}, ICache.scala:383:41, :391:37]
  ...
  wire         refillError = auto_master_out_d_bits_corrupt | (|refill_cnt) & accruedRefillError;	// @[Edges.scala:233:25, ICache.scala:420:31, :422:{43,58,64}]
  ...
  data_arrays_0_0 data_arrays_0_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? {refill_paddr[11:6], 4'h0} | refill_cnt : io_req_bits_addr[11:2]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}, :850:21, Reg.scala:19:16]
