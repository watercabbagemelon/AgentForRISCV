...
module TLMonitor_7(
  ...
  wire [66:0] _a_opcodes_set_T_1 = {63'h0, _T_822 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [78:0] _d_sizes_clr_T_5 = 79'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [66:0] _a_sizes_set_T_1 = {63'h0, _T_822 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_822 ? _a_set_T[4:0] : 5'h0)) & ~(_T_837 ? _d_clr_T[4:0] : 5'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_822 ? _a_opcodes_set_T_1[19:0] : 20'h0)) & ~(_T_837 ? _d_opcodes_clr_T_5[19:0] : 20'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_822 ? _a_sizes_set_T_1[19:0] : 20'h0)) & ~(_T_837 ? _d_sizes_clr_T_5[19:0] : 20'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:16] == 15'h2 | io_in_a_bits_address[30:12] == 19'h10000 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :670:56, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 3'h3 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h10000 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :92:42, :137:{31,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~((_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 3'h3 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h10000 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :92:42, :137:{31,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_870 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_870 & ~d_release_ack ? _d_clr_wo_ready_T[4:0] : 5'h0) | a_set_wo_ready == 5'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
