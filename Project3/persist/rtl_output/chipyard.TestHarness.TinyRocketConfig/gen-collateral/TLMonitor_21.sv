...
module TLMonitor_21(
  ...
  wire        _T_713 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire        _T_637 = _T_713 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [66:0] _a_opcodes_set_T_1 = {63'h0, _T_637 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {62'h0, io_in_a_bits_source, 2'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:46:9]
  wire [78:0] _d_sizes_clr_T_5 = 79'hFF << {73'h0, io_in_d_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:677:76, :678:74]
  wire [67:0] _a_sizes_set_T_1 = {63'h0, _T_637 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {62'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, :723:35]
  wire        _T_786 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire        _T_652 = _T_786 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_713) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_786) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_637 ? _a_set_T[4:0] : 5'h0)) & ~(_T_652 ? _d_clr_T[4:0] : 5'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_637 ? _a_opcodes_set_T_1[19:0] : 20'h0)) & ~(_T_652 ? _d_opcodes_clr_T_5[19:0] : 20'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_637 ? _a_sizes_set_T_1[39:0] : 40'h0)) & ~(_T_652 ? _d_sizes_clr_T_5[39:0] : 40'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_713 | _T_786)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Bundles.scala:259:74, Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_713 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_786 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_191 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_582 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_606 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    ...
    wire  [39:0]     _GEN_24 = {34'h0, io_in_d_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:638:40]
    ...
    wire             _T_685 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    wire             _T_656 = _T_685 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire             _GEN_26 = _T_656 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_27 = _T_656 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_28 = {4'h0, io_in_d_bits_size};	// @[Bundles.scala:259:74, Monitor.scala:691:36]
    wire             _T_742 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [4:0]      _T_638 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [4:0]      _T_657 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [39:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire  [7:0]      _d_clr_wo_ready_T = 8'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [4:0]      _T_743 = 5'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [39:0]     _c_size_lookup_T_1 = 40'h0 >> _GEN_24;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_191 & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_191 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:65, :670:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 4'h3 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 4'h3 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_685 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_685 & ~d_release_ack ? _d_clr_wo_ready_T[4:0] : 5'h0) | a_set_wo_ready == 5'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_742 & ~reset & ~(_T_743[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_742 & ~reset & _GEN_28 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:23], _RANDOM_1[4:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[14:5];	// @[Edges.scala:228:27, Monitor.scala:388:22]
        opcode_1 = _RANDOM_1[17:15];	// @[Monitor.scala:388:22, :535:22]
        param_1 = _RANDOM_1[19:18];	// @[Monitor.scala:388:22, :536:22]
        size_1 = _RANDOM_1[23:20];	// @[Monitor.scala:388:22, :537:22]
        source_1 = _RANDOM_1[26:24];	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_1[27];	// @[Monitor.scala:388:22, :539:22]
        denied = _RANDOM_1[28];	// @[Monitor.scala:388:22, :540:22]
        inflight = {_RANDOM_1[31:29], _RANDOM_2[1:0]};	// @[Monitor.scala:388:22, :611:27]
        inflight_opcodes = _RANDOM_2[21:2];	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_2[31:22], _RANDOM_3[29:0]};	// @[Monitor.scala:611:27, :615:33]
        a_first_counter_1 = {_RANDOM_3[31:30], _RANDOM_4[7:0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_4[17:8];	// @[Edges.scala:228:27]
        watchdog = {_RANDOM_4[31:18], _RANDOM_5[17:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_7[31:29], _RANDOM_8[6:0]};	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
