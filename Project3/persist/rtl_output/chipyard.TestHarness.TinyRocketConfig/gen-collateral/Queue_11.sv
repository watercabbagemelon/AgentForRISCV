...
module Queue_11(
  ...
  wire [63:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[30:27];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[62:31];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[63];	// @[Decoupled.scala:273:95]
endmodule
