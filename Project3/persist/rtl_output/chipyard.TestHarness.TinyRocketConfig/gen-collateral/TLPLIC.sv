...
module TLPLIC(
  ...
  wire [20:0]      _GEN = {_out_back_io_deq_bits_index[23:20], _out_back_io_deq_bits_index[18:12], _out_back_io_deq_bits_index[10:1]};	// @[Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  ...
  wire             claimer_0 = _out_wofireMux_T & _out_back_io_deq_bits_read & out_backSel_5 & _out_out_bits_data_WIRE_5 & (|out_backMask);	// @[Cat.scala:33:92, Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  ...
  assign completer_0 = _out_wofireMux_T_2 & out_backSel_5 & _out_out_bits_data_WIRE_5 & (&out_backMask) & _out_completer_0_T[0];	// @[Cat.scala:33:92, Plic.scala:295:{35,51}, RegisterRouter.scala:82:24]
  wire [2:0]       out_oindex = {_out_back_io_deq_bits_index[19], _out_back_io_deq_bits_index[11], _out_back_io_deq_bits_index[0]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, RegisterRouter.scala:82:24]
  wire [2:0]       _GEN_0 = {_out_back_io_deq_bits_index[19], _out_back_io_deq_bits_index[11], _out_back_io_deq_bits_index[0]};	// @[Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:82:24]
  ...
  wire [7:0]       _GEN_1 = {{1'h1}, {1'h1}, {_out_out_bits_data_WIRE_5}, {_out_out_bits_data_WIRE_5}, {1'h1}, {_out_out_bits_data_WIRE_5}, {_out_out_bits_data_WIRE_5}, {_GEN == 21'h200}};	// @[MuxLiteral.scala:49:10, Plic.scala:245:46, RegisterRouter.scala:82:24]
  wire [7:0][31:0] _GEN_2 = {{32'h0}, {32'h0}, {{31'h0, maxDevs_0}}, {{31'h0, threshold_0}}, {32'h0}, {{30'h0, enables_0_0, 1'h0}}, {{31'h0, priority_0}}, {{30'h0, pending_0, 1'h0}}};	// @[MuxLiteral.scala:49:{10,48}, Plic.scala:163:31, :166:31, :168:26, :174:26, :181:22, RegisterRouter.scala:82:24]
  ...
  always @(posedge clock) begin
    if (_out_wofireMux_T_2 & _GEN_0 == 3'h1 & _out_out_bits_data_WIRE_5 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:82:24]
      priority_0 <= _out_back_io_deq_bits_data[0];	// @[Decoupled.scala:375:21, Plic.scala:163:31, RegisterRouter.scala:82:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 3'h4 & _out_out_bits_data_WIRE_5 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:71:36, :82:24]
      threshold_0 <= _out_back_io_deq_bits_data[0];	// @[Decoupled.scala:375:21, Plic.scala:166:31, RegisterRouter.scala:82:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 3'h2 & _out_out_bits_data_WIRE_5 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:82:24]
