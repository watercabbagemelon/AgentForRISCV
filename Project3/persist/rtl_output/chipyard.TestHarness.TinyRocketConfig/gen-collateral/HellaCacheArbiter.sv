...
module HellaCacheArbiter(
  ...
  assign io_requestor_0_resp_bits_tag = {1'h0, io_mem_resp_bits_tag[6:1]};	// @[HellaCacheArbiter.scala:73:{21,45}]
  ...
  assign io_mem_req_bits_tag = io_requestor_0_req_valid ? {io_requestor_0_req_bits_tag[5:0], 1'h0} : 7'h1;	// @[HellaCacheArbiter.scala:34:29, :50:26]
  assign io_mem_req_bits_cmd = io_requestor_0_req_valid ? io_requestor_0_req_bits_cmd : io_requestor_1_req_bits_cmd;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_req_bits_size = io_requestor_0_req_valid ? io_requestor_0_req_bits_size : io_requestor_1_req_bits_size;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_req_bits_signed = io_requestor_0_req_valid & io_requestor_0_req_bits_signed;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_req_bits_dprv = io_requestor_0_req_valid ? io_requestor_0_req_bits_dprv : 2'h0;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_req_bits_dv = io_requestor_0_req_valid & io_requestor_0_req_bits_dv;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_req_bits_no_xcpt = ~io_requestor_0_req_valid;	// @[HellaCacheArbiter.scala:33:25, :50:26]
  assign io_mem_s1_kill = s1_id ? io_requestor_1_s1_kill : io_requestor_0_s1_kill;	// @[HellaCacheArbiter.scala:20:20, :38:24, :51:30]
  assign io_mem_s1_data_data = s1_id ? io_requestor_1_s1_data_data : io_requestor_0_s1_data_data;	// @[HellaCacheArbiter.scala:20:20, :39:24, :51:30]
  assign io_mem_s1_data_mask = s1_id ? io_requestor_1_s1_data_mask : 4'h0;	// @[HellaCacheArbiter.scala:20:20, :39:24, :51:30]
endmodule
