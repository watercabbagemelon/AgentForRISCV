...
module AsyncQueueSink_2(
  ...
  wire        ridx_incremented =
    _source_valid_io_out & ridx_ridx_bin + _io_deq_valid_output;	// AsyncQueue.scala:52:25, :53:{23,43}, :162:29, :172:31
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_28 widx_widx_gray (	// ShiftReg.scala:45:23
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
  ...
  AsyncValidSync_20 sink_valid_0 (	// AsyncQueue.scala:168:33
    .clock  (clock),
    .reset  (reset | ~io_async_safe_source_reset_n),	// AsyncQueue.scala:173:{42,45}
    .io_out (_sink_valid_0_io_out)
  );
  AsyncValidSync_21 sink_valid_1 (	// AsyncQueue.scala:169:33
  ...
  AsyncValidSync_22 source_extend (	// AsyncQueue.scala:171:31
  ...
  AsyncValidSync_23 source_valid (	// AsyncQueue.scala:172:31
