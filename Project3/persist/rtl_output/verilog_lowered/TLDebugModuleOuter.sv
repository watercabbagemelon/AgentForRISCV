...
module TLDebugModuleOuter(
  ...
  wire       _T_16 = DMCONTROLReg_hartsello == 10'h0;	// Debug.scala:372:47, :374:31, :441:35
  wire       hrmaskNxt_0 =
    ~(~DMCONTROLReg_dmactive | out_woready_12 & DMCONTROLWrData_clrresethaltreq & _T_16)
    & (out_woready_12 & DMCONTROLWrData_setresethaltreq & _T_16 | hrmaskReg_0);	// Debug.scala:374:31, :393:11, :441:35, :514:28, :516:15, :518:44, :519:30, :520:{74,102}, :521:30, :522:{74,102}, :523:30, RegisterRouter.scala:82:24
  wire       out_front_bits_read = auto_dmi_in_a_bits_opcode == 3'h4;	// RegisterRouter.scala:71:36
  wire       _out_out_bits_data_WIRE_1 =
    {auto_dmi_in_a_bits_address[4], auto_dmi_in_a_bits_address[2]} == 2'h0;	// RegisterRouter.scala:82:24, :97:19
  ...
  assign out_woready_12 =
    ...
    & ~(auto_dmi_in_a_bits_address[3]) & _out_out_bits_data_WIRE_1;	// RegisterRouter.scala:71:36, :82:24
  ...
  wire       _io_innerCtrl_bits_resumereq_output =
    out_woready_12 & auto_dmi_in_a_bits_data[30] | innerCtrlResumeReqReg;	// Debug.scala:626:40, :638:{54,83}, RegisterRouter.scala:82:24
  wire       _io_innerCtrl_bits_ackhavereset_output =
    out_woready_12 & auto_dmi_in_a_bits_data[28] | innerCtrlAckHaveResetReg;	// Debug.scala:627:43, :639:{57,89}, RegisterRouter.scala:82:24
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      DMCONTROLReg_haltreq <=
        ...
        & (out_woready_12 ? auto_dmi_in_a_bits_data[31] : DMCONTROLReg_haltreq);	// Debug.scala:374:31, :392:18, :393:22, :394:20, :400:{47,75}, RegisterRouter.scala:82:24
      ...
      DMCONTROLReg_ndmreset <=
        DMCONTROLReg_dmactive
        & (out_woready_12 ? auto_dmi_in_a_bits_data[1] : DMCONTROLReg_ndmreset);	// Debug.scala:374:31, :392:18, :393:22, :394:20, :396:{47,75}, RegisterRouter.scala:82:24
      ...
      debugIntRegs_0 <=
        DMCONTROLReg_dmactive
        & (out_woready_12 ? auto_dmi_in_a_bits_data[31] : debugIntRegs_0);	// Debug.scala:374:31, :595:31, :597:17, :605:44, :606:32, :609:96, :610:34, RegisterRouter.scala:82:24
      ...
      innerCtrlAckHaveResetReg <=
        _io_innerCtrl_bits_ackhavereset_output & ~io_innerCtrl_ready;	// Debug.scala:627:43, :632:54, :634:64, :639:89
    end
  ...
  assign auto_dmi_in_d_bits_data =
    _out_out_bits_data_WIRE_1
      ...
      : 32'h0;	// Cat.scala:33:92, Debug.scala:374:31, :435:47, :529:43, MuxLiteral.scala:49:{10,48}, RegisterRouter.scala:82:24
  ...
  assign io_innerCtrl_bits_hartsel = DMCONTROLReg_hartsello;	// Debug.scala:374:31
