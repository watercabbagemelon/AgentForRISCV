...
module DividerOnlyClockGenerator(
  ...
  assign auto_divider_only_clock_gen_out_member_allClocks_implicit_clock_clock =
    _x1_member_allClocks_subsystem_sbus_0_clock_ClockDivideBy1_clk_out;	// DividerOnlyClockGenerator.scala:134:27
  assign auto_divider_only_clock_gen_out_member_allClocks_implicit_clock_reset =
    auto_divider_only_clock_gen_in_reset;
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_cbus_0_clock =
    _x1_member_allClocks_subsystem_sbus_0_clock_ClockDivideBy1_clk_out;	// DividerOnlyClockGenerator.scala:134:27
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_cbus_0_reset =
    auto_divider_only_clock_gen_in_reset;
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_fbus_0_clock =
    _x1_member_allClocks_subsystem_sbus_0_clock_ClockDivideBy1_clk_out;	// DividerOnlyClockGenerator.scala:134:27
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_fbus_0_reset =
    auto_divider_only_clock_gen_in_reset;
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_pbus_0_clock =
    _x1_member_allClocks_subsystem_sbus_0_clock_ClockDivideBy1_clk_out;	// DividerOnlyClockGenerator.scala:134:27
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_pbus_0_reset =
    auto_divider_only_clock_gen_in_reset;
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_sbus_0_clock =
    _x1_member_allClocks_subsystem_sbus_0_clock_ClockDivideBy1_clk_out;	// DividerOnlyClockGenerator.scala:134:27
  assign auto_divider_only_clock_gen_out_member_allClocks_subsystem_sbus_0_reset =
    auto_divider_only_clock_gen_in_reset;
endmodule
