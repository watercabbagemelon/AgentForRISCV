...
module TLXbar_5(
  ...
  wire        requestAIO_0_0 =
    {auto_in_a_bits_address[31],
     ...
     auto_in_a_bits_address[14:13] ^ 2'h1} == 9'h0;	// Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_1 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25],
     auto_in_a_bits_address[20],
     auto_in_a_bits_address[17:16],
     auto_in_a_bits_address[14:13] ^ 2'h2} == 9'h0
    | {auto_in_a_bits_address[31],
       auto_in_a_bits_address[28],
       auto_in_a_bits_address[26:25],
       auto_in_a_bits_address[20],
       auto_in_a_bits_address[17:16] ^ 2'h2} == 7'h0
    | {auto_in_a_bits_address[31],
       ~(auto_in_a_bits_address[28]),
       auto_in_a_bits_address[25],
       auto_in_a_bits_address[20],
       auto_in_a_bits_address[17:16],
       auto_in_a_bits_address[14:13]} == 8'h0;	// Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92, package.scala:254:43
  wire        requestAIO_0_2 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     ~(auto_in_a_bits_address[26])} == 3'h0;	// Bundles.scala:259:74, Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_3 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25] ^ 2'h1,
     auto_in_a_bits_address[20],
     auto_in_a_bits_address[17:16]} == 7'h0;	// Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_4 =
    {~(auto_in_a_bits_address[31]),
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25],
     auto_in_a_bits_address[20],
     auto_in_a_bits_address[17:16],
     auto_in_a_bits_address[14]} == 8'h0;	// Parameters.scala:137:{31,45,65}, package.scala:254:43
  wire        requestAIO_0_5 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25],
     auto_in_a_bits_address[20],
     auto_in_a_bits_address[17:16],
     auto_in_a_bits_address[14:13]} == 9'h0;	// Arbiter.scala:88:30, Parameters.scala:137:{45,65}
  wire        requestAIO_0_6 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25],
     auto_in_a_bits_address[20],
     auto_in_a_bits_address[17:16] ^ 2'h1} == 7'h0;	// Parameters.scala:137:{31,45,65}
  wire        requestAIO_0_7 =
    {auto_in_a_bits_address[31],
     auto_in_a_bits_address[28],
     auto_in_a_bits_address[26:25],
     ~(auto_in_a_bits_address[20]),
     auto_in_a_bits_address[17:16],
     auto_in_a_bits_address[14:13]} == 9'h0;	// Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}
  ...
  wire        _portsAOI_in_0_a_ready_WIRE =
    ...
    | requestAIO_0_8 & auto_out_8_a_ready;	// Mux.scala:27:73, Parameters.scala:137:65, Xbar.scala:366:92
  reg  [9:0]  beatsLeft;	// Arbiter.scala:88:30
  wire        idle = beatsLeft == 10'h0;	// Arbiter.scala:88:30, :89:28, Edges.scala:220:14
  wire [8:0]  readys_valid =
    {auto_out_8_d_valid,
     auto_out_7_d_valid,
     auto_out_6_d_valid,
     auto_out_5_d_valid,
  ...
  wire [8:0]  readys_readys =
    ~({readys_mask[8],
       _readys_filter_T_1[8] | readys_mask[7],
       _GEN_0[7] | readys_mask[6],
       _GEN_7 | readys_mask[5],
       _GEN_8[5] | readys_mask[4],
       _GEN_13 | readys_mask[3],
       _GEN_14 | readys_mask[2],
       _GEN_15 | readys_mask[1],
       _GEN_16[1] | readys_mask[0]}
      & {_GEN_16[0] | _readys_filter_T_1[8],
         _GEN_9 | _GEN_8[3] | _GEN_0[7],
         _GEN_10 | _GEN_8[2] | _GEN_7,
         _GEN_11 | _GEN_8[1] | _GEN_8[5],
         _GEN_12 | _GEN_8[0] | _GEN_13,
         _GEN_5 | _GEN_3 | _GEN_9 | _GEN_14,
         _GEN_6 | _GEN_4 | _GEN_10 | _GEN_15,
         auto_out_2_d_valid | auto_out_3_d_valid | _GEN_5 | _GEN_11 | _GEN_16[1],
         auto_out_1_d_valid | auto_out_2_d_valid | _GEN_6 | _GEN_12 | _GEN_16[0]});	// Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43
  ...
  wire        out_30_valid =
    idle
      ? _sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid
        ...
        | auto_out_7_d_valid | auto_out_8_d_valid
      : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2
        ...
        & auto_out_7_d_valid | state_8 & auto_out_8_d_valid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Mux.scala:27:73
  wire        out_30_bits_corrupt =
    muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1
    & auto_out_1_d_bits_corrupt | muxStateEarly_4 & auto_out_4_d_bits_corrupt
    | muxStateEarly_7 & auto_out_7_d_bits_corrupt | muxStateEarly_8
    & auto_out_8_d_bits_corrupt;	// Arbiter.scala:118:30, Mux.scala:27:73
  wire        out_30_bits_denied =
    muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1
    & auto_out_1_d_bits_denied | muxStateEarly_4 & auto_out_4_d_bits_denied
    | muxStateEarly_7 & auto_out_7_d_bits_denied | muxStateEarly_8
    & auto_out_8_d_bits_denied;	// Arbiter.scala:118:30, Mux.scala:27:73
  wire        out_30_bits_sink =
    muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink
    | muxStateEarly_4 & auto_out_4_d_bits_sink | muxStateEarly_7 & auto_out_7_d_bits_sink
    | muxStateEarly_8 & auto_out_8_d_bits_sink;	// Arbiter.scala:118:30, Mux.scala:27:73
  wire [2:0]  out_30_bits_source =
    (muxStateEarly_0 ? auto_out_0_d_bits_source : 3'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_source : 3'h0)
    | (muxStateEarly_2 ? auto_out_2_d_bits_source : 3'h0)
    | (muxStateEarly_3 ? auto_out_3_d_bits_source : 3'h0)
    | (muxStateEarly_4 ? auto_out_4_d_bits_source : 3'h0)
    | (muxStateEarly_5 ? auto_out_5_d_bits_source : 3'h0)
    | (muxStateEarly_6 ? auto_out_6_d_bits_source : 3'h0)
    | (muxStateEarly_7 ? auto_out_7_d_bits_source : 3'h0)
    | (muxStateEarly_8 ? auto_out_8_d_bits_source : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  wire [3:0]  out_30_bits_size =
    ...
    | (muxStateEarly_6 ? {1'h0, auto_out_6_d_bits_size} : 4'h0)
    | (muxStateEarly_7 ? {1'h0, auto_out_7_d_bits_size} : 4'h0)
    | (muxStateEarly_8 ? {1'h0, auto_out_8_d_bits_size} : 4'h0);	// Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73
  wire [1:0]  out_30_bits_param =
    (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0)
    | (muxStateEarly_4 ? auto_out_4_d_bits_param : 2'h0)
    | (muxStateEarly_7 ? auto_out_7_d_bits_param : 2'h0)
    | (muxStateEarly_8 ? auto_out_8_d_bits_param : 2'h0);	// Arbiter.scala:118:30, Mux.scala:27:73
  wire [2:0]  out_30_bits_opcode =
    ...
    | (muxStateEarly_5 ? auto_out_5_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_6}
    | (muxStateEarly_7 ? auto_out_7_d_bits_opcode : 3'h0)
    | (muxStateEarly_8 ? auto_out_8_d_bits_opcode : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
          ...
          | {6'h0,
             (winnerQual_1 & auto_out_1_d_bits_opcode[0]
               ...
               | (winnerQual_3 & auto_out_3_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_13[5:2])
                    : 4'h0)
               | (winnerQual_4 & auto_out_4_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_17[5:2])
                    : 4'h0)
               | (winnerQual_5 & auto_out_5_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_21[5:2])
                    : 4'h0) | (winnerQual_6 ? ~(_beatsDO_decode_T_25[5:2]) : 4'h0)
               | (winnerQual_7 & auto_out_7_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_29[5:2])
                    : 4'h0)
               | (winnerQual_8 & auto_out_8_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_33[5:2])
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// Arbiter.scala:106:13
      if (~reset
          & ~((~earlyWinner_0 | ~earlyWinner_1) & (~prefixOR_2 | ~earlyWinner_2)
              & (~prefixOR_3 | ~earlyWinner_3) & (~prefixOR_4 | ~earlyWinner_4)
              & (~prefixOR_5 | ~earlyWinner_5) & (~prefixOR_6 | ~earlyWinner_6)
              & (~prefixOR_7 | ~earlyWinner_7)
              & (~(prefixOR_7 | earlyWinner_7) | ~earlyWinner_8))) begin	// Arbiter.scala:98:79, :105:53, :106:{13,61,64,67,82}
      ...
      if (~reset
          & ~(~(_sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid
                | auto_out_4_d_valid | auto_out_5_d_valid | auto_out_6_d_valid
                | auto_out_7_d_valid | auto_out_8_d_valid) | earlyWinner_0 | earlyWinner_1
              | earlyWinner_2 | earlyWinner_3 | earlyWinner_4 | earlyWinner_5
              | earlyWinner_6 | earlyWinner_7 | earlyWinner_8)) begin	// Arbiter.scala:98:79, :108:{14,15,36,41}
      ...
      if (~reset
          & ~(~(_T_68 | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid
                | auto_out_5_d_valid | auto_out_6_d_valid | auto_out_7_d_valid
                | auto_out_8_d_valid) | _T_68 | auto_out_2_d_valid | auto_out_3_d_valid
              | auto_out_4_d_valid | auto_out_5_d_valid | auto_out_6_d_valid
              | auto_out_7_d_valid | auto_out_8_d_valid)) begin	// Arbiter.scala:109:{14,15,36,41}
  ...
  assign auto_in_d_bits_data =
    ...
    | (muxStateEarly_2 ? auto_out_2_d_bits_data : 32'h0)
    | (muxStateEarly_3 ? auto_out_3_d_bits_data : 32'h0)
    | (muxStateEarly_4 ? auto_out_4_d_bits_data : 32'h0)
    | (muxStateEarly_5 ? auto_out_5_d_bits_data : 32'h0)
    | (muxStateEarly_6 ? auto_out_6_d_bits_data : 32'h0)
    | (muxStateEarly_7 ? auto_out_7_d_bits_data : 32'h0)
    | (muxStateEarly_8 ? auto_out_8_d_bits_data : 32'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
