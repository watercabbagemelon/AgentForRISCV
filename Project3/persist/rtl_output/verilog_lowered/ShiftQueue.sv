...
module ShiftQueue(
  ...
  wire        wen_4 =
    io_deq_ready ? _valid_4_T_4 & valid_4 : _valid_4_T_4 & valid_3 & ~valid_4;	// Decoupled.scala:51:35, ShiftQueue.scala:21:30, :29:10, :30:45, :31:{45,48}
  always @(posedge clock) begin
    ...
    if (io_deq_ready
          ...
          : _valid_4_T_4 & valid_0 & ~valid_1) begin	// Decoupled.scala:51:35, ShiftQueue.scala:21:30, :29:10, :30:{28,45}, :31:{45,48}
    ...
    if (io_deq_ready
          ...
          : _valid_4_T_4 & valid_1 & ~valid_2) begin	// Decoupled.scala:51:35, ShiftQueue.scala:21:30, :29:10, :30:{28,45}, :31:{45,48}
    ...
    if (io_deq_ready
          ...
          : _valid_4_T_4 & valid_2 & ~valid_3) begin	// Decoupled.scala:51:35, ShiftQueue.scala:21:30, :29:10, :30:{28,45}, :31:{45,48}
  ...
  assign io_deq_bits_xcpt_gf_inst =
    valid_0 ? elts_0_xcpt_gf_inst : io_enq_bits_xcpt_gf_inst;	// ShiftQueue.scala:21:30, :22:25, :42:15, :46:{22,36}
