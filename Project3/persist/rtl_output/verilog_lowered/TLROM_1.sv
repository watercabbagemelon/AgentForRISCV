...
module TLROM_1(
  ...
  wire [7:0][31:0] _GEN =
    '{32'h30200073,
      ...
      32'h34151073,
      32'h1F51513,
      32'h10051B};	// BootROM.scala:53:47
  ...
  assign auto_in_d_bits_data =
    (|(auto_in_a_bits_address[15:5])) ? 32'h0 : _GEN[auto_in_a_bits_address[4:2]];	// BootROM.scala:51:34, :52:64, :53:{47,53}, Bundles.scala:259:74
endmodule
