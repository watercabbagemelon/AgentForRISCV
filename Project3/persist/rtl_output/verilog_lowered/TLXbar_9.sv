...
module TLXbar_9(
  ...
  wire        _portsAOI_in_0_a_ready_WIRE =
    ...
    & auto_out_1_a_ready;	// Mux.scala:27:73, Parameters.scala:137:65
  ...
  wire [1:0]  readys_readys =
    ~({readys_mask[1], _readys_filter_T_1[1] | readys_mask[0]}
      & {|_readys_filter_T_1, auto_out_1_d_valid | _readys_filter_T_1[0]});	// Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43
  ...
  wire        out_9_valid =
    idle
      ...
      : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid;	// Arbiter.scala:89:28, :108:36, :117:26, :126:29, Mux.scala:27:73
  ...
  wire [2:0]  out_9_bits_source =
    (muxStateEarly_0 ? auto_out_0_d_bits_source : 3'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_source : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  wire [2:0]  out_9_bits_size =
    (muxStateEarly_0 ? auto_out_0_d_bits_size : 3'h0)
    | (muxStateEarly_1 ? auto_out_1_d_bits_size : 3'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  ...
  wire [2:0]  out_9_bits_opcode =
    (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_1};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
      ...
      if (latch)	// Arbiter.scala:90:24
        beatsLeft <=
          (winnerQual_0 & auto_out_0_d_bits_opcode[0]
             ...
             : 4'h0) | (winnerQual_1 ? ~(_beatsDO_decode_T_5[5:2]) : 4'h0);	// Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}
  ...
  assign auto_in_d_bits_data =
    ...
    | (muxStateEarly_1 ? auto_out_1_d_bits_data : 32'h0);	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
