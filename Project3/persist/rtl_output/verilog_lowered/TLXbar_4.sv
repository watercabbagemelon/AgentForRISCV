...
module TLXbar_4(
  ...
  wire        out_7_valid = auto_out_d_valid & ~(auto_out_d_bits_source[2]);	// Parameters.scala:54:{10,32}, Xbar.scala:182:40
  ...
  wire        idle = beatsLeft == 10'h0;	// Arbiter.scala:88:30, :89:28, :112:73, Edges.scala:220:14
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 10'h0;	// Arbiter.scala:88:30, :112:73, Edges.scala:220:14
  ...
  assign auto_out_a_bits_size =
    (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | {2'h0, muxStateEarly_1, 1'h0};	// Arbiter.scala:26:66, :118:30, Bundles.scala:259:74, Mux.scala:27:73
  assign auto_out_a_bits_source =
    (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 3'h0) | {muxStateEarly_1, 2'h0};	// Arbiter.scala:26:66, :118:30, Mux.scala:27:73, Xbar.scala:240:29
  ...
  assign auto_out_a_bits_mask =
    (muxStateEarly_0 ? auto_in_0_a_bits_mask : 4'h0) | {4{muxStateEarly_1}};	// Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73
  ...
  assign auto_out_d_ready =
    ~(auto_out_d_bits_source[2]) & auto_in_0_d_ready | requestDOI_0_1;	// Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}
endmodule
