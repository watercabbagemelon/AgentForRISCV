...
module TLFragmenter_5(
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// Decoupled.scala:51:35
        if (dFirst)	// Fragmenter.scala:194:29
          ...
          acknum <= acknum - 4'h1;	// Fragmenter.scala:190:29, :210:55
      end
  ...
  assign auto_out_a_bits_address =
    ...
    | {11'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};	// Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}
