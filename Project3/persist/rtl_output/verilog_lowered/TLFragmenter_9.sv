...
module TLFragmenter_9(
  ...
  wire [5:0]  _GEN =
    {auto_out_d_bits_source[3:0], ~(_dsizeOH1_T_1[1:0])}
    & {1'h1, ~(auto_out_d_bits_source[3:0]), _dsizeOH1_T_1[1]};	// Cat.scala:33:92, Fragmenter.scala:193:41, OneHot.scala:64:12, package.scala:233:{35,47,49}, :235:{46,71,76}
  ...
  wire        drop =
    ...
    & ~(auto_out_d_bits_source[5] ? dFirst : auto_out_d_bits_source[3:0] == 4'h0);	// Edges.scala:105:36, Fragmenter.scala:190:29, :193:41, :194:29, :195:30, :220:54, :223:{20,30,33,37}
  wire        x1_d_ready = auto_in_d_ready | drop;	// Fragmenter.scala:223:30, :224:35
  wire [2:0]  aFrag =
    _repeater_io_deq_bits_size > 3'h2 ? 3'h2 : _repeater_io_deq_bits_size;	// Fragmenter.scala:263:30, :286:{24,31}
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// Decoupled.scala:51:35
        if (dFirst)	// Fragmenter.scala:194:29
          ...
          acknum <=
            acknum - {3'h0, auto_out_d_bits_opcode[0] | auto_out_d_bits_size == 2'h2};	// Edges.scala:105:36, Fragmenter.scala:190:29, :205:{32,60}, :210:55, OneHot.scala:64:{12,27}
      end
  ...
  assign auto_out_a_bits_source =
    {_repeater_io_deq_bits_source,
     _repeater_io_deq_bits_opcode == 3'h0,
     ~(aFirst ? dToggle : aToggle_r),
     old_gennum1};	// Cat.scala:33:92, Fragmenter.scala:192:30, :263:30, :293:29, :294:30, :298:{23,27}, Mux.scala:81:61, OneHot.scala:64:12, Reg.scala:19:16
  assign auto_out_a_bits_address =
    _repeater_io_deq_bits_address
    | {26'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};	// Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}
