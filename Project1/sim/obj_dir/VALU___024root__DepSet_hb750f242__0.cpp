...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ ALU__DOT__casez_tmp;
    ALU__DOT__casez_tmp = 0;
    // Body
    ALU__DOT__casez_tmp = ((4U & (IData)(vlSelf->io_op))
                            ...
                            : ((2U & (IData)(vlSelf->io_op))
                                ...
                                : ((1U & (IData)(vlSelf->io_op))
                                    ...
                                    : (vlSelf->io_a 
                                       + vlSelf->io_b))));
    vlSelf->io_result = ALU__DOT__casez_tmp;
    vlSelf->io_zero = (0U == ALU__DOT__casez_tmp);
}
...
#endif
            VL_FATAL_MT("generated/top.sv", 2, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("generated/top.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("generated/top.sv", 2, "", "Active region did not converge.");
            }
